...
public class SEVSymbol: SwiftAutomation.Symbol {
    ...
    public override class func symbol(code: OSType, type: OSType = typeType, descriptor: ScalarDescriptor? = nil) -> SEVSymbol {
        switch (code) {
    ...
    public static let April = SEVSymbol(name: "April", code: 0x61707220, type: typeType) // "apr "
    ...
    public static let August = SEVSymbol(name: "August", code: 0x61756720, type: typeType) // "aug "
    ...
    public static let date = SEVSymbol(name: "date", code: 0x6c647420, type: typeType) // "ldt "
    public static let December = SEVSymbol(name: "December", code: 0x64656320, type: typeType) // "dec "
    ...
    public static let EPSPicture = SEVSymbol(name: "EPSPicture", code: 0x45505320, type: typeType) // "EPS "
    ...
    public static let February = SEVSymbol(name: "February", code: 0x66656220, type: typeType) // "feb "
    ...
    public static let Friday = SEVSymbol(name: "Friday", code: 0x66726920, type: typeType) // "fri "
    ...
    public static let id = SEVSymbol(name: "id", code: 0x49442020, type: typeType) // "ID  "
    ...
    public static let January = SEVSymbol(name: "January", code: 0x6a616e20, type: typeType) // "jan "
    public static let JPEGPicture = SEVSymbol(name: "JPEGPicture", code: 0x4a504547, type: typeType) // "JPEG"
    public static let July = SEVSymbol(name: "July", code: 0x6a756c20, type: typeType) // "jul "
    public static let June = SEVSymbol(name: "June", code: 0x6a756e20, type: typeType) // "jun "
    ...
    public static let March = SEVSymbol(name: "March", code: 0x6d617220, type: typeType) // "mar "
    public static let maximumValue = SEVSymbol(name: "maximumValue", code: 0x6d617856, type: typeType) // "maxV"
    public static let May = SEVSymbol(name: "May", code: 0x6d617920, type: typeType) // "may "
    ...
    public static let Monday = SEVSymbol(name: "Monday", code: 0x6d6f6e20, type: typeType) // "mon "
    ...
    public static let mtu = SEVSymbol(name: "mtu", code: 0x6d747520, type: typeType) // "mtu "
    ...
    public static let November = SEVSymbol(name: "November", code: 0x6e6f7620, type: typeType) // "nov "
    public static let null = SEVSymbol(name: "null", code: 0x6e756c6c, type: typeType) // "null"
    public static let October = SEVSymbol(name: "October", code: 0x6f637420, type: typeType) // "oct "
    ...
    public static let processSerialNumber = SEVSymbol(name: "processSerialNumber", code: 0x70736e20, type: typeType) // "psn "
    ...
    public static let reference = SEVSymbol(name: "reference", code: 0x6f626a20, type: typeType) // "obj "
    ...
    public static let Saturday = SEVSymbol(name: "Saturday", code: 0x73617420, type: typeType) // "sat "
    ...
    public static let September = SEVSymbol(name: "September", code: 0x73657020, type: typeType) // "sep "
    ...
    public static let Sunday = SEVSymbol(name: "Sunday", code: 0x73756e20, type: typeType) // "sun "
    ...
    public static let Thursday = SEVSymbol(name: "Thursday", code: 0x74687520, type: typeType) // "thu "
    ...
    public static let Tuesday = SEVSymbol(name: "Tuesday", code: 0x74756520, type: typeType) // "tue "
    ...
    public static let URL = SEVSymbol(name: "URL", code: 0x75726c20, type: typeType) // "url "
    ...
    public static let Wednesday = SEVSymbol(name: "Wednesday", code: 0x77656420, type: typeType) // "wed "
    ...
    public static let ask = SEVSymbol(name: "ask", code: 0x61736b20, type: typeEnumerated) // "ask "
    ...
    public static let no = SEVSymbol(name: "no", code: 0x6e6f2020, type: typeEnumerated) // "no  "
    ...
    public static let red = SEVSymbol(name: "red", code: 0x72656420, type: typeEnumerated) // "red "
    ...
    public static let yes = SEVSymbol(name: "yes", code: 0x79657320, type: typeEnumerated) // "yes "
}

...
private let _specifierFormatter = SwiftAutomation.SpecifierFormatter(
        ...
        elementsNames: [
                0x73616169: ("analyzerIssue", "analyzerIssues"), // "saai"
                0x63617070: ("application", "applications"), // "capp"
                0x62756366: ("buildConfiguration", "buildConfigurations"), // "bucf"
                0x73616265: ("buildError", "buildErrors"), // "sabe"
                0x61736273: ("buildSetting", "buildSettings"), // "asbs"
                0x73616277: ("buildWarning", "buildWarnings"), // "sabw"
                0x64657663: ("device", "devices"), // "devc"
                0x646f6375: ("document", "documents"), // "docu"
                0x66696c64: ("fileDocument", "fileDocuments"), // "fild"
                0x636f626a: ("item", "items"), // "cobj"
                0x70726f6a: ("project", "projects"), // "proj"
                0x61737273: ("resolvedBuildSetting", "resolvedBuildSettings"), // "asrs"
                0x72756e64: ("runDestination", "runDestinations"), // "rund"
                0x73616973: ("schemeActionIssue", "schemeActionIssues"), // "sais"
                0x73617274: ("schemeActionResult", "schemeActionResults"), // "sart"
                0x72756e78: ("scheme", "schemes"), // "runx"
                0x736f7566: ("sourceDocument", "sourceDocuments"), // "souf"
                0x74617252: ("target", "targets"), // "tarR"
                0x73617466: ("testFailure", "testFailures"), // "satf"
                0x74657864: ("textDocument", "textDocuments"), // "texd"
                0x6377696e: ("window", "windows"), // "cwin"
                0x776b7364: ("workspaceDocument", "workspaceDocuments"), // "wksd"
        ])

private let _glueClasses = SwiftAutomation.GlueClasses(
                                                insertionSpecifierType: XCOInsertion.self,
...
public class XCOSymbol: SwiftAutomation.Symbol {
    ...
    public override class func symbol(code: OSType, type: OSType = AppleEvents.typeType, descriptor: ScalarDescriptor? = nil) -> XCOSymbol {
        switch (code) {
    ...
    // Types/properties
    public static let activeRunDestination = XCOSymbol(name: "activeRunDestination", code: 0x61727564, type: AppleEvents.typeType) // "arud"
    public static let activeScheme = XCOSymbol(name: "activeScheme", code: 0x6172756e, type: AppleEvents.typeType) // "arun"
    public static let activeWorkspaceDocument = XCOSymbol(name: "activeWorkspaceDocument", code: 0x61776b73, type: AppleEvents.typeType) // "awks"
    public static let alias = XCOSymbol(name: "alias", code: 0x616c6973, type: AppleEvents.typeType) // "alis"
    public static let analyzerIssue = XCOSymbol(name: "analyzerIssue", code: 0x73616169, type: AppleEvents.typeType) // "saai"
    public static let anything = XCOSymbol(name: "anything", code: 0x2a2a2a2a, type: AppleEvents.typeType) // "****"
    public static let application = XCOSymbol(name: "application", code: 0x63617070, type: AppleEvents.typeType) // "capp"
    public static let applicationBundleID = XCOSymbol(name: "applicationBundleID", code: 0x62756e64, type: AppleEvents.typeType) // "bund"
    public static let applicationSignature = XCOSymbol(name: "applicationSignature", code: 0x7369676e, type: AppleEvents.typeType) // "sign"
    public static let applicationURL = XCOSymbol(name: "applicationURL", code: 0x6170726c, type: AppleEvents.typeType) // "aprl"
    public static let April = XCOSymbol(name: "April", code: 0x61707220, type: AppleEvents.typeType) // "apr "
    public static let architecture = XCOSymbol(name: "architecture", code: 0x61726368, type: AppleEvents.typeType) // "arch"
    public static let August = XCOSymbol(name: "August", code: 0x61756720, type: AppleEvents.typeType) // "aug "
    public static let best = XCOSymbol(name: "best", code: 0x62657374, type: AppleEvents.typeType) // "best"
    public static let bookmarkData = XCOSymbol(name: "bookmarkData", code: 0x626d726b, type: AppleEvents.typeType) // "bmrk"
    public static let boolean = XCOSymbol(name: "boolean", code: 0x626f6f6c, type: AppleEvents.typeType) // "bool"
    public static let boundingRectangle = XCOSymbol(name: "boundingRectangle", code: 0x71647274, type: AppleEvents.typeType) // "qdrt"
    public static let bounds = XCOSymbol(name: "bounds", code: 0x70626e64, type: AppleEvents.typeType) // "pbnd"
    public static let buildConfiguration = XCOSymbol(name: "buildConfiguration", code: 0x62756366, type: AppleEvents.typeType) // "bucf"
    public static let buildError = XCOSymbol(name: "buildError", code: 0x73616265, type: AppleEvents.typeType) // "sabe"
    public static let buildLog = XCOSymbol(name: "buildLog", code: 0x626c6f67, type: AppleEvents.typeType) // "blog"
    public static let buildSetting = XCOSymbol(name: "buildSetting", code: 0x61736273, type: AppleEvents.typeType) // "asbs"
    public static let buildWarning = XCOSymbol(name: "buildWarning", code: 0x73616277, type: AppleEvents.typeType) // "sabw"
    public static let class_ = XCOSymbol(name: "class_", code: 0x70636c73, type: AppleEvents.typeType) // "pcls"
    public static let closeable = XCOSymbol(name: "closeable", code: 0x68636c62, type: AppleEvents.typeType) // "hclb"
    public static let colorTable = XCOSymbol(name: "colorTable", code: 0x636c7274, type: AppleEvents.typeType) // "clrt"
    public static let companionDevice = XCOSymbol(name: "companionDevice", code: 0x63646576, type: AppleEvents.typeType) // "cdev"
    public static let completed = XCOSymbol(name: "completed", code: 0x73617263, type: AppleEvents.typeType) // "sarc"
    public static let constant = XCOSymbol(name: "constant", code: 0x656e756d, type: AppleEvents.typeType) // "enum"
    public static let dashStyle = XCOSymbol(name: "dashStyle", code: 0x74646173, type: AppleEvents.typeType) // "tdas"
    public static let data = XCOSymbol(name: "data", code: 0x74647461, type: AppleEvents.typeType) // "tdta"
    public static let date = XCOSymbol(name: "date", code: 0x6c647420, type: AppleEvents.typeType) // "ldt "
    public static let December = XCOSymbol(name: "December", code: 0x64656320, type: AppleEvents.typeType) // "dec "
    public static let decimalStruct = XCOSymbol(name: "decimalStruct", code: 0x6465636d, type: AppleEvents.typeType) // "decm"
    public static let device = XCOSymbol(name: "device", code: 0x64657663, type: AppleEvents.typeType) // "devc"
    public static let deviceIdentifier = XCOSymbol(name: "deviceIdentifier", code: 0x64766964, type: AppleEvents.typeType) // "dvid"
    public static let deviceModel = XCOSymbol(name: "deviceModel", code: 0x64767479, type: AppleEvents.typeType) // "dvty"
    public static let document = XCOSymbol(name: "document", code: 0x646f6375, type: AppleEvents.typeType) // "docu"
    public static let doubleInteger = XCOSymbol(name: "doubleInteger", code: 0x636f6d70, type: AppleEvents.typeType) // "comp"
    public static let encodedString = XCOSymbol(name: "encodedString", code: 0x656e6373, type: AppleEvents.typeType) // "encs"
    public static let endingColumnNumber = XCOSymbol(name: "endingColumnNumber", code: 0x73616563, type: AppleEvents.typeType) // "saec"
    public static let endingLineNumber = XCOSymbol(name: "endingLineNumber", code: 0x7361656c, type: AppleEvents.typeType) // "sael"
    public static let environmentVariable = XCOSymbol(name: "environmentVariable", code: 0x656e7672, type: AppleEvents.typeType) // "envr"
    public static let EPSPicture = XCOSymbol(name: "EPSPicture", code: 0x45505320, type: AppleEvents.typeType) // "EPS "
    public static let errorMessage = XCOSymbol(name: "errorMessage", code: 0x73617265, type: AppleEvents.typeType) // "sare"
    public static let February = XCOSymbol(name: "February", code: 0x66656220, type: AppleEvents.typeType) // "feb "
    public static let file = XCOSymbol(name: "file", code: 0x66696c65, type: AppleEvents.typeType) // "file"
    public static let fileDocument = XCOSymbol(name: "fileDocument", code: 0x66696c64, type: AppleEvents.typeType) // "fild"
    public static let filePath = XCOSymbol(name: "filePath", code: 0x73616670, type: AppleEvents.typeType) // "safp"
    public static let fileRef = XCOSymbol(name: "fileRef", code: 0x66737266, type: AppleEvents.typeType) // "fsrf"
    public static let fileURL = XCOSymbol(name: "fileURL", code: 0x6675726c, type: AppleEvents.typeType) // "furl"
    public static let fixed = XCOSymbol(name: "fixed", code: 0x66697864, type: AppleEvents.typeType) // "fixd"
    public static let fixedPoint = XCOSymbol(name: "fixedPoint", code: 0x66706e74, type: AppleEvents.typeType) // "fpnt"
    public static let fixedRectangle = XCOSymbol(name: "fixedRectangle", code: 0x66726374, type: AppleEvents.typeType) // "frct"
    public static let Friday = XCOSymbol(name: "Friday", code: 0x66726920, type: AppleEvents.typeType) // "fri "
    public static let frontmost = XCOSymbol(name: "frontmost", code: 0x70697366, type: AppleEvents.typeType) // "pisf"
    public static let generic = XCOSymbol(name: "generic", code: 0x676e7263, type: AppleEvents.typeType) // "gnrc"
    public static let GIFPicture = XCOSymbol(name: "GIFPicture", code: 0x47494666, type: AppleEvents.typeType) // "GIFf"
    public static let graphicText = XCOSymbol(name: "graphicText", code: 0x63677478, type: AppleEvents.typeType) // "cgtx"
    public static let id = XCOSymbol(name: "id", code: 0x49442020, type: AppleEvents.typeType) // "ID  "
    public static let index = XCOSymbol(name: "index", code: 0x70696478, type: AppleEvents.typeType) // "pidx"
    public static let integer = XCOSymbol(name: "integer", code: 0x6c6f6e67, type: AppleEvents.typeType) // "long"
    public static let internationalText = XCOSymbol(name: "internationalText", code: 0x69747874, type: AppleEvents.typeType) // "itxt"
    public static let internationalWritingCode = XCOSymbol(name: "internationalWritingCode", code: 0x696e746c, type: AppleEvents.typeType) // "intl"
    public static let item = XCOSymbol(name: "item", code: 0x636f626a, type: AppleEvents.typeType) // "cobj"
    public static let January = XCOSymbol(name: "January", code: 0x6a616e20, type: AppleEvents.typeType) // "jan "
    public static let JPEGPicture = XCOSymbol(name: "JPEGPicture", code: 0x4a504547, type: AppleEvents.typeType) // "JPEG"
    public static let July = XCOSymbol(name: "July", code: 0x6a756c20, type: AppleEvents.typeType) // "jul "
    public static let June = XCOSymbol(name: "June", code: 0x6a756e20, type: AppleEvents.typeType) // "jun "
    public static let kernelProcessID = XCOSymbol(name: "kernelProcessID", code: 0x6b706964, type: AppleEvents.typeType) // "kpid"
    public static let largeReal = XCOSymbol(name: "largeReal", code: 0x6c64626c, type: AppleEvents.typeType) // "ldbl"
    public static let lastSchemeActionResult = XCOSymbol(name: "lastSchemeActionResult", code: 0x6c736172, type: AppleEvents.typeType) // "lsar"
    public static let list = XCOSymbol(name: "list", code: 0x6c697374, type: AppleEvents.typeType) // "list"
    public static let loaded = XCOSymbol(name: "loaded", code: 0x6c6f6164, type: AppleEvents.typeType) // "load"
    public static let locationReference = XCOSymbol(name: "locationReference", code: 0x696e736c, type: AppleEvents.typeType) // "insl"
    public static let longFixed = XCOSymbol(name: "longFixed", code: 0x6c667864, type: AppleEvents.typeType) // "lfxd"
    public static let longFixedPoint = XCOSymbol(name: "longFixedPoint", code: 0x6c667074, type: AppleEvents.typeType) // "lfpt"
    public static let longFixedRectangle = XCOSymbol(name: "longFixedRectangle", code: 0x6c667263, type: AppleEvents.typeType) // "lfrc"
    public static let longPoint = XCOSymbol(name: "longPoint", code: 0x6c706e74, type: AppleEvents.typeType) // "lpnt"
    public static let longRectangle = XCOSymbol(name: "longRectangle", code: 0x6c726374, type: AppleEvents.typeType) // "lrct"
    public static let machine = XCOSymbol(name: "machine", code: 0x6d616368, type: AppleEvents.typeType) // "mach"
    public static let machineLocation = XCOSymbol(name: "machineLocation", code: 0x6d4c6f63, type: AppleEvents.typeType) // "mLoc"
    public static let machPort = XCOSymbol(name: "machPort", code: 0x706f7274, type: AppleEvents.typeType) // "port"
    public static let March = XCOSymbol(name: "March", code: 0x6d617220, type: AppleEvents.typeType) // "mar "
    public static let May = XCOSymbol(name: "May", code: 0x6d617920, type: AppleEvents.typeType) // "may "
    public static let message = XCOSymbol(name: "message", code: 0x73616d74, type: AppleEvents.typeType) // "samt"
    public static let miniaturizable = XCOSymbol(name: "miniaturizable", code: 0x69736d6e, type: AppleEvents.typeType) // "ismn"
    public static let miniaturized = XCOSymbol(name: "miniaturized", code: 0x706d6e64, type: AppleEvents.typeType) // "pmnd"
    public static let modified = XCOSymbol(name: "modified", code: 0x696d6f64, type: AppleEvents.typeType) // "imod"
    public static let Monday = XCOSymbol(name: "Monday", code: 0x6d6f6e20, type: AppleEvents.typeType) // "mon "
    public static let name = XCOSymbol(name: "name", code: 0x706e616d, type: AppleEvents.typeType) // "pnam"
    public static let notifiesWhenClosing = XCOSymbol(name: "notifiesWhenClosing", code: 0x776e6f63, type: AppleEvents.typeType) // "wnoc"
    public static let November = XCOSymbol(name: "November", code: 0x6e6f7620, type: AppleEvents.typeType) // "nov "
    public static let null = XCOSymbol(name: "null", code: 0x6e756c6c, type: AppleEvents.typeType) // "null"
    public static let October = XCOSymbol(name: "October", code: 0x6f637420, type: AppleEvents.typeType) // "oct "
    public static let operatingSystemVersion = XCOSymbol(name: "operatingSystemVersion", code: 0x6f737672, type: AppleEvents.typeType) // "osvr"
    public static let path = XCOSymbol(name: "path", code: 0x70707468, type: AppleEvents.typeType) // "ppth"
    public static let PICTPicture = XCOSymbol(name: "PICTPicture", code: 0x50494354, type: AppleEvents.typeType) // "PICT"
    public static let pixelMapRecord = XCOSymbol(name: "pixelMapRecord", code: 0x74706d6d, type: AppleEvents.typeType) // "tpmm"
    public static let platform = XCOSymbol(name: "platform", code: 0x706c6174, type: AppleEvents.typeType) // "plat"
    public static let point = XCOSymbol(name: "point", code: 0x51447074, type: AppleEvents.typeType) // "QDpt"
    public static let processSerialNumber = XCOSymbol(name: "processSerialNumber", code: 0x70736e20, type: AppleEvents.typeType) // "psn "
    public static let project = XCOSymbol(name: "project", code: 0x70726f6a, type: AppleEvents.typeType) // "proj"
    public static let properties = XCOSymbol(name: "properties", code: 0x70414c4c, type: AppleEvents.typeType) // "pALL"
    public static let property_ = XCOSymbol(name: "property_", code: 0x70726f70, type: AppleEvents.typeType) // "prop"
    public static let real = XCOSymbol(name: "real", code: 0x646f7562, type: AppleEvents.typeType) // "doub"
    public static let record = XCOSymbol(name: "record", code: 0x7265636f, type: AppleEvents.typeType) // "reco"
    public static let reference = XCOSymbol(name: "reference", code: 0x6f626a20, type: AppleEvents.typeType) // "obj "
    public static let resizable = XCOSymbol(name: "resizable", code: 0x7072737a, type: AppleEvents.typeType) // "prsz"
    public static let resolvedBuildSetting = XCOSymbol(name: "resolvedBuildSetting", code: 0x61737273, type: AppleEvents.typeType) // "asrs"
    public static let RGB16Color = XCOSymbol(name: "RGB16Color", code: 0x74723136, type: AppleEvents.typeType) // "tr16"
    public static let RGB96Color = XCOSymbol(name: "RGB96Color", code: 0x74723936, type: AppleEvents.typeType) // "tr96"
    public static let RGBColor = XCOSymbol(name: "RGBColor", code: 0x63524742, type: AppleEvents.typeType) // "cRGB"
    public static let rotation = XCOSymbol(name: "rotation", code: 0x74726f74, type: AppleEvents.typeType) // "trot"
    public static let runDestination = XCOSymbol(name: "runDestination", code: 0x72756e64, type: AppleEvents.typeType) // "rund"
    public static let Saturday = XCOSymbol(name: "Saturday", code: 0x73617420, type: AppleEvents.typeType) // "sat "
    public static let scheme = XCOSymbol(name: "scheme", code: 0x72756e78, type: AppleEvents.typeType) // "runx"
    public static let schemeActionIssue = XCOSymbol(name: "schemeActionIssue", code: 0x73616973, type: AppleEvents.typeType) // "sais"
    public static let schemeActionResult = XCOSymbol(name: "schemeActionResult", code: 0x73617274, type: AppleEvents.typeType) // "sart"
    public static let script = XCOSymbol(name: "script", code: 0x73637074, type: AppleEvents.typeType) // "scpt"
    public static let selectedCharacterRange = XCOSymbol(name: "selectedCharacterRange", code: 0x78736372, type: AppleEvents.typeType) // "xscr"
    public static let selectedParagraphRange = XCOSymbol(name: "selectedParagraphRange", code: 0x78737072, type: AppleEvents.typeType) // "xspr"
    public static let September = XCOSymbol(name: "September", code: 0x73657020, type: AppleEvents.typeType) // "sep "
    public static let shortInteger = XCOSymbol(name: "shortInteger", code: 0x73686f72, type: AppleEvents.typeType) // "shor"
    public static let smallReal = XCOSymbol(name: "smallReal", code: 0x73696e67, type: AppleEvents.typeType) // "sing"
    public static let sourceDocument = XCOSymbol(name: "sourceDocument", code: 0x736f7566, type: AppleEvents.typeType) // "souf"
    public static let startingColumnNumber = XCOSymbol(name: "startingColumnNumber", code: 0x73617363, type: AppleEvents.typeType) // "sasc"
    public static let startingLineNumber = XCOSymbol(name: "startingLineNumber", code: 0x7361736c, type: AppleEvents.typeType) // "sasl"
    public static let status = XCOSymbol(name: "status", code: 0x73617273, type: AppleEvents.typeType) // "sars"
    public static let string = XCOSymbol(name: "string", code: 0x54455854, type: AppleEvents.typeType) // "TEXT"
    public static let styledClipboardText = XCOSymbol(name: "styledClipboardText", code: 0x7374796c, type: AppleEvents.typeType) // "styl"
    public static let styledText = XCOSymbol(name: "styledText", code: 0x53545854, type: AppleEvents.typeType) // "STXT"
    public static let Sunday = XCOSymbol(name: "Sunday", code: 0x73756e20, type: AppleEvents.typeType) // "sun "
    public static let target = XCOSymbol(name: "target", code: 0x74617252, type: AppleEvents.typeType) // "tarR"
    public static let testFailure = XCOSymbol(name: "testFailure", code: 0x73617466, type: AppleEvents.typeType) // "satf"
    public static let text = XCOSymbol(name: "text", code: 0x63747874, type: AppleEvents.typeType) // "ctxt"
    public static let textDocument = XCOSymbol(name: "textDocument", code: 0x74657864, type: AppleEvents.typeType) // "texd"
    public static let textStyleInfo = XCOSymbol(name: "textStyleInfo", code: 0x74737479, type: AppleEvents.typeType) // "tsty"
    public static let Thursday = XCOSymbol(name: "Thursday", code: 0x74687520, type: AppleEvents.typeType) // "thu "
    public static let TIFFPicture = XCOSymbol(name: "TIFFPicture", code: 0x54494646, type: AppleEvents.typeType) // "TIFF"
    public static let Tuesday = XCOSymbol(name: "Tuesday", code: 0x74756520, type: AppleEvents.typeType) // "tue "
    public static let typeClass = XCOSymbol(name: "typeClass", code: 0x74797065, type: AppleEvents.typeType) // "type"
    public static let UnicodeText = XCOSymbol(name: "UnicodeText", code: 0x75747874, type: AppleEvents.typeType) // "utxt"
    public static let unsignedDoubleInteger = XCOSymbol(name: "unsignedDoubleInteger", code: 0x75636f6d, type: AppleEvents.typeType) // "ucom"
    public static let unsignedInteger = XCOSymbol(name: "unsignedInteger", code: 0x6d61676e, type: AppleEvents.typeType) // "magn"
    public static let unsignedShortInteger = XCOSymbol(name: "unsignedShortInteger", code: 0x75736872, type: AppleEvents.typeType) // "ushr"
    public static let UTF16Text = XCOSymbol(name: "UTF16Text", code: 0x75743136, type: AppleEvents.typeType) // "ut16"
    public static let UTF8Text = XCOSymbol(name: "UTF8Text", code: 0x75746638, type: AppleEvents.typeType) // "utf8"
    public static let value = XCOSymbol(name: "value", code: 0x76616c4c, type: AppleEvents.typeType) // "valL"
    public static let variableName = XCOSymbol(name: "variableName", code: 0x656e766e, type: AppleEvents.typeType) // "envn"
    public static let variableValue = XCOSymbol(name: "variableValue", code: 0x656e7676, type: AppleEvents.typeType) // "envv"
    public static let version = XCOSymbol(name: "version", code: 0x76657273, type: AppleEvents.typeType) // "vers"
    public static let visible = XCOSymbol(name: "visible", code: 0x70766973, type: AppleEvents.typeType) // "pvis"
    public static let Wednesday = XCOSymbol(name: "Wednesday", code: 0x77656420, type: AppleEvents.typeType) // "wed "
    public static let window = XCOSymbol(name: "window", code: 0x6377696e, type: AppleEvents.typeType) // "cwin"
    public static let workspaceDocument = XCOSymbol(name: "workspaceDocument", code: 0x776b7364, type: AppleEvents.typeType) // "wksd"
    public static let writingCode = XCOSymbol(name: "writingCode", code: 0x70736374, type: AppleEvents.typeType) // "psct"
    public static let zoomable = XCOSymbol(name: "zoomable", code: 0x69737a6d, type: AppleEvents.typeType) // "iszm"
    public static let zoomed = XCOSymbol(name: "zoomed", code: 0x707a756d, type: AppleEvents.typeType) // "pzum"

    // Enumerators
    public static let ask = XCOSymbol(name: "ask", code: 0x61736b20, type: AppleEvents.typeEnumerated) // "ask "
    public static let cancelled = XCOSymbol(name: "cancelled", code: 0x73727363, type: AppleEvents.typeEnumerated) // "srsc"
    public static let case_ = XCOSymbol(name: "case_", code: 0x63617365, type: AppleEvents.typeEnumerated) // "case"
    public static let diacriticals = XCOSymbol(name: "diacriticals", code: 0x64696163, type: AppleEvents.typeEnumerated) // "diac"
    public static let errorOccurred = XCOSymbol(name: "errorOccurred", code: 0x73727365, type: AppleEvents.typeEnumerated) // "srse"
    public static let expansion = XCOSymbol(name: "expansion", code: 0x65787061, type: AppleEvents.typeEnumerated) // "expa"
    public static let failed = XCOSymbol(name: "failed", code: 0x73727366, type: AppleEvents.typeEnumerated) // "srsf"
    public static let hyphens = XCOSymbol(name: "hyphens", code: 0x68797068, type: AppleEvents.typeEnumerated) // "hyph"
    public static let no = XCOSymbol(name: "no", code: 0x6e6f2020, type: AppleEvents.typeEnumerated) // "no  "
    public static let notYetStarted = XCOSymbol(name: "notYetStarted", code: 0x7372736e, type: AppleEvents.typeEnumerated) // "srsn"
    public static let numericStrings = XCOSymbol(name: "numericStrings", code: 0x6e756d65, type: AppleEvents.typeEnumerated) // "nume"
    public static let punctuation = XCOSymbol(name: "punctuation", code: 0x70756e63, type: AppleEvents.typeEnumerated) // "punc"
    public static let running = XCOSymbol(name: "running", code: 0x73727372, type: AppleEvents.typeEnumerated) // "srsr"
    public static let succeeded = XCOSymbol(name: "succeeded", code: 0x73727373, type: AppleEvents.typeEnumerated) // "srss"
    public static let whitespace = XCOSymbol(name: "whitespace", code: 0x77686974, type: AppleEvents.typeEnumerated) // "whit"
    public static let yes = XCOSymbol(name: "yes", code: 0x79657320, type: AppleEvents.typeEnumerated) // "yes "
}
...
extension XCOCommand {
    ...
    @discardableResult public func build(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "build", event: 0x78636f64_62756c64, // "xcodbuld"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func clean(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "clean", event: 0x78636f64_636c656e, // "xcodclen"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func hack(_ directParameter: Any = SwiftAutomation.noParameter,
            ...
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "hack", event: 0x70626173_6861636b, // "pbashack"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
    ...
    @discardableResult public func run_(_ directParameter: Any = SwiftAutomation.noParameter,
            ...
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "run_", event: 0x78636f64_6572756e, // "xcoderun"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
    ...
    @discardableResult public func stop(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "stop", event: 0x78636f64_73746f70, // "xcodstop"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func test(_ directParameter: Any = SwiftAutomation.noParameter,
            ...
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "test", event: 0x78636f64_74657374, // "xcodtest"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                    ("withCommandLineArguments", 0x636c6167, withCommandLineArguments), // "clag"
                    ("withEnvironmentVariables", 0x656e766c, withEnvironmentVariables), // "envl"
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
...
extension XCOObject {
    ...
    public var id: XCOItem {return self.property(0x49442020) as! XCOItem} // "ID  "

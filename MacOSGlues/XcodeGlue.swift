...
public class XCOSymbol: SwiftAutomation.Symbol {
    ...
    public static let enumerator = XCOSymbol(name: "enumerator", code: 0x656e756d, type: typeType) // "enum"
    ...
    public static let extendedFloat = XCOSymbol(name: "extendedFloat", code: 0x65787465, type: typeType) // "exte"
    ...
    public static let float = XCOSymbol(name: "float", code: 0x646f7562, type: typeType) // "doub"
    public static let float128bit = XCOSymbol(name: "float128bit", code: 0x6c64626c, type: typeType) // "ldbl"
    ...
    public static let shortFloat = XCOSymbol(name: "shortFloat", code: 0x73696e67, type: typeType) // "sing"
...
// Application
public class Xcode: XCORoot, SwiftAutomation.ApplicationExtension {

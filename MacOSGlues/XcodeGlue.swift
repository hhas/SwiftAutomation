...
public class XCOSymbol: SwiftAutomation.Symbol {
    ...
    public override class func symbol(code: OSType, type: OSType = typeType, descriptor: ScalarDescriptor? = nil) -> XCOSymbol {
        switch (code) {
    ...
    public static let April = XCOSymbol(name: "April", code: 0x61707220, type: typeType) // "apr "
    public static let architecture = XCOSymbol(name: "architecture", code: 0x61726368, type: typeType) // "arch"
    public static let August = XCOSymbol(name: "August", code: 0x61756720, type: typeType) // "aug "
    ...
    public static let date = XCOSymbol(name: "date", code: 0x6c647420, type: typeType) // "ldt "
    public static let December = XCOSymbol(name: "December", code: 0x64656320, type: typeType) // "dec "
    ...
    public static let EPSPicture = XCOSymbol(name: "EPSPicture", code: 0x45505320, type: typeType) // "EPS "
    public static let errorMessage = XCOSymbol(name: "errorMessage", code: 0x73617265, type: typeType) // "sare"
    public static let February = XCOSymbol(name: "February", code: 0x66656220, type: typeType) // "feb "
    ...
    public static let Friday = XCOSymbol(name: "Friday", code: 0x66726920, type: typeType) // "fri "
    ...
    public static let id = XCOSymbol(name: "id", code: 0x49442020, type: typeType) // "ID  "
    ...
    public static let January = XCOSymbol(name: "January", code: 0x6a616e20, type: typeType) // "jan "
    public static let JPEGPicture = XCOSymbol(name: "JPEGPicture", code: 0x4a504547, type: typeType) // "JPEG"
    public static let July = XCOSymbol(name: "July", code: 0x6a756c20, type: typeType) // "jul "
    public static let June = XCOSymbol(name: "June", code: 0x6a756e20, type: typeType) // "jun "
    ...
    public static let March = XCOSymbol(name: "March", code: 0x6d617220, type: typeType) // "mar "
    public static let May = XCOSymbol(name: "May", code: 0x6d617920, type: typeType) // "may "
    ...
    public static let Monday = XCOSymbol(name: "Monday", code: 0x6d6f6e20, type: typeType) // "mon "
    ...
    public static let November = XCOSymbol(name: "November", code: 0x6e6f7620, type: typeType) // "nov "
    public static let null = XCOSymbol(name: "null", code: 0x6e756c6c, type: typeType) // "null"
    public static let October = XCOSymbol(name: "October", code: 0x6f637420, type: typeType) // "oct "
    ...
    public static let processSerialNumber = XCOSymbol(name: "processSerialNumber", code: 0x70736e20, type: typeType) // "psn "
    ...
    public static let reference = XCOSymbol(name: "reference", code: 0x6f626a20, type: typeType) // "obj "
    ...
    public static let Saturday = XCOSymbol(name: "Saturday", code: 0x73617420, type: typeType) // "sat "
    ...
    public static let September = XCOSymbol(name: "September", code: 0x73657020, type: typeType) // "sep "
    ...
    public static let Sunday = XCOSymbol(name: "Sunday", code: 0x73756e20, type: typeType) // "sun "
    ...
    public static let Thursday = XCOSymbol(name: "Thursday", code: 0x74687520, type: typeType) // "thu "
    public static let TIFFPicture = XCOSymbol(name: "TIFFPicture", code: 0x54494646, type: typeType) // "TIFF"
    public static let Tuesday = XCOSymbol(name: "Tuesday", code: 0x74756520, type: typeType) // "tue "
    ...
    public static let Wednesday = XCOSymbol(name: "Wednesday", code: 0x77656420, type: typeType) // "wed "
    ...
    // Enumerators
    public static let ask = XCOSymbol(name: "ask", code: 0x61736b20, type: typeEnumerated) // "ask "
    ...
    public static let no = XCOSymbol(name: "no", code: 0x6e6f2020, type: typeEnumerated) // "no  "
    ...
    public static let yes = XCOSymbol(name: "yes", code: 0x79657320, type: typeEnumerated) // "yes "
}

...
public class MAISymbol: SwiftAutomation.Symbol {
    ...
    public override class func symbol(code: OSType, type: OSType = typeType, descriptor: ScalarDescriptor? = nil) -> MAISymbol {
        switch (code) {
    ...
    public static let April = MAISymbol(name: "April", code: 0x61707220, type: typeType) // "apr "
    ...
    public static let August = MAISymbol(name: "August", code: 0x61756720, type: typeType) // "aug "
    ...
    public static let character = MAISymbol(name: "character", code: 0x63686120, type: typeType) // "cha "
    ...
    public static let date = MAISymbol(name: "date", code: 0x6c647420, type: typeType) // "ldt "
    ...
    public static let December = MAISymbol(name: "December", code: 0x64656320, type: typeType) // "dec "
    ...
    public static let EPSPicture = MAISymbol(name: "EPSPicture", code: 0x45505320, type: typeType) // "EPS "
    ...
    public static let February = MAISymbol(name: "February", code: 0x66656220, type: typeType) // "feb "
    ...
    public static let Friday = MAISymbol(name: "Friday", code: 0x66726920, type: typeType) // "fri "
    ...
    public static let id = MAISymbol(name: "id", code: 0x49442020, type: typeType) // "ID  "
    ...
    public static let January = MAISymbol(name: "January", code: 0x6a616e20, type: typeType) // "jan "
    public static let JPEGPicture = MAISymbol(name: "JPEGPicture", code: 0x4a504547, type: typeType) // "JPEG"
    public static let July = MAISymbol(name: "July", code: 0x6a756c20, type: typeType) // "jul "
    public static let June = MAISymbol(name: "June", code: 0x6a756e20, type: typeType) // "jun "
    ...
    public static let March = MAISymbol(name: "March", code: 0x6d617220, type: typeType) // "mar "
    ...
    public static let May = MAISymbol(name: "May", code: 0x6d617920, type: typeType) // "may "
    ...
    public static let Monday = MAISymbol(name: "Monday", code: 0x6d6f6e20, type: typeType) // "mon "
    ...
    public static let November = MAISymbol(name: "November", code: 0x6e6f7620, type: typeType) // "nov "
    public static let null = MAISymbol(name: "null", code: 0x6e756c6c, type: typeType) // "null"
    public static let October = MAISymbol(name: "October", code: 0x6f637420, type: typeType) // "oct "
    ...
    public static let processSerialNumber = MAISymbol(name: "processSerialNumber", code: 0x70736e20, type: typeType) // "psn "
    ...
    public static let reference = MAISymbol(name: "reference", code: 0x6f626a20, type: typeType) // "obj "
    ...
    public static let Saturday = MAISymbol(name: "Saturday", code: 0x73617420, type: typeType) // "sat "
    ...
    public static let September = MAISymbol(name: "September", code: 0x73657020, type: typeType) // "sep "
    ...
    public static let Sunday = MAISymbol(name: "Sunday", code: 0x73756e20, type: typeType) // "sun "
    ...
    public static let Thursday = MAISymbol(name: "Thursday", code: 0x74687520, type: typeType) // "thu "
    ...
    public static let Tuesday = MAISymbol(name: "Tuesday", code: 0x74756520, type: typeType) // "tue "
    ...
    public static let Wednesday = MAISymbol(name: "Wednesday", code: 0x77656420, type: typeType) // "wed "
    ...
    public static let ask = MAISymbol(name: "ask", code: 0x61736b20, type: typeEnumerated) // "ask "
    ...
    public static let no = MAISymbol(name: "no", code: 0x6e6f2020, type: typeEnumerated) // "no  "
    ...
    public static let yes = MAISymbol(name: "yes", code: 0x79657320, type: typeEnumerated) // "yes "
}

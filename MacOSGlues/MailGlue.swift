...
private let _specifierFormatter = SwiftAutomation.SpecifierFormatter(
        ...
        elementsNames: [
                ...
                0x62726370: ("bccRecipient", "bccRecipients"), // "brcp"
                0x63726370: ("ccRecipient", "ccRecipients"), // "crcp"
                ...
                0x69746163: ("iCloudAccount", "iCloudAccounts"), // "itac"
                0x69616374: ("imapAccount", "imapAccounts"), // "iact"
                0x636f626a: ("item", "items"), // "cobj"
                0x6c647365: ("ldapServer", "ldapServers"), // "ldse"
                0x61747463: ("mailAttachment", "mailAttachments"), // "attc"
                0x6d627870: ("mailbox", "mailboxes"), // "mbxp"
                0x6d737367: ("message", "messages"), // "mssg"
                0x6d767772: ("messageViewer", "messageViewers"), // "mvwr"
                0x6d656474: ("OLDMessageEditor", "OLDMessageEditors"), // "medt"
                0x62636b65: ("outgoingMessage", "outgoingMessages"), // "bcke"
                0x63706172: ("paragraph", "paragraphs"), // "cpar"
                0x70616374: ("popAccount", "popAccounts"), // "pact"
                0x72637074: ("recipient", "recipients"), // "rcpt"
                0x63747874: ("richText", "richText"), // "ctxt"
                0x72756372: ("ruleCondition", "ruleConditions"), // "rucr"
                0x72756c65: ("rule", "rules"), // "rule"
                0x73697475: ("signature", "signatures"), // "situ"
                0x64616374: ("smtpServer", "smtpServers"), // "dact"
                0x74726370: ("toRecipient", "toRecipients"), // "trcp"
                0x6377696e: ("window", "windows"), // "cwin"
                0x63776f72: ("word", "words"), // "cwor"
        ])

private let _glueClasses = SwiftAutomation.GlueClasses(
                                                insertionSpecifierType: MAIInsertion.self,
...
public class MAISymbol: SwiftAutomation.Symbol {
    ...
    public override class func symbol(code: OSType, type: OSType = AppleEvents.typeType, descriptor: ScalarDescriptor? = nil) -> MAISymbol {
        switch (code) {
    ...
    // Types/properties
    public static let account = MAISymbol(name: "account", code: 0x6d616374, type: AppleEvents.typeType) // "mact"
    public static let accountDirectory = MAISymbol(name: "accountDirectory", code: 0x70617468, type: AppleEvents.typeType) // "path"
    public static let accountType = MAISymbol(name: "accountType", code: 0x61747970, type: AppleEvents.typeType) // "atyp"
    public static let address = MAISymbol(name: "address", code: 0x72616464, type: AppleEvents.typeType) // "radd"
    public static let alias = MAISymbol(name: "alias", code: 0x616c6973, type: AppleEvents.typeType) // "alis"
    public static let allConditionsMustBeMet = MAISymbol(name: "allConditionsMustBeMet", code: 0x7261636d, type: AppleEvents.typeType) // "racm"
    public static let allHeaders = MAISymbol(name: "allHeaders", code: 0x616c6865, type: AppleEvents.typeType) // "alhe"
    public static let alwaysBccMyself = MAISymbol(name: "alwaysBccMyself", code: 0x6162636d, type: AppleEvents.typeType) // "abcm"
    public static let alwaysCcMyself = MAISymbol(name: "alwaysCcMyself", code: 0x6163636d, type: AppleEvents.typeType) // "accm"
    public static let anything = MAISymbol(name: "anything", code: 0x2a2a2a2a, type: AppleEvents.typeType) // "****"
    public static let application = MAISymbol(name: "application", code: 0x63617070, type: AppleEvents.typeType) // "capp"
    public static let applicationBundleID = MAISymbol(name: "applicationBundleID", code: 0x62756e64, type: AppleEvents.typeType) // "bund"
    public static let applicationSignature = MAISymbol(name: "applicationSignature", code: 0x7369676e, type: AppleEvents.typeType) // "sign"
    public static let applicationURL = MAISymbol(name: "applicationURL", code: 0x6170726c, type: AppleEvents.typeType) // "aprl"
    public static let applicationVersion = MAISymbol(name: "applicationVersion", code: 0x61707665, type: AppleEvents.typeType) // "apve"
    public static let April = MAISymbol(name: "April", code: 0x61707220, type: AppleEvents.typeType) // "apr "
    public static let attachment = MAISymbol(name: "attachment", code: 0x61747473, type: AppleEvents.typeType) // "atts"
    public static let attributeRun = MAISymbol(name: "attributeRun", code: 0x63617472, type: AppleEvents.typeType) // "catr"
    public static let August = MAISymbol(name: "August", code: 0x61756720, type: AppleEvents.typeType) // "aug "
    public static let authentication = MAISymbol(name: "authentication", code: 0x70617573, type: AppleEvents.typeType) // "paus"
    public static let backgroundActivityCount = MAISymbol(name: "backgroundActivityCount", code: 0x62746863, type: AppleEvents.typeType) // "bthc"
    public static let backgroundColor = MAISymbol(name: "backgroundColor", code: 0x6d636f6c, type: AppleEvents.typeType) // "mcol"
    public static let bccRecipient = MAISymbol(name: "bccRecipient", code: 0x62726370, type: AppleEvents.typeType) // "brcp"
    public static let best = MAISymbol(name: "best", code: 0x62657374, type: AppleEvents.typeType) // "best"
    public static let bigMessageWarningSize = MAISymbol(name: "bigMessageWarningSize", code: 0x626d7773, type: AppleEvents.typeType) // "bmws"
    public static let bookmarkData = MAISymbol(name: "bookmarkData", code: 0x626d726b, type: AppleEvents.typeType) // "bmrk"
    public static let boolean = MAISymbol(name: "boolean", code: 0x626f6f6c, type: AppleEvents.typeType) // "bool"
    public static let boundingRectangle = MAISymbol(name: "boundingRectangle", code: 0x71647274, type: AppleEvents.typeType) // "qdrt"
    public static let bounds = MAISymbol(name: "bounds", code: 0x70626e64, type: AppleEvents.typeType) // "pbnd"
    public static let ccRecipient = MAISymbol(name: "ccRecipient", code: 0x63726370, type: AppleEvents.typeType) // "crcp"
    public static let character = MAISymbol(name: "character", code: 0x63686120, type: AppleEvents.typeType) // "cha "
    public static let checkSpellingWhileTyping = MAISymbol(name: "checkSpellingWhileTyping", code: 0x63687370, type: AppleEvents.typeType) // "chsp"
    public static let chooseSignatureWhenComposing = MAISymbol(name: "chooseSignatureWhenComposing", code: 0x63737763, type: AppleEvents.typeType) // "cswc"
    public static let class_ = MAISymbol(name: "class_", code: 0x70636c73, type: AppleEvents.typeType) // "pcls"
    public static let closeable = MAISymbol(name: "closeable", code: 0x68636c62, type: AppleEvents.typeType) // "hclb"
    public static let collating = MAISymbol(name: "collating", code: 0x6c77636c, type: AppleEvents.typeType) // "lwcl"
    public static let color = MAISymbol(name: "color", code: 0x636f6c72, type: AppleEvents.typeType) // "colr"
    public static let colorMessage = MAISymbol(name: "colorMessage", code: 0x72636d65, type: AppleEvents.typeType) // "rcme"
    public static let colorQuotedText = MAISymbol(name: "colorQuotedText", code: 0x6d636374, type: AppleEvents.typeType) // "mcct"
    public static let colorTable = MAISymbol(name: "colorTable", code: 0x636c7274, type: AppleEvents.typeType) // "clrt"
    public static let compactMailboxesWhenClosing = MAISymbol(name: "compactMailboxesWhenClosing", code: 0x6377636d, type: AppleEvents.typeType) // "cwcm"
    public static let constant = MAISymbol(name: "constant", code: 0x656e756d, type: AppleEvents.typeType) // "enum"
    public static let container = MAISymbol(name: "container", code: 0x6d627863, type: AppleEvents.typeType) // "mbxc"
    public static let content = MAISymbol(name: "content", code: 0x63746e74, type: AppleEvents.typeType) // "ctnt"
    public static let copies = MAISymbol(name: "copies", code: 0x6c776370, type: AppleEvents.typeType) // "lwcp"
    public static let copyMessage = MAISymbol(name: "copyMessage", code: 0x72636d62, type: AppleEvents.typeType) // "rcmb"
    public static let dashStyle = MAISymbol(name: "dashStyle", code: 0x74646173, type: AppleEvents.typeType) // "tdas"
    public static let data = MAISymbol(name: "data", code: 0x74647461, type: AppleEvents.typeType) // "tdta"
    public static let date = MAISymbol(name: "date", code: 0x6c647420, type: AppleEvents.typeType) // "ldt "
    public static let dateReceived = MAISymbol(name: "dateReceived", code: 0x72647263, type: AppleEvents.typeType) // "rdrc"
    public static let dateSent = MAISymbol(name: "dateSent", code: 0x64726376, type: AppleEvents.typeType) // "drcv"
    public static let December = MAISymbol(name: "December", code: 0x64656320, type: AppleEvents.typeType) // "dec "
    public static let decimalStruct = MAISymbol(name: "decimalStruct", code: 0x6465636d, type: AppleEvents.typeType) // "decm"
    public static let defaultMessageFormat = MAISymbol(name: "defaultMessageFormat", code: 0x64656d66, type: AppleEvents.typeType) // "demf"
    public static let delayedMessageDeletionInterval = MAISymbol(name: "delayedMessageDeletionInterval", code: 0x646d6469, type: AppleEvents.typeType) // "dmdi"
    public static let deletedStatus = MAISymbol(name: "deletedStatus", code: 0x6973646c, type: AppleEvents.typeType) // "isdl"
    public static let deleteMailOnServer = MAISymbol(name: "deleteMailOnServer", code: 0x646d6f73, type: AppleEvents.typeType) // "dmos"
    public static let deleteMessage = MAISymbol(name: "deleteMessage", code: 0x72646d65, type: AppleEvents.typeType) // "rdme"
    public static let deleteMessagesWhenMovedFromInbox = MAISymbol(name: "deleteMessagesWhenMovedFromInbox", code: 0x646d776d, type: AppleEvents.typeType) // "dmwm"
    public static let deliveryAccount = MAISymbol(name: "deliveryAccount", code: 0x64616374, type: AppleEvents.typeType) // "dact"
    public static let document = MAISymbol(name: "document", code: 0x646f6375, type: AppleEvents.typeType) // "docu"
    public static let doubleInteger = MAISymbol(name: "doubleInteger", code: 0x636f6d70, type: AppleEvents.typeType) // "comp"
    public static let downloaded = MAISymbol(name: "downloaded", code: 0x6174646e, type: AppleEvents.typeType) // "atdn"
    public static let downloadHtmlAttachments = MAISymbol(name: "downloadHtmlAttachments", code: 0x64687461, type: AppleEvents.typeType) // "dhta"
    public static let draftsMailbox = MAISymbol(name: "draftsMailbox", code: 0x64726d62, type: AppleEvents.typeType) // "drmb"
    public static let emailAddresses = MAISymbol(name: "emailAddresses", code: 0x656d6164, type: AppleEvents.typeType) // "emad"
    public static let emptyJunkMessagesFrequency = MAISymbol(name: "emptyJunkMessagesFrequency", code: 0x656a6d66, type: AppleEvents.typeType) // "ejmf"
    public static let emptyJunkMessagesOnQuit = MAISymbol(name: "emptyJunkMessagesOnQuit", code: 0x656a6d6f, type: AppleEvents.typeType) // "ejmo"
    public static let emptySentMessagesFrequency = MAISymbol(name: "emptySentMessagesFrequency", code: 0x65736d66, type: AppleEvents.typeType) // "esmf"
    public static let emptySentMessagesOnQuit = MAISymbol(name: "emptySentMessagesOnQuit", code: 0x65736d6f, type: AppleEvents.typeType) // "esmo"
    public static let emptyTrashFrequency = MAISymbol(name: "emptyTrashFrequency", code: 0x65747266, type: AppleEvents.typeType) // "etrf"
    public static let emptyTrashOnQuit = MAISymbol(name: "emptyTrashOnQuit", code: 0x65746f71, type: AppleEvents.typeType) // "etoq"
    public static let enabled = MAISymbol(name: "enabled", code: 0x69736163, type: AppleEvents.typeType) // "isac"
    public static let encodedString = MAISymbol(name: "encodedString", code: 0x656e6373, type: AppleEvents.typeType) // "encs"
    public static let endingPage = MAISymbol(name: "endingPage", code: 0x6c776c70, type: AppleEvents.typeType) // "lwlp"
    public static let EPSPicture = MAISymbol(name: "EPSPicture", code: 0x45505320, type: AppleEvents.typeType) // "EPS "
    public static let errorHandling = MAISymbol(name: "errorHandling", code: 0x6c776568, type: AppleEvents.typeType) // "lweh"
    public static let expandGroupAddresses = MAISymbol(name: "expandGroupAddresses", code: 0x65786761, type: AppleEvents.typeType) // "exga"
    public static let expression = MAISymbol(name: "expression", code: 0x72657870, type: AppleEvents.typeType) // "rexp"
    public static let faxNumber = MAISymbol(name: "faxNumber", code: 0x6661786e, type: AppleEvents.typeType) // "faxn"
    public static let February = MAISymbol(name: "February", code: 0x66656220, type: AppleEvents.typeType) // "feb "
    public static let fetchesAutomatically = MAISymbol(name: "fetchesAutomatically", code: 0x73616674, type: AppleEvents.typeType) // "saft"
    public static let fetchInterval = MAISymbol(name: "fetchInterval", code: 0x61666671, type: AppleEvents.typeType) // "affq"
    public static let file = MAISymbol(name: "file", code: 0x66696c65, type: AppleEvents.typeType) // "file"
    public static let fileName = MAISymbol(name: "fileName", code: 0x6174666e, type: AppleEvents.typeType) // "atfn"
    public static let fileRef = MAISymbol(name: "fileRef", code: 0x66737266, type: AppleEvents.typeType) // "fsrf"
    public static let fileSize = MAISymbol(name: "fileSize", code: 0x6174737a, type: AppleEvents.typeType) // "atsz"
    public static let fileURL = MAISymbol(name: "fileURL", code: 0x6675726c, type: AppleEvents.typeType) // "furl"
    public static let fixed = MAISymbol(name: "fixed", code: 0x66697864, type: AppleEvents.typeType) // "fixd"
    public static let fixedPoint = MAISymbol(name: "fixedPoint", code: 0x66706e74, type: AppleEvents.typeType) // "fpnt"
    public static let fixedRectangle = MAISymbol(name: "fixedRectangle", code: 0x66726374, type: AppleEvents.typeType) // "frct"
    public static let fixedWidthFont = MAISymbol(name: "fixedWidthFont", code: 0x6d707466, type: AppleEvents.typeType) // "mptf"
    public static let fixedWidthFontSize = MAISymbol(name: "fixedWidthFontSize", code: 0x70746673, type: AppleEvents.typeType) // "ptfs"
    public static let flaggedStatus = MAISymbol(name: "flaggedStatus", code: 0x6973666c, type: AppleEvents.typeType) // "isfl"
    public static let flagIndex = MAISymbol(name: "flagIndex", code: 0x66696478, type: AppleEvents.typeType) // "fidx"
    public static let font = MAISymbol(name: "font", code: 0x666f6e74, type: AppleEvents.typeType) // "font"
    public static let forwardMessage = MAISymbol(name: "forwardMessage", code: 0x72666164, type: AppleEvents.typeType) // "rfad"
    public static let forwardText = MAISymbol(name: "forwardText", code: 0x72667465, type: AppleEvents.typeType) // "rfte"
    public static let frameworkVersion = MAISymbol(name: "frameworkVersion", code: 0x66727665, type: AppleEvents.typeType) // "frve"
    public static let Friday = MAISymbol(name: "Friday", code: 0x66726920, type: AppleEvents.typeType) // "fri "
    public static let frontmost = MAISymbol(name: "frontmost", code: 0x70697366, type: AppleEvents.typeType) // "pisf"
    public static let fullName = MAISymbol(name: "fullName", code: 0x666c6c6e, type: AppleEvents.typeType) // "flln"
    public static let GIFPicture = MAISymbol(name: "GIFPicture", code: 0x47494666, type: AppleEvents.typeType) // "GIFf"
    public static let graphicText = MAISymbol(name: "graphicText", code: 0x63677478, type: AppleEvents.typeType) // "cgtx"
    public static let header = MAISymbol(name: "header", code: 0x6d686472, type: AppleEvents.typeType) // "mhdr"
    public static let headerDetail = MAISymbol(name: "headerDetail", code: 0x6865646c, type: AppleEvents.typeType) // "hedl"
    public static let highlightSelectedConversation = MAISymbol(name: "highlightSelectedConversation", code: 0x73686874, type: AppleEvents.typeType) // "shht"
    public static let highlightTextUsingColor = MAISymbol(name: "highlightTextUsingColor", code: 0x68747563, type: AppleEvents.typeType) // "htuc"
    public static let hostName = MAISymbol(name: "hostName", code: 0x6c647361, type: AppleEvents.typeType) // "ldsa"
    public static let hostsToLogActivityOn = MAISymbol(name: "hostsToLogActivityOn", code: 0x6c616f68, type: AppleEvents.typeType) // "laoh"
    public static let htmlContent = MAISymbol(name: "htmlContent", code: 0x68746461, type: AppleEvents.typeType) // "htda"
    public static let iCloudAccount = MAISymbol(name: "iCloudAccount", code: 0x69746163, type: AppleEvents.typeType) // "itac"
    public static let id = MAISymbol(name: "id", code: 0x49442020, type: AppleEvents.typeType) // "ID  "
    public static let imapAccount = MAISymbol(name: "imapAccount", code: 0x69616374, type: AppleEvents.typeType) // "iact"
    public static let inbox = MAISymbol(name: "inbox", code: 0x696e6d62, type: AppleEvents.typeType) // "inmb"
    public static let includeAllOriginalMessageText = MAISymbol(name: "includeAllOriginalMessageText", code: 0x69616f6f, type: AppleEvents.typeType) // "iaoo"
    public static let includeWhenGettingNewMail = MAISymbol(name: "includeWhenGettingNewMail", code: 0x6977676d, type: AppleEvents.typeType) // "iwgm"
    public static let index = MAISymbol(name: "index", code: 0x70696478, type: AppleEvents.typeType) // "pidx"
    public static let integer = MAISymbol(name: "integer", code: 0x6c6f6e67, type: AppleEvents.typeType) // "long"
    public static let internationalText = MAISymbol(name: "internationalText", code: 0x69747874, type: AppleEvents.typeType) // "itxt"
    public static let internationalWritingCode = MAISymbol(name: "internationalWritingCode", code: 0x696e746c, type: AppleEvents.typeType) // "intl"
    public static let item = MAISymbol(name: "item", code: 0x636f626a, type: AppleEvents.typeType) // "cobj"
    public static let January = MAISymbol(name: "January", code: 0x6a616e20, type: AppleEvents.typeType) // "jan "
    public static let JPEGPicture = MAISymbol(name: "JPEGPicture", code: 0x4a504547, type: AppleEvents.typeType) // "JPEG"
    public static let July = MAISymbol(name: "July", code: 0x6a756c20, type: AppleEvents.typeType) // "jul "
    public static let June = MAISymbol(name: "June", code: 0x6a756e20, type: AppleEvents.typeType) // "jun "
    public static let junkMailbox = MAISymbol(name: "junkMailbox", code: 0x6a6b6d62, type: AppleEvents.typeType) // "jkmb"
    public static let junkMailStatus = MAISymbol(name: "junkMailStatus", code: 0x69736a6b, type: AppleEvents.typeType) // "isjk"
    public static let kernelProcessID = MAISymbol(name: "kernelProcessID", code: 0x6b706964, type: AppleEvents.typeType) // "kpid"
    public static let largeReal = MAISymbol(name: "largeReal", code: 0x6c64626c, type: AppleEvents.typeType) // "ldbl"
    public static let ldapServer = MAISymbol(name: "ldapServer", code: 0x6c647365, type: AppleEvents.typeType) // "ldse"
    public static let levelOneQuotingColor = MAISymbol(name: "levelOneQuotingColor", code: 0x6c6f7163, type: AppleEvents.typeType) // "loqc"
    public static let levelThreeQuotingColor = MAISymbol(name: "levelThreeQuotingColor", code: 0x6c687163, type: AppleEvents.typeType) // "lhqc"
    public static let levelTwoQuotingColor = MAISymbol(name: "levelTwoQuotingColor", code: 0x6c777163, type: AppleEvents.typeType) // "lwqc"
    public static let list = MAISymbol(name: "list", code: 0x6c697374, type: AppleEvents.typeType) // "list"
    public static let locationReference = MAISymbol(name: "locationReference", code: 0x696e736c, type: AppleEvents.typeType) // "insl"
    public static let logAllSocketActivity = MAISymbol(name: "logAllSocketActivity", code: 0x6c616173, type: AppleEvents.typeType) // "laas"
    public static let longFixed = MAISymbol(name: "longFixed", code: 0x6c667864, type: AppleEvents.typeType) // "lfxd"
    public static let longFixedPoint = MAISymbol(name: "longFixedPoint", code: 0x6c667074, type: AppleEvents.typeType) // "lfpt"
    public static let longFixedRectangle = MAISymbol(name: "longFixedRectangle", code: 0x6c667263, type: AppleEvents.typeType) // "lfrc"
    public static let longPoint = MAISymbol(name: "longPoint", code: 0x6c706e74, type: AppleEvents.typeType) // "lpnt"
    public static let longRectangle = MAISymbol(name: "longRectangle", code: 0x6c726374, type: AppleEvents.typeType) // "lrct"
    public static let machine = MAISymbol(name: "machine", code: 0x6d616368, type: AppleEvents.typeType) // "mach"
    public static let machineLocation = MAISymbol(name: "machineLocation", code: 0x6d4c6f63, type: AppleEvents.typeType) // "mLoc"
    public static let machPort = MAISymbol(name: "machPort", code: 0x706f7274, type: AppleEvents.typeType) // "port"
    public static let mailAttachment = MAISymbol(name: "mailAttachment", code: 0x61747463, type: AppleEvents.typeType) // "attc"
    public static let mailbox = MAISymbol(name: "mailbox", code: 0x6d627870, type: AppleEvents.typeType) // "mbxp"
    public static let mailboxListVisible = MAISymbol(name: "mailboxListVisible", code: 0x6d6c7368, type: AppleEvents.typeType) // "mlsh"
    public static let March = MAISymbol(name: "March", code: 0x6d617220, type: AppleEvents.typeType) // "mar "
    public static let markFlagged = MAISymbol(name: "markFlagged", code: 0x726d666c, type: AppleEvents.typeType) // "rmfl"
    public static let markFlagIndex = MAISymbol(name: "markFlagIndex", code: 0x7266636c, type: AppleEvents.typeType) // "rfcl"
    public static let markRead = MAISymbol(name: "markRead", code: 0x726d7265, type: AppleEvents.typeType) // "rmre"
    public static let May = MAISymbol(name: "May", code: 0x6d617920, type: AppleEvents.typeType) // "may "
    public static let memoryStatistics = MAISymbol(name: "memoryStatistics", code: 0x6d656d73, type: AppleEvents.typeType) // "mems"
    public static let message = MAISymbol(name: "message", code: 0x6d737367, type: AppleEvents.typeType) // "mssg"
    public static let messageCaching = MAISymbol(name: "messageCaching", code: 0x6d736763, type: AppleEvents.typeType) // "msgc"
    public static let messageFont = MAISymbol(name: "messageFont", code: 0x6d6d666e, type: AppleEvents.typeType) // "mmfn"
    public static let messageFontSize = MAISymbol(name: "messageFontSize", code: 0x6d6d6673, type: AppleEvents.typeType) // "mmfs"
    public static let messageId = MAISymbol(name: "messageId", code: 0x6d656964, type: AppleEvents.typeType) // "meid"
    public static let messageListFont = MAISymbol(name: "messageListFont", code: 0x6d6d6c66, type: AppleEvents.typeType) // "mmlf"
    public static let messageListFontSize = MAISymbol(name: "messageListFontSize", code: 0x6d6c6673, type: AppleEvents.typeType) // "mlfs"
    public static let messageSignature = MAISymbol(name: "messageSignature", code: 0x746e7267, type: AppleEvents.typeType) // "tnrg"
    public static let messageSize = MAISymbol(name: "messageSize", code: 0x6d737a65, type: AppleEvents.typeType) // "msze"
    public static let messageViewer = MAISymbol(name: "messageViewer", code: 0x6d767772, type: AppleEvents.typeType) // "mvwr"
    public static let MIMEType = MAISymbol(name: "MIMEType", code: 0x61747470, type: AppleEvents.typeType) // "attp"
    public static let miniaturizable = MAISymbol(name: "miniaturizable", code: 0x69736d6e, type: AppleEvents.typeType) // "ismn"
    public static let miniaturized = MAISymbol(name: "miniaturized", code: 0x706d6e64, type: AppleEvents.typeType) // "pmnd"
    public static let modified = MAISymbol(name: "modified", code: 0x696d6f64, type: AppleEvents.typeType) // "imod"
    public static let Monday = MAISymbol(name: "Monday", code: 0x6d6f6e20, type: AppleEvents.typeType) // "mon "
    public static let moveDeletedMessagesToTrash = MAISymbol(name: "moveDeletedMessagesToTrash", code: 0x736d646d, type: AppleEvents.typeType) // "smdm"
    public static let moveMessage = MAISymbol(name: "moveMessage", code: 0x72746d65, type: AppleEvents.typeType) // "rtme"
    public static let name = MAISymbol(name: "name", code: 0x706e616d, type: AppleEvents.typeType) // "pnam"
    public static let newMailSound = MAISymbol(name: "newMailSound", code: 0x6d6e6d73, type: AppleEvents.typeType) // "mnms"
    public static let November = MAISymbol(name: "November", code: 0x6e6f7620, type: AppleEvents.typeType) // "nov "
    public static let null = MAISymbol(name: "null", code: 0x6e756c6c, type: AppleEvents.typeType) // "null"
    public static let October = MAISymbol(name: "October", code: 0x6f637420, type: AppleEvents.typeType) // "oct "
    public static let OLDComposeMessage = MAISymbol(name: "OLDComposeMessage", code: 0x62636b65, type: AppleEvents.typeType) // "bcke"
    public static let OLDMessageEditor = MAISymbol(name: "OLDMessageEditor", code: 0x6d656474, type: AppleEvents.typeType) // "medt"
    public static let outbox = MAISymbol(name: "outbox", code: 0x6f756d62, type: AppleEvents.typeType) // "oumb"
    public static let outgoingMessage = MAISymbol(name: "outgoingMessage", code: 0x62636b65, type: AppleEvents.typeType) // "bcke"
    public static let pagesAcross = MAISymbol(name: "pagesAcross", code: 0x6c776c61, type: AppleEvents.typeType) // "lwla"
    public static let pagesDown = MAISymbol(name: "pagesDown", code: 0x6c776c64, type: AppleEvents.typeType) // "lwld"
    public static let paragraph = MAISymbol(name: "paragraph", code: 0x63706172, type: AppleEvents.typeType) // "cpar"
    public static let PICTPicture = MAISymbol(name: "PICTPicture", code: 0x50494354, type: AppleEvents.typeType) // "PICT"
    public static let pixelMapRecord = MAISymbol(name: "pixelMapRecord", code: 0x74706d6d, type: AppleEvents.typeType) // "tpmm"
    public static let playSound = MAISymbol(name: "playSound", code: 0x7270736f, type: AppleEvents.typeType) // "rpso"
    public static let point = MAISymbol(name: "point", code: 0x51447074, type: AppleEvents.typeType) // "QDpt"
    public static let popAccount = MAISymbol(name: "popAccount", code: 0x70616374, type: AppleEvents.typeType) // "pact"
    public static let port = MAISymbol(name: "port", code: 0x706f7274, type: AppleEvents.typeType) // "port"
    public static let portsToLogActivityOn = MAISymbol(name: "portsToLogActivityOn", code: 0x6c616f70, type: AppleEvents.typeType) // "laop"
    public static let previewPaneIsVisible = MAISymbol(name: "previewPaneIsVisible", code: 0x6d767076, type: AppleEvents.typeType) // "mvpv"
    public static let primaryEmail = MAISymbol(name: "primaryEmail", code: 0x75656d6c, type: AppleEvents.typeType) // "ueml"
    public static let printSettings = MAISymbol(name: "printSettings", code: 0x70736574, type: AppleEvents.typeType) // "pset"
    public static let processSerialNumber = MAISymbol(name: "processSerialNumber", code: 0x70736e20, type: AppleEvents.typeType) // "psn "
    public static let properties = MAISymbol(name: "properties", code: 0x70414c4c, type: AppleEvents.typeType) // "pALL"
    public static let property_ = MAISymbol(name: "property_", code: 0x70726f70, type: AppleEvents.typeType) // "prop"
    public static let qualifier = MAISymbol(name: "qualifier", code: 0x72717561, type: AppleEvents.typeType) // "rqua"
    public static let quoteOriginalMessage = MAISymbol(name: "quoteOriginalMessage", code: 0x696e6f6d, type: AppleEvents.typeType) // "inom"
    public static let readStatus = MAISymbol(name: "readStatus", code: 0x69737264, type: AppleEvents.typeType) // "isrd"
    public static let real = MAISymbol(name: "real", code: 0x646f7562, type: AppleEvents.typeType) // "doub"
    public static let recipient = MAISymbol(name: "recipient", code: 0x72637074, type: AppleEvents.typeType) // "rcpt"
    public static let record = MAISymbol(name: "record", code: 0x7265636f, type: AppleEvents.typeType) // "reco"
    public static let redirectMessage = MAISymbol(name: "redirectMessage", code: 0x72726164, type: AppleEvents.typeType) // "rrad"
    public static let reference = MAISymbol(name: "reference", code: 0x6f626a20, type: AppleEvents.typeType) // "obj "
    public static let replyText = MAISymbol(name: "replyText", code: 0x72727465, type: AppleEvents.typeType) // "rrte"
    public static let replyTo = MAISymbol(name: "replyTo", code: 0x7270746f, type: AppleEvents.typeType) // "rpto"
    public static let requestedPrintTime = MAISymbol(name: "requestedPrintTime", code: 0x6c777174, type: AppleEvents.typeType) // "lwqt"
    public static let resizable = MAISymbol(name: "resizable", code: 0x7072737a, type: AppleEvents.typeType) // "prsz"
    public static let RGB16Color = MAISymbol(name: "RGB16Color", code: 0x74723136, type: AppleEvents.typeType) // "tr16"
    public static let RGB96Color = MAISymbol(name: "RGB96Color", code: 0x74723936, type: AppleEvents.typeType) // "tr96"
    public static let RGBColor = MAISymbol(name: "RGBColor", code: 0x63524742, type: AppleEvents.typeType) // "cRGB"
    public static let richText = MAISymbol(name: "richText", code: 0x63747874, type: AppleEvents.typeType) // "ctxt"
    public static let rotation = MAISymbol(name: "rotation", code: 0x74726f74, type: AppleEvents.typeType) // "trot"
    public static let rule = MAISymbol(name: "rule", code: 0x72756c65, type: AppleEvents.typeType) // "rule"
    public static let ruleCondition = MAISymbol(name: "ruleCondition", code: 0x72756372, type: AppleEvents.typeType) // "rucr"
    public static let ruleType = MAISymbol(name: "ruleType", code: 0x72747970, type: AppleEvents.typeType) // "rtyp"
    public static let runScript = MAISymbol(name: "runScript", code: 0x72726173, type: AppleEvents.typeType) // "rras"
    public static let sameReplyFormat = MAISymbol(name: "sameReplyFormat", code: 0x72697366, type: AppleEvents.typeType) // "risf"
    public static let Saturday = MAISymbol(name: "Saturday", code: 0x73617420, type: AppleEvents.typeType) // "sat "
    public static let scope = MAISymbol(name: "scope", code: 0x6c647363, type: AppleEvents.typeType) // "ldsc"
    public static let script = MAISymbol(name: "script", code: 0x73637074, type: AppleEvents.typeType) // "scpt"
    public static let searchBase = MAISymbol(name: "searchBase", code: 0x6c647362, type: AppleEvents.typeType) // "ldsb"
    public static let selectedMailboxes = MAISymbol(name: "selectedMailboxes", code: 0x6d736278, type: AppleEvents.typeType) // "msbx"
    public static let selectedMessages = MAISymbol(name: "selectedMessages", code: 0x736d6773, type: AppleEvents.typeType) // "smgs"
    public static let selectedSignature = MAISymbol(name: "selectedSignature", code: 0x73657369, type: AppleEvents.typeType) // "sesi"
    public static let selection = MAISymbol(name: "selection", code: 0x736c6374, type: AppleEvents.typeType) // "slct"
    public static let sender = MAISymbol(name: "sender", code: 0x736e6472, type: AppleEvents.typeType) // "sndr"
    public static let sentMailbox = MAISymbol(name: "sentMailbox", code: 0x73746d62, type: AppleEvents.typeType) // "stmb"
    public static let September = MAISymbol(name: "September", code: 0x73657020, type: AppleEvents.typeType) // "sep "
    public static let serverName = MAISymbol(name: "serverName", code: 0x686f7374, type: AppleEvents.typeType) // "host"
    public static let shortInteger = MAISymbol(name: "shortInteger", code: 0x73686f72, type: AppleEvents.typeType) // "shor"
    public static let shouldCopyMessage = MAISymbol(name: "shouldCopyMessage", code: 0x7273636d, type: AppleEvents.typeType) // "rscm"
    public static let shouldMoveMessage = MAISymbol(name: "shouldMoveMessage", code: 0x7273746d, type: AppleEvents.typeType) // "rstm"
    public static let shouldPlayOtherMailSounds = MAISymbol(name: "shouldPlayOtherMailSounds", code: 0x706f6d73, type: AppleEvents.typeType) // "poms"
    public static let signature = MAISymbol(name: "signature", code: 0x73697475, type: AppleEvents.typeType) // "situ"
    public static let size = MAISymbol(name: "size", code: 0x7074737a, type: AppleEvents.typeType) // "ptsz"
    public static let smallReal = MAISymbol(name: "smallReal", code: 0x73696e67, type: AppleEvents.typeType) // "sing"
    public static let smtpServer = MAISymbol(name: "smtpServer", code: 0x64616374, type: AppleEvents.typeType) // "dact"
    public static let sortColumn = MAISymbol(name: "sortColumn", code: 0x6d767363, type: AppleEvents.typeType) // "mvsc"
    public static let sortedAscending = MAISymbol(name: "sortedAscending", code: 0x6d767372, type: AppleEvents.typeType) // "mvsr"
    public static let source = MAISymbol(name: "source", code: 0x7261736f, type: AppleEvents.typeType) // "raso"
    public static let startingPage = MAISymbol(name: "startingPage", code: 0x6c776670, type: AppleEvents.typeType) // "lwfp"
    public static let stopEvaluatingRules = MAISymbol(name: "stopEvaluatingRules", code: 0x72736572, type: AppleEvents.typeType) // "rser"
    public static let storeDeletedMessagesOnServer = MAISymbol(name: "storeDeletedMessagesOnServer", code: 0x73746f73, type: AppleEvents.typeType) // "stos"
    public static let storeDraftsOnServer = MAISymbol(name: "storeDraftsOnServer", code: 0x73646f73, type: AppleEvents.typeType) // "sdos"
    public static let storeJunkMailOnServer = MAISymbol(name: "storeJunkMailOnServer", code: 0x736a6f73, type: AppleEvents.typeType) // "sjos"
    public static let storeSentMessagesOnServer = MAISymbol(name: "storeSentMessagesOnServer", code: 0x73736f73, type: AppleEvents.typeType) // "ssos"
    public static let string = MAISymbol(name: "string", code: 0x54455854, type: AppleEvents.typeType) // "TEXT"
    public static let styledClipboardText = MAISymbol(name: "styledClipboardText", code: 0x7374796c, type: AppleEvents.typeType) // "styl"
    public static let styledText = MAISymbol(name: "styledText", code: 0x53545854, type: AppleEvents.typeType) // "STXT"
    public static let subject = MAISymbol(name: "subject", code: 0x7375626a, type: AppleEvents.typeType) // "subj"
    public static let Sunday = MAISymbol(name: "Sunday", code: 0x73756e20, type: AppleEvents.typeType) // "sun "
    public static let targetPrinter = MAISymbol(name: "targetPrinter", code: 0x74727072, type: AppleEvents.typeType) // "trpr"
    public static let textStyleInfo = MAISymbol(name: "textStyleInfo", code: 0x74737479, type: AppleEvents.typeType) // "tsty"
    public static let Thursday = MAISymbol(name: "Thursday", code: 0x74687520, type: AppleEvents.typeType) // "thu "
    public static let TIFFPicture = MAISymbol(name: "TIFFPicture", code: 0x54494646, type: AppleEvents.typeType) // "TIFF"
    public static let toRecipient = MAISymbol(name: "toRecipient", code: 0x74726370, type: AppleEvents.typeType) // "trcp"
    public static let trashMailbox = MAISymbol(name: "trashMailbox", code: 0x74726d62, type: AppleEvents.typeType) // "trmb"
    public static let Tuesday = MAISymbol(name: "Tuesday", code: 0x74756520, type: AppleEvents.typeType) // "tue "
    public static let typeClass = MAISymbol(name: "typeClass", code: 0x74797065, type: AppleEvents.typeType) // "type"
    public static let UnicodeText = MAISymbol(name: "UnicodeText", code: 0x75747874, type: AppleEvents.typeType) // "utxt"
    public static let unreadCount = MAISymbol(name: "unreadCount", code: 0x6d627563, type: AppleEvents.typeType) // "mbuc"
    public static let unsignedDoubleInteger = MAISymbol(name: "unsignedDoubleInteger", code: 0x75636f6d, type: AppleEvents.typeType) // "ucom"
    public static let unsignedInteger = MAISymbol(name: "unsignedInteger", code: 0x6d61676e, type: AppleEvents.typeType) // "magn"
    public static let unsignedShortInteger = MAISymbol(name: "unsignedShortInteger", code: 0x75736872, type: AppleEvents.typeType) // "ushr"
    public static let useAddressCompletion = MAISymbol(name: "useAddressCompletion", code: 0x75736c61, type: AppleEvents.typeType) // "usla"
    public static let useFixedWidthFont = MAISymbol(name: "useFixedWidthFont", code: 0x75667766, type: AppleEvents.typeType) // "ufwf"
    public static let useKeychain = MAISymbol(name: "useKeychain", code: 0x75736b65, type: AppleEvents.typeType) // "uske"
    public static let userName = MAISymbol(name: "userName", code: 0x756e6d65, type: AppleEvents.typeType) // "unme"
    public static let usesSsl = MAISymbol(name: "usesSsl", code: 0x75737373, type: AppleEvents.typeType) // "usss"
    public static let UTF16Text = MAISymbol(name: "UTF16Text", code: 0x75743136, type: AppleEvents.typeType) // "ut16"
    public static let UTF8Text = MAISymbol(name: "UTF8Text", code: 0x75746638, type: AppleEvents.typeType) // "utf8"
    public static let vcardPath = MAISymbol(name: "vcardPath", code: 0x68747663, type: AppleEvents.typeType) // "htvc"
    public static let version = MAISymbol(name: "version", code: 0x76657273, type: AppleEvents.typeType) // "vers"
    public static let visible = MAISymbol(name: "visible", code: 0x70766973, type: AppleEvents.typeType) // "pvis"
    public static let visibleColumns = MAISymbol(name: "visibleColumns", code: 0x6d767663, type: AppleEvents.typeType) // "mvvc"
    public static let visibleMessages = MAISymbol(name: "visibleMessages", code: 0x6d76666d, type: AppleEvents.typeType) // "mvfm"
    public static let wasForwarded = MAISymbol(name: "wasForwarded", code: 0x69736677, type: AppleEvents.typeType) // "isfw"
    public static let wasRedirected = MAISymbol(name: "wasRedirected", code: 0x69737263, type: AppleEvents.typeType) // "isrc"
    public static let wasRepliedTo = MAISymbol(name: "wasRepliedTo", code: 0x69737270, type: AppleEvents.typeType) // "isrp"
    public static let Wednesday = MAISymbol(name: "Wednesday", code: 0x77656420, type: AppleEvents.typeType) // "wed "
    public static let window = MAISymbol(name: "window", code: 0x6377696e, type: AppleEvents.typeType) // "cwin"
    public static let word = MAISymbol(name: "word", code: 0x63776f72, type: AppleEvents.typeType) // "cwor"
    public static let writingCode = MAISymbol(name: "writingCode", code: 0x70736374, type: AppleEvents.typeType) // "psct"
    public static let zoomable = MAISymbol(name: "zoomable", code: 0x69737a6d, type: AppleEvents.typeType) // "iszm"
    public static let zoomed = MAISymbol(name: "zoomed", code: 0x707a756d, type: AppleEvents.typeType) // "pzum"

    // Enumerators
    public static let all_ = MAISymbol(name: "all_", code: 0x6864616c, type: AppleEvents.typeEnumerated) // "hdal"
    public static let allMessagesAndTheirAttachments = MAISymbol(name: "allMessagesAndTheirAttachments", code: 0x7839616c, type: AppleEvents.typeEnumerated) // "x9al"
    public static let allMessagesButOmitAttachments = MAISymbol(name: "allMessagesButOmitAttachments", code: 0x7839626f, type: AppleEvents.typeEnumerated) // "x9bo"
    public static let anyRecipient = MAISymbol(name: "anyRecipient", code: 0x74616e72, type: AppleEvents.typeEnumerated) // "tanr"
    public static let apop = MAISymbol(name: "apop", code: 0x6161706f, type: AppleEvents.typeEnumerated) // "aapo"
    public static let AppleToken = MAISymbol(name: "AppleToken", code: 0x61746f6b, type: AppleEvents.typeEnumerated) // "atok"
    public static let ask = MAISymbol(name: "ask", code: 0x61736b20, type: AppleEvents.typeEnumerated) // "ask "
    public static let attachmentsColumn = MAISymbol(name: "attachmentsColumn", code: 0x65636174, type: AppleEvents.typeEnumerated) // "ecat"
    public static let attachmentType = MAISymbol(name: "attachmentType", code: 0x74617474, type: AppleEvents.typeEnumerated) // "tatt"
    public static let base = MAISymbol(name: "base", code: 0x6c736261, type: AppleEvents.typeEnumerated) // "lsba"
    public static let beginsWithValue = MAISymbol(name: "beginsWithValue", code: 0x72716277, type: AppleEvents.typeEnumerated) // "rqbw"
    public static let blue = MAISymbol(name: "blue", code: 0x6363626c, type: AppleEvents.typeEnumerated) // "ccbl"
    public static let case_ = MAISymbol(name: "case_", code: 0x63617365, type: AppleEvents.typeEnumerated) // "case"
    public static let ccHeader = MAISymbol(name: "ccHeader", code: 0x74636363, type: AppleEvents.typeEnumerated) // "tccc"
    public static let custom = MAISymbol(name: "custom", code: 0x68646375, type: AppleEvents.typeEnumerated) // "hdcu"
    public static let dateLastSavedColumn = MAISymbol(name: "dateLastSavedColumn", code: 0x65636c73, type: AppleEvents.typeEnumerated) // "ecls"
    public static let dateReceivedColumn = MAISymbol(name: "dateReceivedColumn", code: 0x65636472, type: AppleEvents.typeEnumerated) // "ecdr"
    public static let dateSentColumn = MAISymbol(name: "dateSentColumn", code: 0x65636473, type: AppleEvents.typeEnumerated) // "ecds"
    public static let default_ = MAISymbol(name: "default_", code: 0x68646465, type: AppleEvents.typeEnumerated) // "hdde"
    public static let detailed = MAISymbol(name: "detailed", code: 0x6c776474, type: AppleEvents.typeEnumerated) // "lwdt"
    public static let diacriticals = MAISymbol(name: "diacriticals", code: 0x64696163, type: AppleEvents.typeEnumerated) // "diac"
    public static let doesContainValue = MAISymbol(name: "doesContainValue", code: 0x7271636f, type: AppleEvents.typeEnumerated) // "rqco"
    public static let doesNotContainValue = MAISymbol(name: "doesNotContainValue", code: 0x7271646e, type: AppleEvents.typeEnumerated) // "rqdn"
    public static let doNotKeepCopiesOfAnyMessages = MAISymbol(name: "doNotKeepCopiesOfAnyMessages", code: 0x78396e6f, type: AppleEvents.typeEnumerated) // "x9no"
    public static let endsWithValue = MAISymbol(name: "endsWithValue", code: 0x72716577, type: AppleEvents.typeEnumerated) // "rqew"
    public static let equalToValue = MAISymbol(name: "equalToValue", code: 0x72716965, type: AppleEvents.typeEnumerated) // "rqie"
    public static let expansion = MAISymbol(name: "expansion", code: 0x65787061, type: AppleEvents.typeEnumerated) // "expa"
    public static let external = MAISymbol(name: "external", code: 0x61657874, type: AppleEvents.typeEnumerated) // "aext"
    public static let flagsColumn = MAISymbol(name: "flagsColumn", code: 0x6563666c, type: AppleEvents.typeEnumerated) // "ecfl"
    public static let fromColumn = MAISymbol(name: "fromColumn", code: 0x65636672, type: AppleEvents.typeEnumerated) // "ecfr"
    public static let fromHeader = MAISymbol(name: "fromHeader", code: 0x7466726f, type: AppleEvents.typeEnumerated) // "tfro"
    public static let gray = MAISymbol(name: "gray", code: 0x63636779, type: AppleEvents.typeEnumerated) // "ccgy"
    public static let greaterThanValue = MAISymbol(name: "greaterThanValue", code: 0x72716774, type: AppleEvents.typeEnumerated) // "rqgt"
    public static let green = MAISymbol(name: "green", code: 0x63636772, type: AppleEvents.typeEnumerated) // "ccgr"
    public static let headerKey = MAISymbol(name: "headerKey", code: 0x7468646b, type: AppleEvents.typeEnumerated) // "thdk"
    public static let hyphens = MAISymbol(name: "hyphens", code: 0x68797068, type: AppleEvents.typeEnumerated) // "hyph"
    public static let iCloud = MAISymbol(name: "iCloud", code: 0x65746974, type: AppleEvents.typeEnumerated) // "etit"
    public static let imap = MAISymbol(name: "imap", code: 0x6574696d, type: AppleEvents.typeEnumerated) // "etim"
    public static let kerberos5 = MAISymbol(name: "kerberos5", code: 0x61786b35, type: AppleEvents.typeEnumerated) // "axk5"
    public static let lessThanValue = MAISymbol(name: "lessThanValue", code: 0x72716c74, type: AppleEvents.typeEnumerated) // "rqlt"
    public static let mailboxColumn = MAISymbol(name: "mailboxColumn", code: 0x65636d62, type: AppleEvents.typeEnumerated) // "ecmb"
    public static let matchesEveryMessage = MAISymbol(name: "matchesEveryMessage", code: 0x7465766d, type: AppleEvents.typeEnumerated) // "tevm"
    public static let md5 = MAISymbol(name: "md5", code: 0x61786d64, type: AppleEvents.typeEnumerated) // "axmd"
    public static let messageColor = MAISymbol(name: "messageColor", code: 0x6563636c, type: AppleEvents.typeEnumerated) // "eccl"
    public static let messageContent = MAISymbol(name: "messageContent", code: 0x746d6563, type: AppleEvents.typeEnumerated) // "tmec"
    public static let messageIsJunkMail = MAISymbol(name: "messageIsJunkMail", code: 0x746d696a, type: AppleEvents.typeEnumerated) // "tmij"
    public static let messageStatusColumn = MAISymbol(name: "messageStatusColumn", code: 0x65636d73, type: AppleEvents.typeEnumerated) // "ecms"
    public static let nativeFormat = MAISymbol(name: "nativeFormat", code: 0x6974656d, type: AppleEvents.typeEnumerated) // "item"
    public static let no = MAISymbol(name: "no", code: 0x6e6f2020, type: AppleEvents.typeEnumerated) // "no  "
    public static let noHeaders = MAISymbol(name: "noHeaders", code: 0x68646e6e, type: AppleEvents.typeEnumerated) // "hdnn"
    public static let none = MAISymbol(name: "none", code: 0x63636e6f, type: AppleEvents.typeEnumerated) // "ccno"
    public static let ntlm = MAISymbol(name: "ntlm", code: 0x61786e74, type: AppleEvents.typeEnumerated) // "axnt"
    public static let numberColumn = MAISymbol(name: "numberColumn", code: 0x65636e6d, type: AppleEvents.typeEnumerated) // "ecnm"
    public static let numericStrings = MAISymbol(name: "numericStrings", code: 0x6e756d65, type: AppleEvents.typeEnumerated) // "nume"
    public static let oneLevel = MAISymbol(name: "oneLevel", code: 0x6c736f6c, type: AppleEvents.typeEnumerated) // "lsol"
    public static let onlyMessagesIHaveRead = MAISymbol(name: "onlyMessagesIHaveRead", code: 0x78397772, type: AppleEvents.typeEnumerated) // "x9wr"
    public static let orange = MAISymbol(name: "orange", code: 0x63636f72, type: AppleEvents.typeEnumerated) // "ccor"
    public static let other = MAISymbol(name: "other", code: 0x63636f74, type: AppleEvents.typeEnumerated) // "ccot"
    public static let password = MAISymbol(name: "password", code: 0x61786374, type: AppleEvents.typeEnumerated) // "axct"
    public static let plainFormat = MAISymbol(name: "plainFormat", code: 0x646d7074, type: AppleEvents.typeEnumerated) // "dmpt"
    public static let pop = MAISymbol(name: "pop", code: 0x6574706f, type: AppleEvents.typeEnumerated) // "etpo"
    public static let punctuation = MAISymbol(name: "punctuation", code: 0x70756e63, type: AppleEvents.typeEnumerated) // "punc"
    public static let purple = MAISymbol(name: "purple", code: 0x63637075, type: AppleEvents.typeEnumerated) // "ccpu"
    public static let red = MAISymbol(name: "red", code: 0x63637265, type: AppleEvents.typeEnumerated) // "ccre"
    public static let richFormat = MAISymbol(name: "richFormat", code: 0x646d7274, type: AppleEvents.typeEnumerated) // "dmrt"
    public static let senderIsInMyContacts = MAISymbol(name: "senderIsInMyContacts", code: 0x74736969, type: AppleEvents.typeEnumerated) // "tsii"
    public static let senderIsInMyPreviousRecipients = MAISymbol(name: "senderIsInMyPreviousRecipients", code: 0x74736168, type: AppleEvents.typeEnumerated) // "tsah"
    public static let senderIsMemberOfGroup = MAISymbol(name: "senderIsMemberOfGroup", code: 0x7473696d, type: AppleEvents.typeEnumerated) // "tsim"
    public static let senderIsNotInMyContacts = MAISymbol(name: "senderIsNotInMyContacts", code: 0x7473696e, type: AppleEvents.typeEnumerated) // "tsin"
    public static let senderIsNotInMyPreviousRecipients = MAISymbol(name: "senderIsNotInMyPreviousRecipients", code: 0x746e6168, type: AppleEvents.typeEnumerated) // "tnah"
    public static let senderIsNotMemberOfGroup = MAISymbol(name: "senderIsNotMemberOfGroup", code: 0x74736967, type: AppleEvents.typeEnumerated) // "tsig"
    public static let senderIsVIP = MAISymbol(name: "senderIsVIP", code: 0x74736967, type: AppleEvents.typeEnumerated) // "tsig"
    public static let sizeColumn = MAISymbol(name: "sizeColumn", code: 0x6563737a, type: AppleEvents.typeEnumerated) // "ecsz"
    public static let smtp = MAISymbol(name: "smtp", code: 0x6574736d, type: AppleEvents.typeEnumerated) // "etsm"
    public static let standard = MAISymbol(name: "standard", code: 0x6c777374, type: AppleEvents.typeEnumerated) // "lwst"
    public static let subjectColumn = MAISymbol(name: "subjectColumn", code: 0x65637375, type: AppleEvents.typeEnumerated) // "ecsu"
    public static let subjectHeader = MAISymbol(name: "subjectHeader", code: 0x74737562, type: AppleEvents.typeEnumerated) // "tsub"
    public static let subtree = MAISymbol(name: "subtree", code: 0x6c737374, type: AppleEvents.typeEnumerated) // "lsst"
    public static let toColumn = MAISymbol(name: "toColumn", code: 0x6563746f, type: AppleEvents.typeEnumerated) // "ecto"
    public static let toHeader = MAISymbol(name: "toHeader", code: 0x74746f6f, type: AppleEvents.typeEnumerated) // "ttoo"
    public static let toOrCcHeader = MAISymbol(name: "toOrCcHeader", code: 0x74746f63, type: AppleEvents.typeEnumerated) // "ttoc"
    public static let unknown = MAISymbol(name: "unknown", code: 0x6574756e, type: AppleEvents.typeEnumerated) // "etun"
    public static let whitespace = MAISymbol(name: "whitespace", code: 0x77686974, type: AppleEvents.typeEnumerated) // "whit"
    public static let yellow = MAISymbol(name: "yellow", code: 0x63637965, type: AppleEvents.typeEnumerated) // "ccye"
    public static let yes = MAISymbol(name: "yes", code: 0x79657320, type: AppleEvents.typeEnumerated) // "yes "
}
...
extension MAICommand {
    ...
    @discardableResult public func bounce(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "bounce", event: 0x656d616c_62636d73, // "emalbcms"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func checkForNewMail(_ directParameter: Any = SwiftAutomation.noParameter,
            ...
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "checkForNewMail", event: 0x656d616c_63686d61, // "emalchma"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
    ...
    @discardableResult public func extractAddressFrom(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "extractAddressFrom", event: 0x656d616c_65617561, // "emaleaua"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func extractNameFrom(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "extractNameFrom", event: 0x656d616c_6561666e, // "emaleafn"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func forward(_ directParameter: Any = SwiftAutomation.noParameter,
            ...
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "forward", event: 0x656d616c_66776d73, // "emalfwms"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
    ...
    @discardableResult public func GetURL(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "GetURL", event: 0x656d616c_656d7467, // "emalemtg"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func importMailMailbox(_ directParameter: Any = SwiftAutomation.noParameter,
            ...
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "importMailMailbox", event: 0x656d616c_696d6d78, // "emalimmx"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
    ...
    @discardableResult public func mailto(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "mailto", event: 0x656d616c_656d746f, // "emalemto"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func performMailActionWithMessages(_ directParameter: Any = SwiftAutomation.noParameter,
            ...
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "performMailActionWithMessages", event: 0x656d616c_63706d61, // "emalcpma"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
    ...
    @discardableResult public func redirect(_ directParameter: Any = SwiftAutomation.noParameter,
            ...
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "redirect", event: 0x656d616c_72646d73, // "emalrdms"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                    ("openingWindow", 0x726f7077, openingWindow), // "ropw"
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    ...
    @discardableResult public func reply(_ directParameter: Any = SwiftAutomation.noParameter,
            ...
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "reply", event: 0x656d616c_72706d73, // "emalrpms"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                    ("openingWindow", 0x726f7077, openingWindow), // "ropw"
    ...
    @discardableResult public func send(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "send", event: 0x656d7367_73656e64, // "emsgsend"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func synchronize(_ directParameter: Any = SwiftAutomation.noParameter,
            ...
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "synchronize", event: 0x656d616c_73796163, // "emalsyac"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
...
extension MAIObject {
    ...
    public var id: MAIItem {return self.property(0x49442020) as! MAIItem} // "ID  "
    ...
    public var characters: MAIItems {return self.elements(0x63686120) as! MAIItems} // "cha "

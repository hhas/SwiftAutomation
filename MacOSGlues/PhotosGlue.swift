...
public class PHOSymbol: SwiftAutomation.Symbol {
    ...
    public override class func symbol(code: OSType, type: OSType = typeType, descriptor: ScalarDescriptor? = nil) -> PHOSymbol {
        switch (code) {
    ...
    public static let April = PHOSymbol(name: "April", code: 0x61707220, type: typeType) // "apr "
    public static let August = PHOSymbol(name: "August", code: 0x61756720, type: typeType) // "aug "
    ...
    public static let date = PHOSymbol(name: "date", code: 0x6c647420, type: typeType) // "ldt "
    public static let date_ = PHOSymbol(name: "date_", code: 0x69646174, type: typeType) // "idat"
    public static let December = PHOSymbol(name: "December", code: 0x64656320, type: typeType) // "dec "
    ...
    public static let EPSPicture = PHOSymbol(name: "EPSPicture", code: 0x45505320, type: typeType) // "EPS "
    ...
    public static let February = PHOSymbol(name: "February", code: 0x66656220, type: typeType) // "feb "
    ...
    public static let Friday = PHOSymbol(name: "Friday", code: 0x66726920, type: typeType) // "fri "
    ...
    public static let id = PHOSymbol(name: "id", code: 0x49442020, type: typeType) // "ID  "
    ...
    public static let January = PHOSymbol(name: "January", code: 0x6a616e20, type: typeType) // "jan "
    public static let JPEGPicture = PHOSymbol(name: "JPEGPicture", code: 0x4a504547, type: typeType) // "JPEG"
    public static let July = PHOSymbol(name: "July", code: 0x6a756c20, type: typeType) // "jul "
    public static let June = PHOSymbol(name: "June", code: 0x6a756e20, type: typeType) // "jun "
    ...
    public static let March = PHOSymbol(name: "March", code: 0x6d617220, type: typeType) // "mar "
    public static let May = PHOSymbol(name: "May", code: 0x6d617920, type: typeType) // "may "
    ...
    public static let Monday = PHOSymbol(name: "Monday", code: 0x6d6f6e20, type: typeType) // "mon "
    public static let name = PHOSymbol(name: "name", code: 0x706e616d, type: typeType) // "pnam"
    public static let November = PHOSymbol(name: "November", code: 0x6e6f7620, type: typeType) // "nov "
    public static let null = PHOSymbol(name: "null", code: 0x6e756c6c, type: typeType) // "null"
    public static let October = PHOSymbol(name: "October", code: 0x6f637420, type: typeType) // "oct "
    ...
    public static let processSerialNumber = PHOSymbol(name: "processSerialNumber", code: 0x70736e20, type: typeType) // "psn "
    ...
    public static let reference = PHOSymbol(name: "reference", code: 0x6f626a20, type: typeType) // "obj "
    ...
    public static let Saturday = PHOSymbol(name: "Saturday", code: 0x73617420, type: typeType) // "sat "
    ...
    public static let September = PHOSymbol(name: "September", code: 0x73657020, type: typeType) // "sep "
    ...
    public static let Sunday = PHOSymbol(name: "Sunday", code: 0x73756e20, type: typeType) // "sun "
    public static let textStyleInfo = PHOSymbol(name: "textStyleInfo", code: 0x74737479, type: typeType) // "tsty"
    public static let Thursday = PHOSymbol(name: "Thursday", code: 0x74687520, type: typeType) // "thu "
    public static let TIFFPicture = PHOSymbol(name: "TIFFPicture", code: 0x54494646, type: typeType) // "TIFF"
    public static let Tuesday = PHOSymbol(name: "Tuesday", code: 0x74756520, type: typeType) // "tue "
    ...
    public static let Wednesday = PHOSymbol(name: "Wednesday", code: 0x77656420, type: typeType) // "wed "
    ...
    // Enumerators
    public static let ask = PHOSymbol(name: "ask", code: 0x61736b20, type: typeEnumerated) // "ask "
    ...
    public static let no = PHOSymbol(name: "no", code: 0x6e6f2020, type: typeEnumerated) // "no  "
    ...
    public static let yes = PHOSymbol(name: "yes", code: 0x79657320, type: typeEnumerated) // "yes "
}

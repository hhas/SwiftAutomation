...
private let _specifierFormatter = SwiftAutomation.SpecifierFormatter(
        applicationClassName: "Automator",
        classNamePrefix: "AUT",
        typeNames: [
        ...
        elementsNames: [
                ...
                0x6163747a: ("AutomatorAction", "AutomatorActions"), // "actz"
                ...
                0x72657172: ("requiredResource", "requiredResources"), // "reqr"
...
private let _glueClasses = SwiftAutomation.GlueClasses(
                                                insertionSpecifierType: AUTInsertion.self,
...
public class AUTSymbol: SwiftAutomation.Symbol {
    ...
    public override class func symbol(code: OSType, type: OSType = AppleEvents.typeType, descriptor: ScalarDescriptor? = nil) -> AUTSymbol {
        switch (code) {
    ...
    // Types/properties
    public static let alias = AUTSymbol(name: "alias", code: 0x616c6973, type: AppleEvents.typeType) // "alis"
    public static let anything = AUTSymbol(name: "anything", code: 0x2a2a2a2a, type: AppleEvents.typeType) // "****"
    public static let application = AUTSymbol(name: "application", code: 0x63617070, type: AppleEvents.typeType) // "capp"
    public static let applicationBundleID = AUTSymbol(name: "applicationBundleID", code: 0x62756e64, type: AppleEvents.typeType) // "bund"
    public static let applicationSignature = AUTSymbol(name: "applicationSignature", code: 0x7369676e, type: AppleEvents.typeType) // "sign"
    public static let applicationURL = AUTSymbol(name: "applicationURL", code: 0x6170726c, type: AppleEvents.typeType) // "aprl"
    public static let April = AUTSymbol(name: "April", code: 0x61707220, type: AppleEvents.typeType) // "apr "
    public static let attachment = AUTSymbol(name: "attachment", code: 0x61747473, type: AppleEvents.typeType) // "atts"
    public static let attributeRun = AUTSymbol(name: "attributeRun", code: 0x63617472, type: AppleEvents.typeType) // "catr"
    public static let August = AUTSymbol(name: "August", code: 0x61756720, type: AppleEvents.typeType) // "aug "
    public static let AutomatorAction = AUTSymbol(name: "AutomatorAction", code: 0x6163747a, type: AppleEvents.typeType) // "actz"
    public static let best = AUTSymbol(name: "best", code: 0x62657374, type: AppleEvents.typeType) // "best"
    public static let bookmarkData = AUTSymbol(name: "bookmarkData", code: 0x626d726b, type: AppleEvents.typeType) // "bmrk"
    public static let boolean = AUTSymbol(name: "boolean", code: 0x626f6f6c, type: AppleEvents.typeType) // "bool"
    public static let boundingRectangle = AUTSymbol(name: "boundingRectangle", code: 0x71647274, type: AppleEvents.typeType) // "qdrt"
    public static let bounds = AUTSymbol(name: "bounds", code: 0x70626e64, type: AppleEvents.typeType) // "pbnd"
    public static let bundleId = AUTSymbol(name: "bundleId", code: 0x626e6964, type: AppleEvents.typeType) // "bnid"
    public static let category = AUTSymbol(name: "category", code: 0x63746779, type: AppleEvents.typeType) // "ctgy"
    public static let character = AUTSymbol(name: "character", code: 0x63686120, type: AppleEvents.typeType) // "cha "
    public static let class_ = AUTSymbol(name: "class_", code: 0x70636c73, type: AppleEvents.typeType) // "pcls"
    public static let closeable = AUTSymbol(name: "closeable", code: 0x68636c62, type: AppleEvents.typeType) // "hclb"
    public static let collating = AUTSymbol(name: "collating", code: 0x6c77636c, type: AppleEvents.typeType) // "lwcl"
    public static let color = AUTSymbol(name: "color", code: 0x636f6c72, type: AppleEvents.typeType) // "colr"
    public static let colorTable = AUTSymbol(name: "colorTable", code: 0x636c7274, type: AppleEvents.typeType) // "clrt"
    public static let comment = AUTSymbol(name: "comment", code: 0x636f6d74, type: AppleEvents.typeType) // "comt"
    public static let constant = AUTSymbol(name: "constant", code: 0x656e756d, type: AppleEvents.typeType) // "enum"
    public static let copies = AUTSymbol(name: "copies", code: 0x6c776370, type: AppleEvents.typeType) // "lwcp"
    public static let currentAction = AUTSymbol(name: "currentAction", code: 0x63616374, type: AppleEvents.typeType) // "cact"
    public static let dashStyle = AUTSymbol(name: "dashStyle", code: 0x74646173, type: AppleEvents.typeType) // "tdas"
    public static let data = AUTSymbol(name: "data", code: 0x74647461, type: AppleEvents.typeType) // "tdta"
    public static let date = AUTSymbol(name: "date", code: 0x6c647420, type: AppleEvents.typeType) // "ldt "
    public static let December = AUTSymbol(name: "December", code: 0x64656320, type: AppleEvents.typeType) // "dec "
    public static let decimalStruct = AUTSymbol(name: "decimalStruct", code: 0x6465636d, type: AppleEvents.typeType) // "decm"
    public static let defaultValue = AUTSymbol(name: "defaultValue", code: 0x6476616c, type: AppleEvents.typeType) // "dval"
    public static let document = AUTSymbol(name: "document", code: 0x646f6375, type: AppleEvents.typeType) // "docu"
    public static let doubleInteger = AUTSymbol(name: "doubleInteger", code: 0x636f6d70, type: AppleEvents.typeType) // "comp"
    public static let enabled = AUTSymbol(name: "enabled", code: 0x656e6142, type: AppleEvents.typeType) // "enaB"
    public static let encodedString = AUTSymbol(name: "encodedString", code: 0x656e6373, type: AppleEvents.typeType) // "encs"
    public static let endingPage = AUTSymbol(name: "endingPage", code: 0x6c776c70, type: AppleEvents.typeType) // "lwlp"
    public static let EPSPicture = AUTSymbol(name: "EPSPicture", code: 0x45505320, type: AppleEvents.typeType) // "EPS "
    public static let errorHandling = AUTSymbol(name: "errorHandling", code: 0x6c776568, type: AppleEvents.typeType) // "lweh"
    public static let executionErrorMessage = AUTSymbol(name: "executionErrorMessage", code: 0x7865726d, type: AppleEvents.typeType) // "xerm"
    public static let executionErrorNumber = AUTSymbol(name: "executionErrorNumber", code: 0x7865726e, type: AppleEvents.typeType) // "xern"
    public static let executionId = AUTSymbol(name: "executionId", code: 0x78696478, type: AppleEvents.typeType) // "xidx"
    public static let executionResult = AUTSymbol(name: "executionResult", code: 0x7872736c, type: AppleEvents.typeType) // "xrsl"
    public static let faxNumber = AUTSymbol(name: "faxNumber", code: 0x6661786e, type: AppleEvents.typeType) // "faxn"
    public static let February = AUTSymbol(name: "February", code: 0x66656220, type: AppleEvents.typeType) // "feb "
    public static let fileName = AUTSymbol(name: "fileName", code: 0x6174666e, type: AppleEvents.typeType) // "atfn"
    public static let fileRef = AUTSymbol(name: "fileRef", code: 0x66737266, type: AppleEvents.typeType) // "fsrf"
    public static let fileURL = AUTSymbol(name: "fileURL", code: 0x6675726c, type: AppleEvents.typeType) // "furl"
    public static let fixed = AUTSymbol(name: "fixed", code: 0x66697864, type: AppleEvents.typeType) // "fixd"
    public static let fixedPoint = AUTSymbol(name: "fixedPoint", code: 0x66706e74, type: AppleEvents.typeType) // "fpnt"
    public static let fixedRectangle = AUTSymbol(name: "fixedRectangle", code: 0x66726374, type: AppleEvents.typeType) // "frct"
    public static let floating = AUTSymbol(name: "floating", code: 0x6973666c, type: AppleEvents.typeType) // "isfl"
    public static let font = AUTSymbol(name: "font", code: 0x666f6e74, type: AppleEvents.typeType) // "font"
    public static let Friday = AUTSymbol(name: "Friday", code: 0x66726920, type: AppleEvents.typeType) // "fri "
    public static let frontmost = AUTSymbol(name: "frontmost", code: 0x70697366, type: AppleEvents.typeType) // "pisf"
    public static let GIFPicture = AUTSymbol(name: "GIFPicture", code: 0x47494666, type: AppleEvents.typeType) // "GIFf"
    public static let graphicText = AUTSymbol(name: "graphicText", code: 0x63677478, type: AppleEvents.typeType) // "cgtx"
    public static let iconName = AUTSymbol(name: "iconName", code: 0x69636e6d, type: AppleEvents.typeType) // "icnm"
    public static let id = AUTSymbol(name: "id", code: 0x49442020, type: AppleEvents.typeType) // "ID  "
    public static let ignoresInput = AUTSymbol(name: "ignoresInput", code: 0x6967696e, type: AppleEvents.typeType) // "igin"
    public static let index = AUTSymbol(name: "index", code: 0x70696478, type: AppleEvents.typeType) // "pidx"
    public static let inputTypes = AUTSymbol(name: "inputTypes", code: 0x696e7479, type: AppleEvents.typeType) // "inty"
    public static let integer = AUTSymbol(name: "integer", code: 0x6c6f6e67, type: AppleEvents.typeType) // "long"
    public static let internationalText = AUTSymbol(name: "internationalText", code: 0x69747874, type: AppleEvents.typeType) // "itxt"
    public static let internationalWritingCode = AUTSymbol(name: "internationalWritingCode", code: 0x696e746c, type: AppleEvents.typeType) // "intl"
    public static let item = AUTSymbol(name: "item", code: 0x636f626a, type: AppleEvents.typeType) // "cobj"
    public static let January = AUTSymbol(name: "January", code: 0x6a616e20, type: AppleEvents.typeType) // "jan "
    public static let JPEGPicture = AUTSymbol(name: "JPEGPicture", code: 0x4a504547, type: AppleEvents.typeType) // "JPEG"
    public static let July = AUTSymbol(name: "July", code: 0x6a756c20, type: AppleEvents.typeType) // "jul "
    public static let June = AUTSymbol(name: "June", code: 0x6a756e20, type: AppleEvents.typeType) // "jun "
    public static let kernelProcessID = AUTSymbol(name: "kernelProcessID", code: 0x6b706964, type: AppleEvents.typeType) // "kpid"
    public static let keywords = AUTSymbol(name: "keywords", code: 0x6b797764, type: AppleEvents.typeType) // "kywd"
    public static let kind = AUTSymbol(name: "kind", code: 0x6b696e64, type: AppleEvents.typeType) // "kind"
    public static let largeReal = AUTSymbol(name: "largeReal", code: 0x6c64626c, type: AppleEvents.typeType) // "ldbl"
    public static let list = AUTSymbol(name: "list", code: 0x6c697374, type: AppleEvents.typeType) // "list"
    public static let locationReference = AUTSymbol(name: "locationReference", code: 0x696e736c, type: AppleEvents.typeType) // "insl"
    public static let longFixed = AUTSymbol(name: "longFixed", code: 0x6c667864, type: AppleEvents.typeType) // "lfxd"
    public static let longFixedPoint = AUTSymbol(name: "longFixedPoint", code: 0x6c667074, type: AppleEvents.typeType) // "lfpt"
    public static let longFixedRectangle = AUTSymbol(name: "longFixedRectangle", code: 0x6c667263, type: AppleEvents.typeType) // "lfrc"
    public static let longPoint = AUTSymbol(name: "longPoint", code: 0x6c706e74, type: AppleEvents.typeType) // "lpnt"
    public static let longRectangle = AUTSymbol(name: "longRectangle", code: 0x6c726374, type: AppleEvents.typeType) // "lrct"
    public static let machine = AUTSymbol(name: "machine", code: 0x6d616368, type: AppleEvents.typeType) // "mach"
    public static let machineLocation = AUTSymbol(name: "machineLocation", code: 0x6d4c6f63, type: AppleEvents.typeType) // "mLoc"
    public static let machPort = AUTSymbol(name: "machPort", code: 0x706f7274, type: AppleEvents.typeType) // "port"
    public static let March = AUTSymbol(name: "March", code: 0x6d617220, type: AppleEvents.typeType) // "mar "
    public static let May = AUTSymbol(name: "May", code: 0x6d617920, type: AppleEvents.typeType) // "may "
    public static let miniaturizable = AUTSymbol(name: "miniaturizable", code: 0x69736d6e, type: AppleEvents.typeType) // "ismn"
    public static let miniaturized = AUTSymbol(name: "miniaturized", code: 0x706d6e64, type: AppleEvents.typeType) // "pmnd"
    public static let modal = AUTSymbol(name: "modal", code: 0x706d6f64, type: AppleEvents.typeType) // "pmod"
    public static let modified = AUTSymbol(name: "modified", code: 0x696d6f64, type: AppleEvents.typeType) // "imod"
    public static let Monday = AUTSymbol(name: "Monday", code: 0x6d6f6e20, type: AppleEvents.typeType) // "mon "
    public static let name = AUTSymbol(name: "name", code: 0x706e616d, type: AppleEvents.typeType) // "pnam"
    public static let November = AUTSymbol(name: "November", code: 0x6e6f7620, type: AppleEvents.typeType) // "nov "
    public static let null = AUTSymbol(name: "null", code: 0x6e756c6c, type: AppleEvents.typeType) // "null"
    public static let October = AUTSymbol(name: "October", code: 0x6f637420, type: AppleEvents.typeType) // "oct "
    public static let outputTypes = AUTSymbol(name: "outputTypes", code: 0x6f757479, type: AppleEvents.typeType) // "outy"
    public static let pagesAcross = AUTSymbol(name: "pagesAcross", code: 0x6c776c61, type: AppleEvents.typeType) // "lwla"
    public static let pagesDown = AUTSymbol(name: "pagesDown", code: 0x6c776c64, type: AppleEvents.typeType) // "lwld"
    public static let paragraph = AUTSymbol(name: "paragraph", code: 0x63706172, type: AppleEvents.typeType) // "cpar"
    public static let parentWorkflow = AUTSymbol(name: "parentWorkflow", code: 0x70776b66, type: AppleEvents.typeType) // "pwkf"
    public static let path = AUTSymbol(name: "path", code: 0x70707468, type: AppleEvents.typeType) // "ppth"
    public static let PICTPicture = AUTSymbol(name: "PICTPicture", code: 0x50494354, type: AppleEvents.typeType) // "PICT"
    public static let pixelMapRecord = AUTSymbol(name: "pixelMapRecord", code: 0x74706d6d, type: AppleEvents.typeType) // "tpmm"
    public static let point = AUTSymbol(name: "point", code: 0x51447074, type: AppleEvents.typeType) // "QDpt"
    public static let printSettings = AUTSymbol(name: "printSettings", code: 0x70736574, type: AppleEvents.typeType) // "pset"
    public static let processSerialNumber = AUTSymbol(name: "processSerialNumber", code: 0x70736e20, type: AppleEvents.typeType) // "psn "
    public static let properties = AUTSymbol(name: "properties", code: 0x70414c4c, type: AppleEvents.typeType) // "pALL"
    public static let property_ = AUTSymbol(name: "property_", code: 0x70726f70, type: AppleEvents.typeType) // "prop"
    public static let real = AUTSymbol(name: "real", code: 0x646f7562, type: AppleEvents.typeType) // "doub"
    public static let record = AUTSymbol(name: "record", code: 0x7265636f, type: AppleEvents.typeType) // "reco"
    public static let reference = AUTSymbol(name: "reference", code: 0x6f626a20, type: AppleEvents.typeType) // "obj "
    public static let requestedPrintTime = AUTSymbol(name: "requestedPrintTime", code: 0x6c777174, type: AppleEvents.typeType) // "lwqt"
    public static let requiredResource = AUTSymbol(name: "requiredResource", code: 0x72657172, type: AppleEvents.typeType) // "reqr"
    public static let resizable = AUTSymbol(name: "resizable", code: 0x7072737a, type: AppleEvents.typeType) // "prsz"
    public static let resource = AUTSymbol(name: "resource", code: 0x72737263, type: AppleEvents.typeType) // "rsrc"
    public static let RGB16Color = AUTSymbol(name: "RGB16Color", code: 0x74723136, type: AppleEvents.typeType) // "tr16"
    public static let RGB96Color = AUTSymbol(name: "RGB96Color", code: 0x74723936, type: AppleEvents.typeType) // "tr96"
    public static let RGBColor = AUTSymbol(name: "RGBColor", code: 0x63524742, type: AppleEvents.typeType) // "cRGB"
    public static let rotation = AUTSymbol(name: "rotation", code: 0x74726f74, type: AppleEvents.typeType) // "trot"
    public static let Saturday = AUTSymbol(name: "Saturday", code: 0x73617420, type: AppleEvents.typeType) // "sat "
    public static let script = AUTSymbol(name: "script", code: 0x73637074, type: AppleEvents.typeType) // "scpt"
    public static let September = AUTSymbol(name: "September", code: 0x73657020, type: AppleEvents.typeType) // "sep "
    public static let settable = AUTSymbol(name: "settable", code: 0x7374626c, type: AppleEvents.typeType) // "stbl"
    public static let setting = AUTSymbol(name: "setting", code: 0x73746e67, type: AppleEvents.typeType) // "stng"
    public static let shortInteger = AUTSymbol(name: "shortInteger", code: 0x73686f72, type: AppleEvents.typeType) // "shor"
    public static let showActionWhenRun = AUTSymbol(name: "showActionWhenRun", code: 0x73687772, type: AppleEvents.typeType) // "shwr"
    public static let size = AUTSymbol(name: "size", code: 0x7074737a, type: AppleEvents.typeType) // "ptsz"
    public static let smallReal = AUTSymbol(name: "smallReal", code: 0x73696e67, type: AppleEvents.typeType) // "sing"
    public static let startingPage = AUTSymbol(name: "startingPage", code: 0x6c776670, type: AppleEvents.typeType) // "lwfp"
    public static let string = AUTSymbol(name: "string", code: 0x54455854, type: AppleEvents.typeType) // "TEXT"
    public static let styledClipboardText = AUTSymbol(name: "styledClipboardText", code: 0x7374796c, type: AppleEvents.typeType) // "styl"
    public static let styledText = AUTSymbol(name: "styledText", code: 0x53545854, type: AppleEvents.typeType) // "STXT"
    public static let Sunday = AUTSymbol(name: "Sunday", code: 0x73756e20, type: AppleEvents.typeType) // "sun "
    public static let targetApplication = AUTSymbol(name: "targetApplication", code: 0x74617070, type: AppleEvents.typeType) // "tapp"
    public static let targetPrinter = AUTSymbol(name: "targetPrinter", code: 0x74727072, type: AppleEvents.typeType) // "trpr"
    public static let text = AUTSymbol(name: "text", code: 0x63747874, type: AppleEvents.typeType) // "ctxt"
    public static let textStyleInfo = AUTSymbol(name: "textStyleInfo", code: 0x74737479, type: AppleEvents.typeType) // "tsty"
    public static let Thursday = AUTSymbol(name: "Thursday", code: 0x74687520, type: AppleEvents.typeType) // "thu "
    public static let TIFFPicture = AUTSymbol(name: "TIFFPicture", code: 0x54494646, type: AppleEvents.typeType) // "TIFF"
    public static let titled = AUTSymbol(name: "titled", code: 0x70746974, type: AppleEvents.typeType) // "ptit"
    public static let Tuesday = AUTSymbol(name: "Tuesday", code: 0x74756520, type: AppleEvents.typeType) // "tue "
    public static let typeClass = AUTSymbol(name: "typeClass", code: 0x74797065, type: AppleEvents.typeType) // "type"
    public static let UnicodeText = AUTSymbol(name: "UnicodeText", code: 0x75747874, type: AppleEvents.typeType) // "utxt"
    public static let unsignedDoubleInteger = AUTSymbol(name: "unsignedDoubleInteger", code: 0x75636f6d, type: AppleEvents.typeType) // "ucom"
    public static let unsignedInteger = AUTSymbol(name: "unsignedInteger", code: 0x6d61676e, type: AppleEvents.typeType) // "magn"
    public static let unsignedShortInteger = AUTSymbol(name: "unsignedShortInteger", code: 0x75736872, type: AppleEvents.typeType) // "ushr"
    public static let UTF16Text = AUTSymbol(name: "UTF16Text", code: 0x75743136, type: AppleEvents.typeType) // "ut16"
    public static let UTF8Text = AUTSymbol(name: "UTF8Text", code: 0x75746638, type: AppleEvents.typeType) // "utf8"
    public static let value = AUTSymbol(name: "value", code: 0x7076616c, type: AppleEvents.typeType) // "pval"
    public static let variable = AUTSymbol(name: "variable", code: 0x76617269, type: AppleEvents.typeType) // "vari"
    public static let version = AUTSymbol(name: "version", code: 0x76657273, type: AppleEvents.typeType) // "vers"
    public static let visible = AUTSymbol(name: "visible", code: 0x70766973, type: AppleEvents.typeType) // "pvis"
    public static let warningAction = AUTSymbol(name: "warningAction", code: 0x77616374, type: AppleEvents.typeType) // "wact"
    public static let warningLevel = AUTSymbol(name: "warningLevel", code: 0x776c6576, type: AppleEvents.typeType) // "wlev"
    public static let warningMessage = AUTSymbol(name: "warningMessage", code: 0x776d7367, type: AppleEvents.typeType) // "wmsg"
    public static let Wednesday = AUTSymbol(name: "Wednesday", code: 0x77656420, type: AppleEvents.typeType) // "wed "
    public static let window = AUTSymbol(name: "window", code: 0x6377696e, type: AppleEvents.typeType) // "cwin"
    public static let word = AUTSymbol(name: "word", code: 0x63776f72, type: AppleEvents.typeType) // "cwor"
    public static let workflow = AUTSymbol(name: "workflow", code: 0x776b6677, type: AppleEvents.typeType) // "wkfw"
    public static let writingCode = AUTSymbol(name: "writingCode", code: 0x70736374, type: AppleEvents.typeType) // "psct"
    public static let zoomable = AUTSymbol(name: "zoomable", code: 0x69737a6d, type: AppleEvents.typeType) // "iszm"
    public static let zoomed = AUTSymbol(name: "zoomed", code: 0x707a756d, type: AppleEvents.typeType) // "pzum"

    // Enumerators
    public static let ask = AUTSymbol(name: "ask", code: 0x61736b20, type: AppleEvents.typeEnumerated) // "ask "
    public static let case_ = AUTSymbol(name: "case_", code: 0x63617365, type: AppleEvents.typeEnumerated) // "case"
    public static let detailed = AUTSymbol(name: "detailed", code: 0x6c776474, type: AppleEvents.typeEnumerated) // "lwdt"
    public static let diacriticals = AUTSymbol(name: "diacriticals", code: 0x64696163, type: AppleEvents.typeEnumerated) // "diac"
    public static let expansion = AUTSymbol(name: "expansion", code: 0x65787061, type: AppleEvents.typeEnumerated) // "expa"
    public static let hyphens = AUTSymbol(name: "hyphens", code: 0x68797068, type: AppleEvents.typeEnumerated) // "hyph"
    public static let irreversible = AUTSymbol(name: "irreversible", code: 0x69727276, type: AppleEvents.typeEnumerated) // "irrv"
    public static let no = AUTSymbol(name: "no", code: 0x6e6f2020, type: AppleEvents.typeEnumerated) // "no  "
    public static let none = AUTSymbol(name: "none", code: 0x6e6f6e65, type: AppleEvents.typeEnumerated) // "none"
    public static let numericStrings = AUTSymbol(name: "numericStrings", code: 0x6e756d65, type: AppleEvents.typeEnumerated) // "nume"
    public static let punctuation = AUTSymbol(name: "punctuation", code: 0x70756e63, type: AppleEvents.typeEnumerated) // "punc"
    public static let reversible = AUTSymbol(name: "reversible", code: 0x7276626c, type: AppleEvents.typeEnumerated) // "rvbl"
    public static let standard = AUTSymbol(name: "standard", code: 0x6c777374, type: AppleEvents.typeEnumerated) // "lwst"
    public static let whitespace = AUTSymbol(name: "whitespace", code: 0x77686974, type: AppleEvents.typeEnumerated) // "whit"
    public static let yes = AUTSymbol(name: "yes", code: 0x79657320, type: AppleEvents.typeEnumerated) // "yes "
}
...
extension AUTCommand {
    ...
    @discardableResult public func add(_ directParameter: Any = SwiftAutomation.noParameter,
            ...
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "add", event: 0x6f74746f_61646420, // "ottoadd "
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                    ("to", 0x696e7368, to), // "insh"
                    ("atIndex", 0x61742049, atIndex), // "at I"
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func execute(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "execute", event: 0x6f74746f_65786563, // "ottoexec"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func remove(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "remove", event: 0x6f74746f_72656d76, // "ottoremv"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
...
extension AUTObject {
    ...
    public var id: AUTItem {return self.property(0x49442020) as! AUTItem} // "ID  "
    ...
    public var characters: AUTItems {return self.elements(0x63686120) as! AUTItems} // "cha "

...
public class DEVSymbol: SwiftAutomation.Symbol {
    ...
    public override class func symbol(code: OSType, type: OSType = typeType, descriptor: ScalarDescriptor? = nil) -> DEVSymbol {
        switch (code) {
    ...
    public static let April = DEVSymbol(name: "April", code: 0x61707220, type: typeType) // "apr "
    ...
    public static let August = DEVSymbol(name: "August", code: 0x61756720, type: typeType) // "aug "
    ...
    public static let character = DEVSymbol(name: "character", code: 0x63686120, type: typeType) // "cha "
    ...
    public static let date = DEVSymbol(name: "date", code: 0x6c647420, type: typeType) // "ldt "
    public static let December = DEVSymbol(name: "December", code: 0x64656320, type: typeType) // "dec "
    ...
    public static let EPSPicture = DEVSymbol(name: "EPSPicture", code: 0x45505320, type: typeType) // "EPS "
    ...
    public static let February = DEVSymbol(name: "February", code: 0x66656220, type: typeType) // "feb "
    ...
    public static let Friday = DEVSymbol(name: "Friday", code: 0x66726920, type: typeType) // "fri "
    ...
    public static let id = DEVSymbol(name: "id", code: 0x49442020, type: typeType) // "ID  "
    ...
    public static let January = DEVSymbol(name: "January", code: 0x6a616e20, type: typeType) // "jan "
    public static let JPEGPicture = DEVSymbol(name: "JPEGPicture", code: 0x4a504547, type: typeType) // "JPEG"
    public static let July = DEVSymbol(name: "July", code: 0x6a756c20, type: typeType) // "jul "
    public static let June = DEVSymbol(name: "June", code: 0x6a756e20, type: typeType) // "jun "
    ...
    public static let March = DEVSymbol(name: "March", code: 0x6d617220, type: typeType) // "mar "
    public static let May = DEVSymbol(name: "May", code: 0x6d617920, type: typeType) // "may "
    ...
    public static let Monday = DEVSymbol(name: "Monday", code: 0x6d6f6e20, type: typeType) // "mon "
    public static let name = DEVSymbol(name: "name", code: 0x706e616d, type: typeType) // "pnam"
    public static let November = DEVSymbol(name: "November", code: 0x6e6f7620, type: typeType) // "nov "
    public static let null = DEVSymbol(name: "null", code: 0x6e756c6c, type: typeType) // "null"
    public static let October = DEVSymbol(name: "October", code: 0x6f637420, type: typeType) // "oct "
    ...
    public static let processSerialNumber = DEVSymbol(name: "processSerialNumber", code: 0x70736e20, type: typeType) // "psn "
    ...
    public static let reference = DEVSymbol(name: "reference", code: 0x6f626a20, type: typeType) // "obj "
    ...
    public static let Saturday = DEVSymbol(name: "Saturday", code: 0x73617420, type: typeType) // "sat "
    public static let script = DEVSymbol(name: "script", code: 0x73637074, type: typeType) // "scpt"
    public static let September = DEVSymbol(name: "September", code: 0x73657020, type: typeType) // "sep "
    ...
    public static let Sunday = DEVSymbol(name: "Sunday", code: 0x73756e20, type: typeType) // "sun "
    ...
    public static let Thursday = DEVSymbol(name: "Thursday", code: 0x74687520, type: typeType) // "thu "
    ...
    public static let Tuesday = DEVSymbol(name: "Tuesday", code: 0x74756520, type: typeType) // "tue "
    ...
    public static let Wednesday = DEVSymbol(name: "Wednesday", code: 0x77656420, type: typeType) // "wed "
    ...
    // Enumerators
    public static let ask = DEVSymbol(name: "ask", code: 0x61736b20, type: typeEnumerated) // "ask "
    public static let binary = DEVSymbol(name: "binary", code: 0x62696e20, type: typeEnumerated) // "bin "
    ...
    public static let memory = DEVSymbol(name: "memory", code: 0x6d656d20, type: typeEnumerated) // "mem "
    public static let no = DEVSymbol(name: "no", code: 0x6e6f2020, type: typeEnumerated) // "no  "
    ...
    public static let XML = DEVSymbol(name: "XML", code: 0x786d6c20, type: typeEnumerated) // "xml "
    public static let yes = DEVSymbol(name: "yes", code: 0x79657320, type: typeEnumerated) // "yes "
}

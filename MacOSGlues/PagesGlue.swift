...
public class PAGSymbol: SwiftAutomation.Symbol {
    ...
    public override class func symbol(code: OSType, type: OSType = typeType, descriptor: ScalarDescriptor? = nil) -> PAGSymbol {
        switch (code) {
    ...
    public static let April = PAGSymbol(name: "April", code: 0x61707220, type: typeType) // "apr "
    public static let audioClip = PAGSymbol(name: "audioClip", code: 0x73686175, type: typeType) // "shau"
    public static let August = PAGSymbol(name: "August", code: 0x61756720, type: typeType) // "aug "
    ...
    public static let character = PAGSymbol(name: "character", code: 0x63686120, type: typeType) // "cha "
    ...
    public static let date = PAGSymbol(name: "date", code: 0x6c647420, type: typeType) // "ldt "
    public static let December = PAGSymbol(name: "December", code: 0x64656320, type: typeType) // "dec "
    ...
    public static let EPSPicture = PAGSymbol(name: "EPSPicture", code: 0x45505320, type: typeType) // "EPS "
    ...
    public static let February = PAGSymbol(name: "February", code: 0x66656220, type: typeType) // "feb "
    ...
    public static let Friday = PAGSymbol(name: "Friday", code: 0x66726920, type: typeType) // "fri "
    ...
    public static let id = PAGSymbol(name: "id", code: 0x49442020, type: typeType) // "ID  "
    ...
    public static let January = PAGSymbol(name: "January", code: 0x6a616e20, type: typeType) // "jan "
    public static let JPEGPicture = PAGSymbol(name: "JPEGPicture", code: 0x4a504547, type: typeType) // "JPEG"
    public static let July = PAGSymbol(name: "July", code: 0x6a756c20, type: typeType) // "jul "
    public static let June = PAGSymbol(name: "June", code: 0x6a756e20, type: typeType) // "jun "
    ...
    public static let March = PAGSymbol(name: "March", code: 0x6d617220, type: typeType) // "mar "
    public static let May = PAGSymbol(name: "May", code: 0x6d617920, type: typeType) // "may "
    ...
    public static let Monday = PAGSymbol(name: "Monday", code: 0x6d6f6e20, type: typeType) // "mon "
    ...
    public static let November = PAGSymbol(name: "November", code: 0x6e6f7620, type: typeType) // "nov "
    ...
    public static let October = PAGSymbol(name: "October", code: 0x6f637420, type: typeType) // "oct "
    ...
    public static let processSerialNumber = PAGSymbol(name: "processSerialNumber", code: 0x70736e20, type: typeType) // "psn "
    ...
    public static let reference = PAGSymbol(name: "reference", code: 0x6f626a20, type: typeType) // "obj "
    ...
    public static let Saturday = PAGSymbol(name: "Saturday", code: 0x73617420, type: typeType) // "sat "
    ...
    public static let selection = PAGSymbol(name: "selection", code: 0x73656c65, type: typeType) // "sele"
    public static let selectionRange = PAGSymbol(name: "selectionRange", code: 0x4e4d5473, type: typeType) // "NMTs"
    public static let September = PAGSymbol(name: "September", code: 0x73657020, type: typeType) // "sep "
    ...
    public static let Sunday = PAGSymbol(name: "Sunday", code: 0x73756e20, type: typeType) // "sun "
    ...
    public static let Thursday = PAGSymbol(name: "Thursday", code: 0x74687520, type: typeType) // "thu "
    ...
    public static let Tuesday = PAGSymbol(name: "Tuesday", code: 0x74756520, type: typeType) // "tue "
    ...
    public static let Wednesday = PAGSymbol(name: "Wednesday", code: 0x77656420, type: typeType) // "wed "
    ...
    public static let ask = PAGSymbol(name: "ask", code: 0x61736b20, type: typeEnumerated) // "ask "
    ...
    public static let no = PAGSymbol(name: "no", code: 0x6e6f2020, type: typeEnumerated) // "no  "
    ...
    public static let yes = PAGSymbol(name: "yes", code: 0x79657320, type: typeEnumerated) // "yes "
}

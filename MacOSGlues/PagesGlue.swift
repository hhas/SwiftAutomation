...
private let _specifierFormatter = SwiftAutomation.SpecifierFormatter(
        ...
        elementsNames: [
                ...
                0x63706c61: ("placeholderText", "placeholderTexts"), // "cpla"
...
private let _glueClasses = SwiftAutomation.GlueClasses(
                                                insertionSpecifierType: PAGInsertion.self,
...
public class PAGSymbol: SwiftAutomation.Symbol {
    ...
    public override class func symbol(code: OSType, type: OSType = AppleEvents.typeType, descriptor: ScalarDescriptor? = nil) -> PAGSymbol {
        switch (code) {
    ...
    // Types/properties
    public static let address = PAGSymbol(name: "address", code: 0x4e4d6164, type: AppleEvents.typeType) // "NMad"
    public static let alias = PAGSymbol(name: "alias", code: 0x616c6973, type: AppleEvents.typeType) // "alis"
    public static let alignment = PAGSymbol(name: "alignment", code: 0x74657841, type: AppleEvents.typeType) // "texA"
    public static let anything = PAGSymbol(name: "anything", code: 0x2a2a2a2a, type: AppleEvents.typeType) // "****"
    public static let application = PAGSymbol(name: "application", code: 0x63617070, type: AppleEvents.typeType) // "capp"
    public static let applicationBundleID = PAGSymbol(name: "applicationBundleID", code: 0x62756e64, type: AppleEvents.typeType) // "bund"
    public static let applicationSignature = PAGSymbol(name: "applicationSignature", code: 0x7369676e, type: AppleEvents.typeType) // "sign"
    public static let applicationURL = PAGSymbol(name: "applicationURL", code: 0x6170726c, type: AppleEvents.typeType) // "aprl"
    public static let April = PAGSymbol(name: "April", code: 0x61707220, type: AppleEvents.typeType) // "apr "
    public static let audioClip = PAGSymbol(name: "audioClip", code: 0x73686175, type: AppleEvents.typeType) // "shau"
    public static let August = PAGSymbol(name: "August", code: 0x61756720, type: AppleEvents.typeType) // "aug "
    public static let author = PAGSymbol(name: "author", code: 0x50786561, type: AppleEvents.typeType) // "Pxea"
    public static let backgroundColor = PAGSymbol(name: "backgroundColor", code: 0x63654243, type: AppleEvents.typeType) // "ceBC"
    public static let backgroundFillType = PAGSymbol(name: "backgroundFillType", code: 0x626b6674, type: AppleEvents.typeType) // "bkft"
    public static let best = PAGSymbol(name: "best", code: 0x62657374, type: AppleEvents.typeType) // "best"
    public static let bodyText = PAGSymbol(name: "bodyText", code: 0x70547874, type: AppleEvents.typeType) // "pTxt"
    public static let bookmarkData = PAGSymbol(name: "bookmarkData", code: 0x626d726b, type: AppleEvents.typeType) // "bmrk"
    public static let boolean = PAGSymbol(name: "boolean", code: 0x626f6f6c, type: AppleEvents.typeType) // "bool"
    public static let boundingRectangle = PAGSymbol(name: "boundingRectangle", code: 0x71647274, type: AppleEvents.typeType) // "qdrt"
    public static let bounds = PAGSymbol(name: "bounds", code: 0x70626e64, type: AppleEvents.typeType) // "pbnd"
    public static let cell = PAGSymbol(name: "cell", code: 0x4e6d436c, type: AppleEvents.typeType) // "NmCl"
    public static let cellRange = PAGSymbol(name: "cellRange", code: 0x4e4d5463, type: AppleEvents.typeType) // "NMTc"
    public static let character = PAGSymbol(name: "character", code: 0x63686120, type: AppleEvents.typeType) // "cha "
    public static let chart = PAGSymbol(name: "chart", code: 0x73686374, type: AppleEvents.typeType) // "shct"
    public static let class_ = PAGSymbol(name: "class_", code: 0x70636c73, type: AppleEvents.typeType) // "pcls"
    public static let clipVolume = PAGSymbol(name: "clipVolume", code: 0x61766f6c, type: AppleEvents.typeType) // "avol"
    public static let closeable = PAGSymbol(name: "closeable", code: 0x68636c62, type: AppleEvents.typeType) // "hclb"
    public static let collating = PAGSymbol(name: "collating", code: 0x6c77636c, type: AppleEvents.typeType) // "lwcl"
    public static let color = PAGSymbol(name: "color", code: 0x636f6c72, type: AppleEvents.typeType) // "colr"
    public static let colorTable = PAGSymbol(name: "colorTable", code: 0x636c7274, type: AppleEvents.typeType) // "clrt"
    public static let column = PAGSymbol(name: "column", code: 0x4e4d436f, type: AppleEvents.typeType) // "NMCo"
    public static let columnCount = PAGSymbol(name: "columnCount", code: 0x4e6d5463, type: AppleEvents.typeType) // "NmTc"
    public static let constant = PAGSymbol(name: "constant", code: 0x656e756d, type: AppleEvents.typeType) // "enum"
    public static let copies = PAGSymbol(name: "copies", code: 0x6c776370, type: AppleEvents.typeType) // "lwcp"
    public static let cover = PAGSymbol(name: "cover", code: 0x50786563, type: AppleEvents.typeType) // "Pxec"
    public static let currentPage = PAGSymbol(name: "currentPage", code: 0x70437061, type: AppleEvents.typeType) // "pCpa"
    public static let dashStyle = PAGSymbol(name: "dashStyle", code: 0x74646173, type: AppleEvents.typeType) // "tdas"
    public static let data = PAGSymbol(name: "data", code: 0x74647461, type: AppleEvents.typeType) // "tdta"
    public static let date = PAGSymbol(name: "date", code: 0x6c647420, type: AppleEvents.typeType) // "ldt "
    public static let December = PAGSymbol(name: "December", code: 0x64656320, type: AppleEvents.typeType) // "dec "
    public static let decimalStruct = PAGSymbol(name: "decimalStruct", code: 0x6465636d, type: AppleEvents.typeType) // "decm"
    public static let description_ = PAGSymbol(name: "description_", code: 0x64736372, type: AppleEvents.typeType) // "dscr"
    public static let document = PAGSymbol(name: "document", code: 0x646f6375, type: AppleEvents.typeType) // "docu"
    public static let documentBody = PAGSymbol(name: "documentBody", code: 0x7044626f, type: AppleEvents.typeType) // "pDbo"
    public static let documentTemplate = PAGSymbol(name: "documentTemplate", code: 0x546d706c, type: AppleEvents.typeType) // "Tmpl"
    public static let doubleInteger = PAGSymbol(name: "doubleInteger", code: 0x636f6d70, type: AppleEvents.typeType) // "comp"
    public static let encodedString = PAGSymbol(name: "encodedString", code: 0x656e6373, type: AppleEvents.typeType) // "encs"
    public static let endingPage = PAGSymbol(name: "endingPage", code: 0x6c776c70, type: AppleEvents.typeType) // "lwlp"
    public static let endPoint = PAGSymbol(name: "endPoint", code: 0x6c6e6570, type: AppleEvents.typeType) // "lnep"
    public static let EPSPicture = PAGSymbol(name: "EPSPicture", code: 0x45505320, type: AppleEvents.typeType) // "EPS "
    public static let errorHandling = PAGSymbol(name: "errorHandling", code: 0x6c776568, type: AppleEvents.typeType) // "lweh"
    public static let exportOptions = PAGSymbol(name: "exportOptions", code: 0x50786f70, type: AppleEvents.typeType) // "Pxop"
    public static let faxNumber = PAGSymbol(name: "faxNumber", code: 0x6661786e, type: AppleEvents.typeType) // "faxn"
    public static let February = PAGSymbol(name: "February", code: 0x66656220, type: AppleEvents.typeType) // "feb "
    public static let file = PAGSymbol(name: "file", code: 0x66696c65, type: AppleEvents.typeType) // "file"
    public static let fileName = PAGSymbol(name: "fileName", code: 0x6174666e, type: AppleEvents.typeType) // "atfn"
    public static let fileRef = PAGSymbol(name: "fileRef", code: 0x66737266, type: AppleEvents.typeType) // "fsrf"
    public static let fileURL = PAGSymbol(name: "fileURL", code: 0x6675726c, type: AppleEvents.typeType) // "furl"
    public static let fixed = PAGSymbol(name: "fixed", code: 0x66697864, type: AppleEvents.typeType) // "fixd"
    public static let fixedLayout = PAGSymbol(name: "fixedLayout", code: 0x50786566, type: AppleEvents.typeType) // "Pxef"
    public static let fixedPoint = PAGSymbol(name: "fixedPoint", code: 0x66706e74, type: AppleEvents.typeType) // "fpnt"
    public static let fixedRectangle = PAGSymbol(name: "fixedRectangle", code: 0x66726374, type: AppleEvents.typeType) // "frct"
    public static let font = PAGSymbol(name: "font", code: 0x666f6e74, type: AppleEvents.typeType) // "font"
    public static let fontName = PAGSymbol(name: "fontName", code: 0x4e4d666e, type: AppleEvents.typeType) // "NMfn"
    public static let fontSize = PAGSymbol(name: "fontSize", code: 0x4e4d6673, type: AppleEvents.typeType) // "NMfs"
    public static let footerRowCount = PAGSymbol(name: "footerRowCount", code: 0x4e6d4672, type: AppleEvents.typeType) // "NmFr"
    public static let format = PAGSymbol(name: "format", code: 0x4e4d4354, type: AppleEvents.typeType) // "NMCT"
    public static let formattedValue = PAGSymbol(name: "formattedValue", code: 0x4e4d6676, type: AppleEvents.typeType) // "NMfv"
    public static let formula = PAGSymbol(name: "formula", code: 0x4e4d4366, type: AppleEvents.typeType) // "NMCf"
    public static let Friday = PAGSymbol(name: "Friday", code: 0x66726920, type: AppleEvents.typeType) // "fri "
    public static let frontmost = PAGSymbol(name: "frontmost", code: 0x70697366, type: AppleEvents.typeType) // "pisf"
    public static let genre = PAGSymbol(name: "genre", code: 0x50786567, type: AppleEvents.typeType) // "Pxeg"
    public static let GIFPicture = PAGSymbol(name: "GIFPicture", code: 0x47494666, type: AppleEvents.typeType) // "GIFf"
    public static let graphicText = PAGSymbol(name: "graphicText", code: 0x63677478, type: AppleEvents.typeType) // "cgtx"
    public static let group = PAGSymbol(name: "group", code: 0x69677270, type: AppleEvents.typeType) // "igrp"
    public static let headerColumnCount = PAGSymbol(name: "headerColumnCount", code: 0x4e6d4843, type: AppleEvents.typeType) // "NmHC"
    public static let headerRowCount = PAGSymbol(name: "headerRowCount", code: 0x4e6d4872, type: AppleEvents.typeType) // "NmHr"
    public static let height = PAGSymbol(name: "height", code: 0x73697468, type: AppleEvents.typeType) // "sith"
    public static let id = PAGSymbol(name: "id", code: 0x49442020, type: AppleEvents.typeType) // "ID  "
    public static let image = PAGSymbol(name: "image", code: 0x696d6167, type: AppleEvents.typeType) // "imag"
    public static let imageQuality = PAGSymbol(name: "imageQuality", code: 0x50785049, type: AppleEvents.typeType) // "PxPI"
    public static let index = PAGSymbol(name: "index", code: 0x70696478, type: AppleEvents.typeType) // "pidx"
    public static let integer = PAGSymbol(name: "integer", code: 0x6c6f6e67, type: AppleEvents.typeType) // "long"
    public static let internationalText = PAGSymbol(name: "internationalText", code: 0x69747874, type: AppleEvents.typeType) // "itxt"
    public static let internationalWritingCode = PAGSymbol(name: "internationalWritingCode", code: 0x696e746c, type: AppleEvents.typeType) // "intl"
    public static let item = PAGSymbol(name: "item", code: 0x636f626a, type: AppleEvents.typeType) // "cobj"
    public static let iWorkContainer = PAGSymbol(name: "iWorkContainer", code: 0x69776b63, type: AppleEvents.typeType) // "iwkc"
    public static let iWorkItem = PAGSymbol(name: "iWorkItem", code: 0x666d7469, type: AppleEvents.typeType) // "fmti"
    public static let January = PAGSymbol(name: "January", code: 0x6a616e20, type: AppleEvents.typeType) // "jan "
    public static let JPEGPicture = PAGSymbol(name: "JPEGPicture", code: 0x4a504547, type: AppleEvents.typeType) // "JPEG"
    public static let July = PAGSymbol(name: "July", code: 0x6a756c20, type: AppleEvents.typeType) // "jul "
    public static let June = PAGSymbol(name: "June", code: 0x6a756e20, type: AppleEvents.typeType) // "jun "
    public static let kernelProcessID = PAGSymbol(name: "kernelProcessID", code: 0x6b706964, type: AppleEvents.typeType) // "kpid"
    public static let language = PAGSymbol(name: "language", code: 0x5078656c, type: AppleEvents.typeType) // "Pxel"
    public static let largeReal = PAGSymbol(name: "largeReal", code: 0x6c64626c, type: AppleEvents.typeType) // "ldbl"
    public static let line = PAGSymbol(name: "line", code: 0x69576c6e, type: AppleEvents.typeType) // "iWln"
    public static let list = PAGSymbol(name: "list", code: 0x6c697374, type: AppleEvents.typeType) // "list"
    public static let locationReference = PAGSymbol(name: "locationReference", code: 0x696e736c, type: AppleEvents.typeType) // "insl"
    public static let locked = PAGSymbol(name: "locked", code: 0x704c636b, type: AppleEvents.typeType) // "pLck"
    public static let longFixed = PAGSymbol(name: "longFixed", code: 0x6c667864, type: AppleEvents.typeType) // "lfxd"
    public static let longFixedPoint = PAGSymbol(name: "longFixedPoint", code: 0x6c667074, type: AppleEvents.typeType) // "lfpt"
    public static let longFixedRectangle = PAGSymbol(name: "longFixedRectangle", code: 0x6c667263, type: AppleEvents.typeType) // "lfrc"
    public static let longPoint = PAGSymbol(name: "longPoint", code: 0x6c706e74, type: AppleEvents.typeType) // "lpnt"
    public static let longRectangle = PAGSymbol(name: "longRectangle", code: 0x6c726374, type: AppleEvents.typeType) // "lrct"
    public static let machine = PAGSymbol(name: "machine", code: 0x6d616368, type: AppleEvents.typeType) // "mach"
    public static let machineLocation = PAGSymbol(name: "machineLocation", code: 0x6d4c6f63, type: AppleEvents.typeType) // "mLoc"
    public static let machPort = PAGSymbol(name: "machPort", code: 0x706f7274, type: AppleEvents.typeType) // "port"
    public static let March = PAGSymbol(name: "March", code: 0x6d617220, type: AppleEvents.typeType) // "mar "
    public static let May = PAGSymbol(name: "May", code: 0x6d617920, type: AppleEvents.typeType) // "may "
    public static let miniaturizable = PAGSymbol(name: "miniaturizable", code: 0x69736d6e, type: AppleEvents.typeType) // "ismn"
    public static let miniaturized = PAGSymbol(name: "miniaturized", code: 0x706d6e64, type: AppleEvents.typeType) // "pmnd"
    public static let modified = PAGSymbol(name: "modified", code: 0x696d6f64, type: AppleEvents.typeType) // "imod"
    public static let Monday = PAGSymbol(name: "Monday", code: 0x6d6f6e20, type: AppleEvents.typeType) // "mon "
    public static let movie = PAGSymbol(name: "movie", code: 0x73686d76, type: AppleEvents.typeType) // "shmv"
    public static let movieVolume = PAGSymbol(name: "movieVolume", code: 0x6d766f6c, type: AppleEvents.typeType) // "mvol"
    public static let name = PAGSymbol(name: "name", code: 0x706e616d, type: AppleEvents.typeType) // "pnam"
    public static let November = PAGSymbol(name: "November", code: 0x6e6f7620, type: AppleEvents.typeType) // "nov "
    public static let null = PAGSymbol(name: "null", code: 0x6e756c6c, type: AppleEvents.typeType) // "null"
    public static let objectText = PAGSymbol(name: "objectText", code: 0x70445478, type: AppleEvents.typeType) // "pDTx"
    public static let October = PAGSymbol(name: "October", code: 0x6f637420, type: AppleEvents.typeType) // "oct "
    public static let opacity = PAGSymbol(name: "opacity", code: 0x70534f70, type: AppleEvents.typeType) // "pSOp"
    public static let page = PAGSymbol(name: "page", code: 0x63506167, type: AppleEvents.typeType) // "cPag"
    public static let pagesAcross = PAGSymbol(name: "pagesAcross", code: 0x6c776c61, type: AppleEvents.typeType) // "lwla"
    public static let pagesDown = PAGSymbol(name: "pagesDown", code: 0x6c776c64, type: AppleEvents.typeType) // "lwld"
    public static let paragraph = PAGSymbol(name: "paragraph", code: 0x63706172, type: AppleEvents.typeType) // "cpar"
    public static let parent = PAGSymbol(name: "parent", code: 0x73697074, type: AppleEvents.typeType) // "sipt"
    public static let password = PAGSymbol(name: "password", code: 0x50785057, type: AppleEvents.typeType) // "PxPW"
    public static let passwordHint = PAGSymbol(name: "passwordHint", code: 0x50785048, type: AppleEvents.typeType) // "PxPH"
    public static let PICTPicture = PAGSymbol(name: "PICTPicture", code: 0x50494354, type: AppleEvents.typeType) // "PICT"
    public static let pixelMapRecord = PAGSymbol(name: "pixelMapRecord", code: 0x74706d6d, type: AppleEvents.typeType) // "tpmm"
    public static let placeholderText = PAGSymbol(name: "placeholderText", code: 0x63706c61, type: AppleEvents.typeType) // "cpla"
    public static let point = PAGSymbol(name: "point", code: 0x51447074, type: AppleEvents.typeType) // "QDpt"
    public static let position = PAGSymbol(name: "position", code: 0x7369706f, type: AppleEvents.typeType) // "sipo"
    public static let printSettings = PAGSymbol(name: "printSettings", code: 0x70736574, type: AppleEvents.typeType) // "pset"
    public static let processSerialNumber = PAGSymbol(name: "processSerialNumber", code: 0x70736e20, type: AppleEvents.typeType) // "psn "
    public static let properties = PAGSymbol(name: "properties", code: 0x70414c4c, type: AppleEvents.typeType) // "pALL"
    public static let property_ = PAGSymbol(name: "property_", code: 0x70726f70, type: AppleEvents.typeType) // "prop"
    public static let publisher = PAGSymbol(name: "publisher", code: 0x50786570, type: AppleEvents.typeType) // "Pxep"
    public static let range = PAGSymbol(name: "range", code: 0x4e6d4352, type: AppleEvents.typeType) // "NmCR"
    public static let real = PAGSymbol(name: "real", code: 0x646f7562, type: AppleEvents.typeType) // "doub"
    public static let record = PAGSymbol(name: "record", code: 0x7265636f, type: AppleEvents.typeType) // "reco"
    public static let reference = PAGSymbol(name: "reference", code: 0x6f626a20, type: AppleEvents.typeType) // "obj "
    public static let reflectionShowing = PAGSymbol(name: "reflectionShowing", code: 0x73697273, type: AppleEvents.typeType) // "sirs"
    public static let reflectionValue = PAGSymbol(name: "reflectionValue", code: 0x73697276, type: AppleEvents.typeType) // "sirv"
    public static let repetitionMethod = PAGSymbol(name: "repetitionMethod", code: 0x6d767270, type: AppleEvents.typeType) // "mvrp"
    public static let requestedPrintTime = PAGSymbol(name: "requestedPrintTime", code: 0x6c777174, type: AppleEvents.typeType) // "lwqt"
    public static let resizable = PAGSymbol(name: "resizable", code: 0x7072737a, type: AppleEvents.typeType) // "prsz"
    public static let RGB16Color = PAGSymbol(name: "RGB16Color", code: 0x74723136, type: AppleEvents.typeType) // "tr16"
    public static let RGB96Color = PAGSymbol(name: "RGB96Color", code: 0x74723936, type: AppleEvents.typeType) // "tr96"
    public static let RGBColor = PAGSymbol(name: "RGBColor", code: 0x63524742, type: AppleEvents.typeType) // "cRGB"
    public static let richText = PAGSymbol(name: "richText", code: 0x72747874, type: AppleEvents.typeType) // "rtxt"
    public static let rotation = PAGSymbol(name: "rotation", code: 0x74726f74, type: AppleEvents.typeType) // "trot"
    public static let rotation_ = PAGSymbol(name: "rotation_", code: 0x7369726f, type: AppleEvents.typeType) // "siro"
    public static let row = PAGSymbol(name: "row", code: 0x4e4d5277, type: AppleEvents.typeType) // "NMRw"
    public static let rowCount = PAGSymbol(name: "rowCount", code: 0x4e6d5472, type: AppleEvents.typeType) // "NmTr"
    public static let Saturday = PAGSymbol(name: "Saturday", code: 0x73617420, type: AppleEvents.typeType) // "sat "
    public static let script = PAGSymbol(name: "script", code: 0x73637074, type: AppleEvents.typeType) // "scpt"
    public static let section = PAGSymbol(name: "section", code: 0x63536563, type: AppleEvents.typeType) // "cSec"
    public static let selection = PAGSymbol(name: "selection", code: 0x73656c65, type: AppleEvents.typeType) // "sele"
    public static let selectionRange = PAGSymbol(name: "selectionRange", code: 0x4e4d5473, type: AppleEvents.typeType) // "NMTs"
    public static let September = PAGSymbol(name: "September", code: 0x73657020, type: AppleEvents.typeType) // "sep "
    public static let shape = PAGSymbol(name: "shape", code: 0x73736870, type: AppleEvents.typeType) // "sshp"
    public static let shortInteger = PAGSymbol(name: "shortInteger", code: 0x73686f72, type: AppleEvents.typeType) // "shor"
    public static let size = PAGSymbol(name: "size", code: 0x7074737a, type: AppleEvents.typeType) // "ptsz"
    public static let smallReal = PAGSymbol(name: "smallReal", code: 0x73696e67, type: AppleEvents.typeType) // "sing"
    public static let startingPage = PAGSymbol(name: "startingPage", code: 0x6c776670, type: AppleEvents.typeType) // "lwfp"
    public static let startPoint = PAGSymbol(name: "startPoint", code: 0x6c6e7370, type: AppleEvents.typeType) // "lnsp"
    public static let string = PAGSymbol(name: "string", code: 0x54455854, type: AppleEvents.typeType) // "TEXT"
    public static let styledClipboardText = PAGSymbol(name: "styledClipboardText", code: 0x7374796c, type: AppleEvents.typeType) // "styl"
    public static let styledText = PAGSymbol(name: "styledText", code: 0x53545854, type: AppleEvents.typeType) // "STXT"
    public static let Sunday = PAGSymbol(name: "Sunday", code: 0x73756e20, type: AppleEvents.typeType) // "sun "
    public static let table = PAGSymbol(name: "table", code: 0x4e6d5462, type: AppleEvents.typeType) // "NmTb"
    public static let tag = PAGSymbol(name: "tag", code: 0x63706c74, type: AppleEvents.typeType) // "cplt"
    public static let targetPrinter = PAGSymbol(name: "targetPrinter", code: 0x74727072, type: AppleEvents.typeType) // "trpr"
    public static let template = PAGSymbol(name: "template", code: 0x746d706c, type: AppleEvents.typeType) // "tmpl"
    public static let textColor = PAGSymbol(name: "textColor", code: 0x74657843, type: AppleEvents.typeType) // "texC"
    public static let textItem = PAGSymbol(name: "textItem", code: 0x73687478, type: AppleEvents.typeType) // "shtx"
    public static let textStyleInfo = PAGSymbol(name: "textStyleInfo", code: 0x74737479, type: AppleEvents.typeType) // "tsty"
    public static let textWrap = PAGSymbol(name: "textWrap", code: 0x77726170, type: AppleEvents.typeType) // "wrap"
    public static let Thursday = PAGSymbol(name: "Thursday", code: 0x74687520, type: AppleEvents.typeType) // "thu "
    public static let TIFFPicture = PAGSymbol(name: "TIFFPicture", code: 0x54494646, type: AppleEvents.typeType) // "TIFF"
    public static let title = PAGSymbol(name: "title", code: 0x50786574, type: AppleEvents.typeType) // "Pxet"
    public static let Tuesday = PAGSymbol(name: "Tuesday", code: 0x74756520, type: AppleEvents.typeType) // "tue "
    public static let typeClass = PAGSymbol(name: "typeClass", code: 0x74797065, type: AppleEvents.typeType) // "type"
    public static let UnicodeText = PAGSymbol(name: "UnicodeText", code: 0x75747874, type: AppleEvents.typeType) // "utxt"
    public static let unsignedDoubleInteger = PAGSymbol(name: "unsignedDoubleInteger", code: 0x75636f6d, type: AppleEvents.typeType) // "ucom"
    public static let unsignedInteger = PAGSymbol(name: "unsignedInteger", code: 0x6d61676e, type: AppleEvents.typeType) // "magn"
    public static let unsignedShortInteger = PAGSymbol(name: "unsignedShortInteger", code: 0x75736872, type: AppleEvents.typeType) // "ushr"
    public static let UTF16Text = PAGSymbol(name: "UTF16Text", code: 0x75743136, type: AppleEvents.typeType) // "ut16"
    public static let UTF8Text = PAGSymbol(name: "UTF8Text", code: 0x75746638, type: AppleEvents.typeType) // "utf8"
    public static let value = PAGSymbol(name: "value", code: 0x4e4d4376, type: AppleEvents.typeType) // "NMCv"
    public static let version = PAGSymbol(name: "version", code: 0x76657273, type: AppleEvents.typeType) // "vers"
    public static let verticalAlignment = PAGSymbol(name: "verticalAlignment", code: 0x74785641, type: AppleEvents.typeType) // "txVA"
    public static let visible = PAGSymbol(name: "visible", code: 0x70766973, type: AppleEvents.typeType) // "pvis"
    public static let Wednesday = PAGSymbol(name: "Wednesday", code: 0x77656420, type: AppleEvents.typeType) // "wed "
    public static let width = PAGSymbol(name: "width", code: 0x73697477, type: AppleEvents.typeType) // "sitw"
    public static let window = PAGSymbol(name: "window", code: 0x6377696e, type: AppleEvents.typeType) // "cwin"
    public static let word = PAGSymbol(name: "word", code: 0x63776f72, type: AppleEvents.typeType) // "cwor"
    public static let writingCode = PAGSymbol(name: "writingCode", code: 0x70736374, type: AppleEvents.typeType) // "psct"
    public static let zoomable = PAGSymbol(name: "zoomable", code: 0x69737a6d, type: AppleEvents.typeType) // "iszm"
    public static let zoomed = PAGSymbol(name: "zoomed", code: 0x707a756d, type: AppleEvents.typeType) // "pzum"

    // Enumerators
    public static let advancedGradientFill = PAGSymbol(name: "advancedGradientFill", code: 0x66696167, type: AppleEvents.typeEnumerated) // "fiag"
    public static let advancedImageFill = PAGSymbol(name: "advancedImageFill", code: 0x66696169, type: AppleEvents.typeEnumerated) // "fiai"
    public static let ascending = PAGSymbol(name: "ascending", code: 0x6173636e, type: AppleEvents.typeEnumerated) // "ascn"
    public static let ask = PAGSymbol(name: "ask", code: 0x61736b20, type: AppleEvents.typeEnumerated) // "ask "
    public static let autoAlign = PAGSymbol(name: "autoAlign", code: 0x61617574, type: AppleEvents.typeEnumerated) // "aaut"
    public static let automatic = PAGSymbol(name: "automatic", code: 0x66617574, type: AppleEvents.typeEnumerated) // "faut"
    public static let Best = PAGSymbol(name: "Best", code: 0x50675032, type: AppleEvents.typeEnumerated) // "PgP2"
    public static let Better = PAGSymbol(name: "Better", code: 0x50675031, type: AppleEvents.typeEnumerated) // "PgP1"
    public static let bottom = PAGSymbol(name: "bottom", code: 0x61766274, type: AppleEvents.typeEnumerated) // "avbt"
    public static let case_ = PAGSymbol(name: "case_", code: 0x63617365, type: AppleEvents.typeEnumerated) // "case"
    public static let center = PAGSymbol(name: "center", code: 0x61637472, type: AppleEvents.typeEnumerated) // "actr"
    public static let checkbox = PAGSymbol(name: "checkbox", code: 0x66636368, type: AppleEvents.typeEnumerated) // "fcch"
    public static let colorFill = PAGSymbol(name: "colorFill", code: 0x6669636f, type: AppleEvents.typeEnumerated) // "fico"
    public static let currency = PAGSymbol(name: "currency", code: 0x66637572, type: AppleEvents.typeEnumerated) // "fcur"
    public static let dateAndTime = PAGSymbol(name: "dateAndTime", code: 0x6664746d, type: AppleEvents.typeEnumerated) // "fdtm"
    public static let descending = PAGSymbol(name: "descending", code: 0x6473636e, type: AppleEvents.typeEnumerated) // "dscn"
    public static let detailed = PAGSymbol(name: "detailed", code: 0x6c776474, type: AppleEvents.typeEnumerated) // "lwdt"
    public static let diacriticals = PAGSymbol(name: "diacriticals", code: 0x64696163, type: AppleEvents.typeEnumerated) // "diac"
    public static let duration = PAGSymbol(name: "duration", code: 0x66647572, type: AppleEvents.typeEnumerated) // "fdur"
    public static let EPUB = PAGSymbol(name: "EPUB", code: 0x50657075, type: AppleEvents.typeEnumerated) // "Pepu"
    public static let expansion = PAGSymbol(name: "expansion", code: 0x65787061, type: AppleEvents.typeEnumerated) // "expa"
    public static let formattedText = PAGSymbol(name: "formattedText", code: 0x50727466, type: AppleEvents.typeEnumerated) // "Prtf"
    public static let fraction = PAGSymbol(name: "fraction", code: 0x66667261, type: AppleEvents.typeEnumerated) // "ffra"
    public static let Good = PAGSymbol(name: "Good", code: 0x50675030, type: AppleEvents.typeEnumerated) // "PgP0"
    public static let gradientFill = PAGSymbol(name: "gradientFill", code: 0x66696772, type: AppleEvents.typeEnumerated) // "figr"
    public static let hyphens = PAGSymbol(name: "hyphens", code: 0x68797068, type: AppleEvents.typeEnumerated) // "hyph"
    public static let imageFill = PAGSymbol(name: "imageFill", code: 0x6669696d, type: AppleEvents.typeEnumerated) // "fiim"
    public static let justify = PAGSymbol(name: "justify", code: 0x616a7374, type: AppleEvents.typeEnumerated) // "ajst"
    public static let left = PAGSymbol(name: "left", code: 0x616c6674, type: AppleEvents.typeEnumerated) // "alft"
    public static let loop = PAGSymbol(name: "loop", code: 0x6d766c70, type: AppleEvents.typeEnumerated) // "mvlp"
    public static let loopBackAndForth = PAGSymbol(name: "loopBackAndForth", code: 0x6d766266, type: AppleEvents.typeEnumerated) // "mvbf"
    public static let MicrosoftWord = PAGSymbol(name: "MicrosoftWord", code: 0x50777264, type: AppleEvents.typeEnumerated) // "Pwrd"
    public static let no = PAGSymbol(name: "no", code: 0x6e6f2020, type: AppleEvents.typeEnumerated) // "no  "
    public static let noFill = PAGSymbol(name: "noFill", code: 0x66696e6f, type: AppleEvents.typeEnumerated) // "fino"
    public static let none = PAGSymbol(name: "none", code: 0x6d76726e, type: AppleEvents.typeEnumerated) // "mvrn"
    public static let number = PAGSymbol(name: "number", code: 0x6e6d6272, type: AppleEvents.typeEnumerated) // "nmbr"
    public static let numeralSystem = PAGSymbol(name: "numeralSystem", code: 0x66636e73, type: AppleEvents.typeEnumerated) // "fcns"
    public static let numericStrings = PAGSymbol(name: "numericStrings", code: 0x6e756d65, type: AppleEvents.typeEnumerated) // "nume"
    public static let Pages09 = PAGSymbol(name: "Pages09", code: 0x50506167, type: AppleEvents.typeEnumerated) // "PPag"
    public static let PagesFormat = PAGSymbol(name: "PagesFormat", code: 0x50676666, type: AppleEvents.typeEnumerated) // "Pgff"
    public static let PDF = PAGSymbol(name: "PDF", code: 0x50706466, type: AppleEvents.typeEnumerated) // "Ppdf"
    public static let percent = PAGSymbol(name: "percent", code: 0x66706572, type: AppleEvents.typeEnumerated) // "fper"
    public static let popUpMenu = PAGSymbol(name: "popUpMenu", code: 0x66637070, type: AppleEvents.typeEnumerated) // "fcpp"
    public static let punctuation = PAGSymbol(name: "punctuation", code: 0x70756e63, type: AppleEvents.typeEnumerated) // "punc"
    public static let rating = PAGSymbol(name: "rating", code: 0x66726174, type: AppleEvents.typeEnumerated) // "frat"
    public static let right = PAGSymbol(name: "right", code: 0x61726974, type: AppleEvents.typeEnumerated) // "arit"
    public static let scientific = PAGSymbol(name: "scientific", code: 0x66736369, type: AppleEvents.typeEnumerated) // "fsci"
    public static let slider = PAGSymbol(name: "slider", code: 0x6663736c, type: AppleEvents.typeEnumerated) // "fcsl"
    public static let standard = PAGSymbol(name: "standard", code: 0x6c777374, type: AppleEvents.typeEnumerated) // "lwst"
    public static let stepper = PAGSymbol(name: "stepper", code: 0x66637374, type: AppleEvents.typeEnumerated) // "fcst"
    public static let text = PAGSymbol(name: "text", code: 0x63747874, type: AppleEvents.typeEnumerated) // "ctxt"
    public static let top = PAGSymbol(name: "top", code: 0x61767470, type: AppleEvents.typeEnumerated) // "avtp"
    public static let unformattedText = PAGSymbol(name: "unformattedText", code: 0x50747866, type: AppleEvents.typeEnumerated) // "Ptxf"
    public static let whitespace = PAGSymbol(name: "whitespace", code: 0x77686974, type: AppleEvents.typeEnumerated) // "whit"
    public static let yes = PAGSymbol(name: "yes", code: 0x79657320, type: AppleEvents.typeEnumerated) // "yes "
}
...
extension PAGCommand {
    ...
    @discardableResult public func export(_ directParameter: Any = SwiftAutomation.noParameter,
            ...
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "export", event: 0x50677374_6578706f, // "Pgstexpo"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
...
extension PAGObject {
    ...
    public var id: PAGItem {return self.property(0x49442020) as! PAGItem} // "ID  "
    ...
    public var selection: PAGItem {return self.property(0x73656c65) as! PAGItem} // "sele"
    ...
    public var characters: PAGItems {return self.elements(0x63686120) as! PAGItems} // "cha "

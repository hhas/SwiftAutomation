...
public class VOVSymbol: SwiftAutomation.Symbol {
    ...
    public override class func symbol(code: OSType, type: OSType = typeType, descriptor: ScalarDescriptor? = nil) -> VOVSymbol {
        switch (code) {
    ...
    public static let April = VOVSymbol(name: "April", code: 0x61707220, type: typeType) // "apr "
    public static let August = VOVSymbol(name: "August", code: 0x61756720, type: typeType) // "aug "
    ...
    public static let date = VOVSymbol(name: "date", code: 0x6c647420, type: typeType) // "ldt "
    public static let December = VOVSymbol(name: "December", code: 0x64656320, type: typeType) // "dec "
    ...
    public static let EPSPicture = VOVSymbol(name: "EPSPicture", code: 0x45505320, type: typeType) // "EPS "
    public static let February = VOVSymbol(name: "February", code: 0x66656220, type: typeType) // "feb "
    ...
    public static let Friday = VOVSymbol(name: "Friday", code: 0x66726920, type: typeType) // "fri "
    ...
    public static let id = VOVSymbol(name: "id", code: 0x49442020, type: typeType) // "ID  "
    ...
    public static let January = VOVSymbol(name: "January", code: 0x6a616e20, type: typeType) // "jan "
    public static let JPEGPicture = VOVSymbol(name: "JPEGPicture", code: 0x4a504547, type: typeType) // "JPEG"
    public static let July = VOVSymbol(name: "July", code: 0x6a756c20, type: typeType) // "jul "
    public static let June = VOVSymbol(name: "June", code: 0x6a756e20, type: typeType) // "jun "
    ...
    public static let March = VOVSymbol(name: "March", code: 0x6d617220, type: typeType) // "mar "
    public static let May = VOVSymbol(name: "May", code: 0x6d617920, type: typeType) // "may "
    public static let Monday = VOVSymbol(name: "Monday", code: 0x6d6f6e20, type: typeType) // "mon "
    ...
    public static let November = VOVSymbol(name: "November", code: 0x6e6f7620, type: typeType) // "nov "
    public static let null = VOVSymbol(name: "null", code: 0x6e756c6c, type: typeType) // "null"
    public static let October = VOVSymbol(name: "October", code: 0x6f637420, type: typeType) // "oct "
    ...
    public static let processSerialNumber = VOVSymbol(name: "processSerialNumber", code: 0x70736e20, type: typeType) // "psn "
    ...
    public static let reference = VOVSymbol(name: "reference", code: 0x6f626a20, type: typeType) // "obj "
    ...
    public static let Saturday = VOVSymbol(name: "Saturday", code: 0x73617420, type: typeType) // "sat "
    public static let script = VOVSymbol(name: "script", code: 0x73637074, type: typeType) // "scpt"
    public static let September = VOVSymbol(name: "September", code: 0x73657020, type: typeType) // "sep "
    ...
    public static let Sunday = VOVSymbol(name: "Sunday", code: 0x73756e20, type: typeType) // "sun "
    ...
    public static let Thursday = VOVSymbol(name: "Thursday", code: 0x74687520, type: typeType) // "thu "
    public static let TIFFPicture = VOVSymbol(name: "TIFFPicture", code: 0x54494646, type: typeType) // "TIFF"
    public static let Tuesday = VOVSymbol(name: "Tuesday", code: 0x74756520, type: typeType) // "tue "
    ...
    public static let Wednesday = VOVSymbol(name: "Wednesday", code: 0x77656420, type: typeType) // "wed "
    ...
    public static let ask = VOVSymbol(name: "ask", code: 0x61736b20, type: typeEnumerated) // "ask "
    ...
    public static let intoItem = VOVSymbol(name: "intoItem", code: 0x696e2056, type: typeEnumerated) // "in V"
    ...
    public static let no = VOVSymbol(name: "no", code: 0x6e6f2020, type: typeEnumerated) // "no  "
    ...
    public static let up = VOVSymbol(name: "up", code: 0x75702056, type: typeEnumerated) // "up V"
    ...
    public static let yes = VOVSymbol(name: "yes", code: 0x79657320, type: typeEnumerated) // "yes "
}

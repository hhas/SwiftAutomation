...
private let _specifierFormatter = SwiftAutomation.SpecifierFormatter(applicationClassName: "VoiceOver",
                                                     ...
                                                     typeNames: [
                                                                     ...
                                                                     0x62727061: "braillePanel", // "brpa"
                                                                     0x6272704f: "braillePanelObject", // "brpO"
                                                                     0x63617061: "captionPanel", // "capa"
                                                                     0x6361704f: "captionPanelObject", // "capO"
                                                     ...
                                                     elementsNames: [
                                                                     ...
                                                                     0x6272704f: "braillePanelObjects", // "brpO"
                                                                     0x6361704f: "captionPanelObjects", // "capO"
                                                                     0x636d6d4f: "commanderObjects", // "cmmO"
                                                                     0x636f626a: "items", // "cobj"
                                                                     0x6b62634f: "keyboardCursorObjects", // "kbcO"
                                                                     0x6c61704f: "lastPhraseObjects", // "lapO"
                                                                     0x6d6f634f: "mouseCursorObjects", // "mocO"
                                                                     0x766f634f: "voCursorObject", // "vocO"
                                                     ])
...
public class VOVSymbol: SwiftAutomation.Symbol {
    ...
    public override class func symbol(code: OSType, type: OSType = typeType, descriptor: NSAppleEventDescriptor? = nil) -> VOVSymbol {
        ...
        case 0x62727061: return self.braillePanel // "brpa"
        case 0x6272704f: return self.braillePanelObject // "brpO"
        case 0x63617061: return self.captionPanel // "capa"
        case 0x6361704f: return self.captionPanelObject // "capO"
        ...
        case 0x726f7773: return self.rows // "rows"
        ...
        case 0x73697a65: return self.size // "size"
    ...
    public static let braillePanel = VOVSymbol(name: "braillePanel", code: 0x62727061, type: typeType) // "brpa"
    public static let braillePanelObject = VOVSymbol(name: "braillePanelObject", code: 0x6272704f, type: typeType) // "brpO"
    public static let captionPanel = VOVSymbol(name: "captionPanel", code: 0x63617061, type: typeType) // "capa"
    public static let captionPanelObject = VOVSymbol(name: "captionPanelObject", code: 0x6361704f, type: typeType) // "capO"
    ...
    public static let position = VOVSymbol(name: "position", code: 0x70706f73, type: typeType) // "ppos"
    ...
    public static let rows = VOVSymbol(name: "rows", code: 0x726f7773, type: typeType) // "rows"
    ...
    public static let size = VOVSymbol(name: "size", code: 0x73697a65, type: typeType) // "size"
    ...
    public static let visible = VOVSymbol(name: "visible", code: 0x70766973, type: typeType) // "pvis"
...
extension VOVObject {
    ...
    public var braillePanel: VOVItem {return self.property(0x62727061) as! VOVItem} // "brpa"
    public var captionPanel: VOVItem {return self.property(0x63617061) as! VOVItem} // "capa"
    ...
    public var position: VOVItem {return self.property(0x70706f73) as! VOVItem} // "ppos"
    public var properties: VOVItem {return self.property(0x70414c4c) as! VOVItem} // "pALL"
    public var rows: VOVItem {return self.property(0x726f7773) as! VOVItem} // "rows"
    public var size: VOVItem {return self.property(0x73697a65) as! VOVItem} // "size"
    public var textUnderCursor: VOVItem {return self.property(0x766f7478) as! VOVItem} // "votx"
    public var visible: VOVItem {return self.property(0x70766973) as! VOVItem} // "pvis"
    ...
    public var braillePanelObjects: VOVItems {return self.elements(0x6272704f) as! VOVItems} // "brpO"
    public var captionPanelObjects: VOVItems {return self.elements(0x6361704f) as! VOVItems} // "capO"

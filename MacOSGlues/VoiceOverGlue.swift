...
private let _specifierFormatter = SwiftAutomation.SpecifierFormatter(
        applicationClassName: "VoiceOver",
        classNamePrefix: "VOV",
        typeNames: [
        ...
        elementsNames: [
                ...
                0x6272704f: ("brailleWindowObject", "brailleWindowObjects"), // "brpO"
                0x6361704f: ("captionWindowObject", "captionWindowObjects"), // "capO"
                0x636d6d4f: ("commanderObject", "commanderObjects"), // "cmmO"
                0x636f626a: ("item", "items"), // "cobj"
                0x6b62634f: ("keyboardCursorObject", "keyboardCursorObjects"), // "kbcO"
                0x6c61704f: ("lastPhraseObject", "lastPhraseObjects"), // "lapO"
                0x6d6f634f: ("mouseCursorObject", "mouseCursorObjects"), // "mocO"
                0x766f634f: ("voCursorObject", "voCursorObject"), // "vocO"
        ])

private let _glueClasses = SwiftAutomation.GlueClasses(
                                                insertionSpecifierType: VOVInsertion.self,
...
public class VOVSymbol: SwiftAutomation.Symbol {
    ...
    public override class func symbol(code: OSType, type: OSType = AppleEvents.typeType, descriptor: ScalarDescriptor? = nil) -> VOVSymbol {
        switch (code) {
        ...
        case 0x696e2056: return self.intoItem // "in V"
        ...
        case 0x75702056: return self.up // "up V"
    ...
    // Types/properties
    public static let alias = VOVSymbol(name: "alias", code: 0x616c6973, type: AppleEvents.typeType) // "alis"
    public static let anything = VOVSymbol(name: "anything", code: 0x2a2a2a2a, type: AppleEvents.typeType) // "****"
    public static let application = VOVSymbol(name: "application", code: 0x63617070, type: AppleEvents.typeType) // "capp"
    public static let applicationBundleID = VOVSymbol(name: "applicationBundleID", code: 0x62756e64, type: AppleEvents.typeType) // "bund"
    public static let applicationSignature = VOVSymbol(name: "applicationSignature", code: 0x7369676e, type: AppleEvents.typeType) // "sign"
    public static let applicationURL = VOVSymbol(name: "applicationURL", code: 0x6170726c, type: AppleEvents.typeType) // "aprl"
    public static let April = VOVSymbol(name: "April", code: 0x61707220, type: AppleEvents.typeType) // "apr "
    public static let August = VOVSymbol(name: "August", code: 0x61756720, type: AppleEvents.typeType) // "aug "
    public static let best = VOVSymbol(name: "best", code: 0x62657374, type: AppleEvents.typeType) // "best"
    public static let bookmarkData = VOVSymbol(name: "bookmarkData", code: 0x626d726b, type: AppleEvents.typeType) // "bmrk"
    public static let boolean = VOVSymbol(name: "boolean", code: 0x626f6f6c, type: AppleEvents.typeType) // "bool"
    public static let boundingRectangle = VOVSymbol(name: "boundingRectangle", code: 0x71647274, type: AppleEvents.typeType) // "qdrt"
    public static let bounds = VOVSymbol(name: "bounds", code: 0x70626e64, type: AppleEvents.typeType) // "pbnd"
    public static let brailleWindow = VOVSymbol(name: "brailleWindow", code: 0x62727061, type: AppleEvents.typeType) // "brpa"
    public static let brailleWindowObject = VOVSymbol(name: "brailleWindowObject", code: 0x6272704f, type: AppleEvents.typeType) // "brpO"
    public static let captionWindow = VOVSymbol(name: "captionWindow", code: 0x63617061, type: AppleEvents.typeType) // "capa"
    public static let captionWindowObject = VOVSymbol(name: "captionWindowObject", code: 0x6361704f, type: AppleEvents.typeType) // "capO"
    public static let class_ = VOVSymbol(name: "class_", code: 0x70636c73, type: AppleEvents.typeType) // "pcls"
    public static let colorTable = VOVSymbol(name: "colorTable", code: 0x636c7274, type: AppleEvents.typeType) // "clrt"
    public static let commander = VOVSymbol(name: "commander", code: 0x636d6d64, type: AppleEvents.typeType) // "cmmd"
    public static let commanderObject = VOVSymbol(name: "commanderObject", code: 0x636d6d4f, type: AppleEvents.typeType) // "cmmO"
    public static let constant = VOVSymbol(name: "constant", code: 0x656e756d, type: AppleEvents.typeType) // "enum"
    public static let content = VOVSymbol(name: "content", code: 0x6c707478, type: AppleEvents.typeType) // "lptx"
    public static let dashStyle = VOVSymbol(name: "dashStyle", code: 0x74646173, type: AppleEvents.typeType) // "tdas"
    public static let data = VOVSymbol(name: "data", code: 0x74647461, type: AppleEvents.typeType) // "tdta"
    public static let date = VOVSymbol(name: "date", code: 0x6c647420, type: AppleEvents.typeType) // "ldt "
    public static let December = VOVSymbol(name: "December", code: 0x64656320, type: AppleEvents.typeType) // "dec "
    public static let decimalStruct = VOVSymbol(name: "decimalStruct", code: 0x6465636d, type: AppleEvents.typeType) // "decm"
    public static let doubleInteger = VOVSymbol(name: "doubleInteger", code: 0x636f6d70, type: AppleEvents.typeType) // "comp"
    public static let enabled = VOVSymbol(name: "enabled", code: 0x63776f6e, type: AppleEvents.typeType) // "cwon"
    public static let encodedString = VOVSymbol(name: "encodedString", code: 0x656e6373, type: AppleEvents.typeType) // "encs"
    public static let EPSPicture = VOVSymbol(name: "EPSPicture", code: 0x45505320, type: AppleEvents.typeType) // "EPS "
    public static let February = VOVSymbol(name: "February", code: 0x66656220, type: AppleEvents.typeType) // "feb "
    public static let fileRef = VOVSymbol(name: "fileRef", code: 0x66737266, type: AppleEvents.typeType) // "fsrf"
    public static let fileURL = VOVSymbol(name: "fileURL", code: 0x6675726c, type: AppleEvents.typeType) // "furl"
    public static let fixed = VOVSymbol(name: "fixed", code: 0x66697864, type: AppleEvents.typeType) // "fixd"
    public static let fixedPoint = VOVSymbol(name: "fixedPoint", code: 0x66706e74, type: AppleEvents.typeType) // "fpnt"
    public static let fixedRectangle = VOVSymbol(name: "fixedRectangle", code: 0x66726374, type: AppleEvents.typeType) // "frct"
    public static let Friday = VOVSymbol(name: "Friday", code: 0x66726920, type: AppleEvents.typeType) // "fri "
    public static let GIFPicture = VOVSymbol(name: "GIFPicture", code: 0x47494666, type: AppleEvents.typeType) // "GIFf"
    public static let graphicText = VOVSymbol(name: "graphicText", code: 0x63677478, type: AppleEvents.typeType) // "cgtx"
    public static let id = VOVSymbol(name: "id", code: 0x49442020, type: AppleEvents.typeType) // "ID  "
    public static let integer = VOVSymbol(name: "integer", code: 0x6c6f6e67, type: AppleEvents.typeType) // "long"
    public static let internationalText = VOVSymbol(name: "internationalText", code: 0x69747874, type: AppleEvents.typeType) // "itxt"
    public static let internationalWritingCode = VOVSymbol(name: "internationalWritingCode", code: 0x696e746c, type: AppleEvents.typeType) // "intl"
    public static let item = VOVSymbol(name: "item", code: 0x636f626a, type: AppleEvents.typeType) // "cobj"
    public static let January = VOVSymbol(name: "January", code: 0x6a616e20, type: AppleEvents.typeType) // "jan "
    public static let JPEGPicture = VOVSymbol(name: "JPEGPicture", code: 0x4a504547, type: AppleEvents.typeType) // "JPEG"
    public static let July = VOVSymbol(name: "July", code: 0x6a756c20, type: AppleEvents.typeType) // "jul "
    public static let June = VOVSymbol(name: "June", code: 0x6a756e20, type: AppleEvents.typeType) // "jun "
    public static let kernelProcessID = VOVSymbol(name: "kernelProcessID", code: 0x6b706964, type: AppleEvents.typeType) // "kpid"
    public static let keyboardCursor = VOVSymbol(name: "keyboardCursor", code: 0x6b626375, type: AppleEvents.typeType) // "kbcu"
    public static let keyboardCursorObject = VOVSymbol(name: "keyboardCursorObject", code: 0x6b62634f, type: AppleEvents.typeType) // "kbcO"
    public static let largeReal = VOVSymbol(name: "largeReal", code: 0x6c64626c, type: AppleEvents.typeType) // "ldbl"
    public static let lastPhrase = VOVSymbol(name: "lastPhrase", code: 0x6c617072, type: AppleEvents.typeType) // "lapr"
    public static let lastPhraseObject = VOVSymbol(name: "lastPhraseObject", code: 0x6c61704f, type: AppleEvents.typeType) // "lapO"
    public static let list = VOVSymbol(name: "list", code: 0x6c697374, type: AppleEvents.typeType) // "list"
    public static let locationReference = VOVSymbol(name: "locationReference", code: 0x696e736c, type: AppleEvents.typeType) // "insl"
    public static let longFixed = VOVSymbol(name: "longFixed", code: 0x6c667864, type: AppleEvents.typeType) // "lfxd"
    public static let longFixedPoint = VOVSymbol(name: "longFixedPoint", code: 0x6c667074, type: AppleEvents.typeType) // "lfpt"
    public static let longFixedRectangle = VOVSymbol(name: "longFixedRectangle", code: 0x6c667263, type: AppleEvents.typeType) // "lfrc"
    public static let longPoint = VOVSymbol(name: "longPoint", code: 0x6c706e74, type: AppleEvents.typeType) // "lpnt"
    public static let longRectangle = VOVSymbol(name: "longRectangle", code: 0x6c726374, type: AppleEvents.typeType) // "lrct"
    public static let machine = VOVSymbol(name: "machine", code: 0x6d616368, type: AppleEvents.typeType) // "mach"
    public static let machineLocation = VOVSymbol(name: "machineLocation", code: 0x6d4c6f63, type: AppleEvents.typeType) // "mLoc"
    public static let machPort = VOVSymbol(name: "machPort", code: 0x706f7274, type: AppleEvents.typeType) // "port"
    public static let magnification = VOVSymbol(name: "magnification", code: 0x764d6167, type: AppleEvents.typeType) // "vMag"
    public static let March = VOVSymbol(name: "March", code: 0x6d617220, type: AppleEvents.typeType) // "mar "
    public static let May = VOVSymbol(name: "May", code: 0x6d617920, type: AppleEvents.typeType) // "may "
    public static let Monday = VOVSymbol(name: "Monday", code: 0x6d6f6e20, type: AppleEvents.typeType) // "mon "
    public static let mouseCursor = VOVSymbol(name: "mouseCursor", code: 0x6d6f6375, type: AppleEvents.typeType) // "mocu"
    public static let mouseCursorObject = VOVSymbol(name: "mouseCursorObject", code: 0x6d6f634f, type: AppleEvents.typeType) // "mocO"
    public static let November = VOVSymbol(name: "November", code: 0x6e6f7620, type: AppleEvents.typeType) // "nov "
    public static let null = VOVSymbol(name: "null", code: 0x6e756c6c, type: AppleEvents.typeType) // "null"
    public static let October = VOVSymbol(name: "October", code: 0x6f637420, type: AppleEvents.typeType) // "oct "
    public static let PICTPicture = VOVSymbol(name: "PICTPicture", code: 0x50494354, type: AppleEvents.typeType) // "PICT"
    public static let pixelMapRecord = VOVSymbol(name: "pixelMapRecord", code: 0x74706d6d, type: AppleEvents.typeType) // "tpmm"
    public static let point = VOVSymbol(name: "point", code: 0x51447074, type: AppleEvents.typeType) // "QDpt"
    public static let position = VOVSymbol(name: "position", code: 0x706f7369, type: AppleEvents.typeType) // "posi"
    public static let processSerialNumber = VOVSymbol(name: "processSerialNumber", code: 0x70736e20, type: AppleEvents.typeType) // "psn "
    public static let properties = VOVSymbol(name: "properties", code: 0x70414c4c, type: AppleEvents.typeType) // "pALL"
    public static let property_ = VOVSymbol(name: "property_", code: 0x70726f70, type: AppleEvents.typeType) // "prop"
    public static let real = VOVSymbol(name: "real", code: 0x646f7562, type: AppleEvents.typeType) // "doub"
    public static let record = VOVSymbol(name: "record", code: 0x7265636f, type: AppleEvents.typeType) // "reco"
    public static let reference = VOVSymbol(name: "reference", code: 0x6f626a20, type: AppleEvents.typeType) // "obj "
    public static let RGB16Color = VOVSymbol(name: "RGB16Color", code: 0x74723136, type: AppleEvents.typeType) // "tr16"
    public static let RGB96Color = VOVSymbol(name: "RGB96Color", code: 0x74723936, type: AppleEvents.typeType) // "tr96"
    public static let RGBColor = VOVSymbol(name: "RGBColor", code: 0x63524742, type: AppleEvents.typeType) // "cRGB"
    public static let rotation = VOVSymbol(name: "rotation", code: 0x74726f74, type: AppleEvents.typeType) // "trot"
    public static let Saturday = VOVSymbol(name: "Saturday", code: 0x73617420, type: AppleEvents.typeType) // "sat "
    public static let script = VOVSymbol(name: "script", code: 0x73637074, type: AppleEvents.typeType) // "scpt"
    public static let September = VOVSymbol(name: "September", code: 0x73657020, type: AppleEvents.typeType) // "sep "
    public static let shortInteger = VOVSymbol(name: "shortInteger", code: 0x73686f72, type: AppleEvents.typeType) // "shor"
    public static let smallReal = VOVSymbol(name: "smallReal", code: 0x73696e67, type: AppleEvents.typeType) // "sing"
    public static let string = VOVSymbol(name: "string", code: 0x54455854, type: AppleEvents.typeType) // "TEXT"
    public static let styledClipboardText = VOVSymbol(name: "styledClipboardText", code: 0x7374796c, type: AppleEvents.typeType) // "styl"
    public static let styledText = VOVSymbol(name: "styledText", code: 0x53545854, type: AppleEvents.typeType) // "STXT"
    public static let Sunday = VOVSymbol(name: "Sunday", code: 0x73756e20, type: AppleEvents.typeType) // "sun "
    public static let textStyleInfo = VOVSymbol(name: "textStyleInfo", code: 0x74737479, type: AppleEvents.typeType) // "tsty"
    public static let textUnderCursor = VOVSymbol(name: "textUnderCursor", code: 0x766f7478, type: AppleEvents.typeType) // "votx"
    public static let Thursday = VOVSymbol(name: "Thursday", code: 0x74687520, type: AppleEvents.typeType) // "thu "
    public static let TIFFPicture = VOVSymbol(name: "TIFFPicture", code: 0x54494646, type: AppleEvents.typeType) // "TIFF"
    public static let Tuesday = VOVSymbol(name: "Tuesday", code: 0x74756520, type: AppleEvents.typeType) // "tue "
    public static let typeClass = VOVSymbol(name: "typeClass", code: 0x74797065, type: AppleEvents.typeType) // "type"
    public static let UnicodeText = VOVSymbol(name: "UnicodeText", code: 0x75747874, type: AppleEvents.typeType) // "utxt"
    public static let unsignedDoubleInteger = VOVSymbol(name: "unsignedDoubleInteger", code: 0x75636f6d, type: AppleEvents.typeType) // "ucom"
    public static let unsignedInteger = VOVSymbol(name: "unsignedInteger", code: 0x6d61676e, type: AppleEvents.typeType) // "magn"
    public static let unsignedShortInteger = VOVSymbol(name: "unsignedShortInteger", code: 0x75736872, type: AppleEvents.typeType) // "ushr"
    public static let UTF16Text = VOVSymbol(name: "UTF16Text", code: 0x75743136, type: AppleEvents.typeType) // "ut16"
    public static let UTF8Text = VOVSymbol(name: "UTF8Text", code: 0x75746638, type: AppleEvents.typeType) // "utf8"
    public static let version = VOVSymbol(name: "version", code: 0x76657273, type: AppleEvents.typeType) // "vers"
    public static let voCursor = VOVSymbol(name: "voCursor", code: 0x766f6375, type: AppleEvents.typeType) // "vocu"
    public static let voCursorObject = VOVSymbol(name: "voCursorObject", code: 0x766f634f, type: AppleEvents.typeType) // "vocO"
    public static let Wednesday = VOVSymbol(name: "Wednesday", code: 0x77656420, type: AppleEvents.typeType) // "wed "
    public static let writingCode = VOVSymbol(name: "writingCode", code: 0x70736374, type: AppleEvents.typeType) // "psct"

    // Enumerators
    public static let alphabeticSpelling = VOVSymbol(name: "alphabeticSpelling", code: 0x616c7053, type: AppleEvents.typeEnumerated) // "alpS"
    public static let announcementHistory = VOVSymbol(name: "announcementHistory", code: 0x616e6e48, type: AppleEvents.typeEnumerated) // "annH"
    public static let applicationsMenu = VOVSymbol(name: "applicationsMenu", code: 0x61707073, type: AppleEvents.typeEnumerated) // "apps"
    public static let ask = VOVSymbol(name: "ask", code: 0x61736b20, type: AppleEvents.typeEnumerated) // "ask "
    public static let case_ = VOVSymbol(name: "case_", code: 0x63617365, type: AppleEvents.typeEnumerated) // "case"
    public static let commandsMenu = VOVSymbol(name: "commandsMenu", code: 0x636d6473, type: AppleEvents.typeEnumerated) // "cmds"
    public static let contextualMenu = VOVSymbol(name: "contextualMenu", code: 0x6374786d, type: AppleEvents.typeEnumerated) // "ctxm"
    public static let desktop = VOVSymbol(name: "desktop", code: 0x64657356, type: AppleEvents.typeEnumerated) // "desV"
    public static let diacriticals = VOVSymbol(name: "diacriticals", code: 0x64696163, type: AppleEvents.typeEnumerated) // "diac"
    public static let dock = VOVSymbol(name: "dock", code: 0x646f6356, type: AppleEvents.typeEnumerated) // "docV"
    public static let down = VOVSymbol(name: "down", code: 0x646f7756, type: AppleEvents.typeEnumerated) // "dowV"
    public static let expansion = VOVSymbol(name: "expansion", code: 0x65787061, type: AppleEvents.typeEnumerated) // "expa"
    public static let firstItem = VOVSymbol(name: "firstItem", code: 0x46697256, type: AppleEvents.typeEnumerated) // "FirV"
    public static let helpMenu = VOVSymbol(name: "helpMenu", code: 0x68656c70, type: AppleEvents.typeEnumerated) // "help"
    public static let hyphens = VOVSymbol(name: "hyphens", code: 0x68797068, type: AppleEvents.typeEnumerated) // "hyph"
    public static let intoItem = VOVSymbol(name: "intoItem", code: 0x696e2056, type: AppleEvents.typeEnumerated) // "in V"
    public static let itemChooser = VOVSymbol(name: "itemChooser", code: 0x6974656d, type: AppleEvents.typeEnumerated) // "item"
    public static let lastItem = VOVSymbol(name: "lastItem", code: 0x4c617356, type: AppleEvents.typeEnumerated) // "LasV"
    public static let left = VOVSymbol(name: "left", code: 0x6c656656, type: AppleEvents.typeEnumerated) // "lefV"
    public static let leftButton = VOVSymbol(name: "leftButton", code: 0x6c656674, type: AppleEvents.typeEnumerated) // "left"
    public static let linkedItem = VOVSymbol(name: "linkedItem", code: 0x6c696e56, type: AppleEvents.typeEnumerated) // "linV"
    public static let menubar = VOVSymbol(name: "menubar", code: 0x6d656e56, type: AppleEvents.typeEnumerated) // "menV"
    public static let menuExtras = VOVSymbol(name: "menuExtras", code: 0x6d656556, type: AppleEvents.typeEnumerated) // "meeV"
    public static let mouseSummary = VOVSymbol(name: "mouseSummary", code: 0x6d6f7355, type: AppleEvents.typeEnumerated) // "mosU"
    public static let no = VOVSymbol(name: "no", code: 0x6e6f2020, type: AppleEvents.typeEnumerated) // "no  "
    public static let numericStrings = VOVSymbol(name: "numericStrings", code: 0x6e756d65, type: AppleEvents.typeEnumerated) // "nume"
    public static let once = VOVSymbol(name: "once", code: 0x6f6e6365, type: AppleEvents.typeEnumerated) // "once"
    public static let outOfItem = VOVSymbol(name: "outOfItem", code: 0x6f757456, type: AppleEvents.typeEnumerated) // "outV"
    public static let phoneticSpelling = VOVSymbol(name: "phoneticSpelling", code: 0x70686f53, type: AppleEvents.typeEnumerated) // "phoS"
    public static let punctuation = VOVSymbol(name: "punctuation", code: 0x70756e63, type: AppleEvents.typeEnumerated) // "punc"
    public static let quickstart = VOVSymbol(name: "quickstart", code: 0x7175696b, type: AppleEvents.typeEnumerated) // "quik"
    public static let right = VOVSymbol(name: "right", code: 0x72696756, type: AppleEvents.typeEnumerated) // "rigV"
    public static let rightButton = VOVSymbol(name: "rightButton", code: 0x72696768, type: AppleEvents.typeEnumerated) // "righ"
    public static let spotlight = VOVSymbol(name: "spotlight", code: 0x73706f56, type: AppleEvents.typeEnumerated) // "spoV"
    public static let thrice = VOVSymbol(name: "thrice", code: 0x74687269, type: AppleEvents.typeEnumerated) // "thri"
    public static let twice = VOVSymbol(name: "twice", code: 0x74776963, type: AppleEvents.typeEnumerated) // "twic"
    public static let up = VOVSymbol(name: "up", code: 0x75702056, type: AppleEvents.typeEnumerated) // "up V"
    public static let utility = VOVSymbol(name: "utility", code: 0x7574696c, type: AppleEvents.typeEnumerated) // "util"
    public static let VoiceOverHelp = VOVSymbol(name: "VoiceOverHelp", code: 0x7668656c, type: AppleEvents.typeEnumerated) // "vhel"
    public static let webMenu = VOVSymbol(name: "webMenu", code: 0x7765626d, type: AppleEvents.typeEnumerated) // "webm"
    public static let webOverview = VOVSymbol(name: "webOverview", code: 0x7765624f, type: AppleEvents.typeEnumerated) // "webO"
    public static let whitespace = VOVSymbol(name: "whitespace", code: 0x77686974, type: AppleEvents.typeEnumerated) // "whit"
    public static let windowOverview = VOVSymbol(name: "windowOverview", code: 0x77696e4f, type: AppleEvents.typeEnumerated) // "winO"
    public static let windowsMenu = VOVSymbol(name: "windowsMenu", code: 0x77696e64, type: AppleEvents.typeEnumerated) // "wind"
    public static let workspaceOverview = VOVSymbol(name: "workspaceOverview", code: 0x776f7253, type: AppleEvents.typeEnumerated) // "worS"
    public static let yes = VOVSymbol(name: "yes", code: 0x79657320, type: AppleEvents.typeEnumerated) // "yes "
}
...
extension VOVCommand {
    ...
    @discardableResult public func click(_ directParameter: Any = SwiftAutomation.noParameter,
            ...
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "click", event: 0x564f4153_636c696b, // "VOASclik"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
    ...
    @discardableResult public func closeMenu(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "closeMenu", event: 0x564f4153_636c6f73, // "VOASclos"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func copyToPasteboard(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "copyToPasteboard", event: 0x564f4153_636f7079, // "VOAScopy"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func grabScreenshot(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "grabScreenshot", event: 0x564f4153_73686f74, // "VOASshot"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func open_(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "open_", event: 0x564f4153_6f70656e, // "VOASopen"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func output(_ directParameter: Any = SwiftAutomation.noParameter,
            ...
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "output", event: 0x564f4153_6f757470, // "VOASoutp"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                    ("with", 0x77697468, with), // "with"
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    ...
    @discardableResult public func performAction(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "performAction", event: 0x564f4153_70657261, // "VOASpera"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func performCommand(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "performCommand", event: 0x564f4153_70657243, // "VOASperC"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func press(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "press", event: 0x564f4153_70726573, // "VOASpres"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func release(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "release", event: 0x564f4153_72656c65, // "VOASrele"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func save(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "save", event: 0x564f4153_73617665, // "VOASsave"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func select(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "select", event: 0x564f4153_73656c65, // "VOASsele"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
...
extension VOVObject {
    ...
    public var id: VOVItem {return self.property(0x49442020) as! VOVItem} // "ID  "

...
public class FINSymbol: SwiftAutomation.Symbol {
    ...
    public override class func symbol(code: OSType, type: OSType = AppleEvents.typeType, descriptor: ScalarDescriptor? = nil) -> FINSymbol {
        switch (code) {
    ...
    // Types/properties
    public static let acceptsHighLevelEvents = FINSymbol(name: "acceptsHighLevelEvents", code: 0x69736162, type: AppleEvents.typeType) // "isab"
    public static let acceptsRemoteEvents = FINSymbol(name: "acceptsRemoteEvents", code: 0x72657674, type: AppleEvents.typeType) // "revt"
    public static let alias = FINSymbol(name: "alias", code: 0x616c6973, type: AppleEvents.typeType) // "alis"
    public static let aliasFile = FINSymbol(name: "aliasFile", code: 0x616c6961, type: AppleEvents.typeType) // "alia"
    public static let aliasList = FINSymbol(name: "aliasList", code: 0x616c7374, type: AppleEvents.typeType) // "alst"
    public static let allNameExtensionsShowing = FINSymbol(name: "allNameExtensionsShowing", code: 0x70736e78, type: AppleEvents.typeType) // "psnx"
    public static let anything = FINSymbol(name: "anything", code: 0x2a2a2a2a, type: AppleEvents.typeType) // "****"
    public static let application = FINSymbol(name: "application", code: 0x63617070, type: AppleEvents.typeType) // "capp"
    public static let applicationBundleID = FINSymbol(name: "applicationBundleID", code: 0x62756e64, type: AppleEvents.typeType) // "bund"
    public static let applicationFile = FINSymbol(name: "applicationFile", code: 0x61707066, type: AppleEvents.typeType) // "appf"
    ...
    public static let bookmarkData = FINSymbol(name: "bookmarkData", code: 0x626d726b, type: AppleEvents.typeType) // "bmrk"
    public static let boolean = FINSymbol(name: "boolean", code: 0x626f6f6c, type: AppleEvents.typeType) // "bool"
    public static let boundingRectangle = FINSymbol(name: "boundingRectangle", code: 0x71647274, type: AppleEvents.typeType) // "qdrt"
    public static let bounds = FINSymbol(name: "bounds", code: 0x70626e64, type: AppleEvents.typeType) // "pbnd"
    public static let calculatesFolderSizes = FINSymbol(name: "calculatesFolderSizes", code: 0x7366737a, type: AppleEvents.typeType) // "sfsz"
    public static let capacity = FINSymbol(name: "capacity", code: 0x63617061, type: AppleEvents.typeType) // "capa"
    public static let class_ = FINSymbol(name: "class_", code: 0x70636c73, type: AppleEvents.typeType) // "pcls"
    public static let clipboard = FINSymbol(name: "clipboard", code: 0x70636c69, type: AppleEvents.typeType) // "pcli"
    public static let clipping = FINSymbol(name: "clipping", code: 0x636c7066, type: AppleEvents.typeType) // "clpf"
    public static let clippingWindow = FINSymbol(name: "clippingWindow", code: 0x6c776e64, type: AppleEvents.typeType) // "lwnd"
    public static let closeable = FINSymbol(name: "closeable", code: 0x68636c62, type: AppleEvents.typeType) // "hclb"
    public static let collapsed = FINSymbol(name: "collapsed", code: 0x77736864, type: AppleEvents.typeType) // "wshd"
    public static let color = FINSymbol(name: "color", code: 0x636f6c72, type: AppleEvents.typeType) // "colr"
    public static let colorTable = FINSymbol(name: "colorTable", code: 0x636c7274, type: AppleEvents.typeType) // "clrt"
    public static let column = FINSymbol(name: "column", code: 0x6c76636c, type: AppleEvents.typeType) // "lvcl"
    public static let columnViewOptions = FINSymbol(name: "columnViewOptions", code: 0x63766f70, type: AppleEvents.typeType) // "cvop"
    public static let completelyExpanded = FINSymbol(name: "completelyExpanded", code: 0x70657863, type: AppleEvents.typeType) // "pexc"
    public static let computerContainer = FINSymbol(name: "computerContainer", code: 0x70636d70, type: AppleEvents.typeType) // "pcmp"
    public static let computerObject = FINSymbol(name: "computerObject", code: 0x63636d70, type: AppleEvents.typeType) // "ccmp"
    public static let constant = FINSymbol(name: "constant", code: 0x656e756d, type: AppleEvents.typeType) // "enum"
    public static let container = FINSymbol(name: "container", code: 0x63746e72, type: AppleEvents.typeType) // "ctnr"
    public static let containerWindow = FINSymbol(name: "containerWindow", code: 0x63776e64, type: AppleEvents.typeType) // "cwnd"
    public static let creatorType = FINSymbol(name: "creatorType", code: 0x66637274, type: AppleEvents.typeType) // "fcrt"
    public static let currentPanel = FINSymbol(name: "currentPanel", code: 0x70616e6c, type: AppleEvents.typeType) // "panl"
    ...
    public static let deskAccessoryFile = FINSymbol(name: "deskAccessoryFile", code: 0x64616669, type: AppleEvents.typeType) // "dafi"
    public static let deskAccessoryProcess = FINSymbol(name: "deskAccessoryProcess", code: 0x70636461, type: AppleEvents.typeType) // "pcda"
    public static let desktop = FINSymbol(name: "desktop", code: 0x6465736b, type: AppleEvents.typeType) // "desk"
    public static let desktopObject = FINSymbol(name: "desktopObject", code: 0x6364736b, type: AppleEvents.typeType) // "cdsk"
    public static let desktopPicture = FINSymbol(name: "desktopPicture", code: 0x64706963, type: AppleEvents.typeType) // "dpic"
    public static let desktopPosition = FINSymbol(name: "desktopPosition", code: 0x64706f73, type: AppleEvents.typeType) // "dpos"
    public static let desktopShowsConnectedServers = FINSymbol(name: "desktopShowsConnectedServers", code: 0x70647376, type: AppleEvents.typeType) // "pdsv"
    public static let desktopShowsExternalHardDisks = FINSymbol(name: "desktopShowsExternalHardDisks", code: 0x70656864, type: AppleEvents.typeType) // "pehd"
    public static let desktopShowsHardDisks = FINSymbol(name: "desktopShowsHardDisks", code: 0x70646864, type: AppleEvents.typeType) // "pdhd"
    public static let desktopShowsRemovableMedia = FINSymbol(name: "desktopShowsRemovableMedia", code: 0x7064726d, type: AppleEvents.typeType) // "pdrm"
    public static let desktopWindow = FINSymbol(name: "desktopWindow", code: 0x646b7477, type: AppleEvents.typeType) // "dktw"
    public static let disclosesPreviewPane = FINSymbol(name: "disclosesPreviewPane", code: 0x64737072, type: AppleEvents.typeType) // "dspr"
    public static let disk = FINSymbol(name: "disk", code: 0x63646973, type: AppleEvents.typeType) // "cdis"
    public static let displayedName = FINSymbol(name: "displayedName", code: 0x646e616d, type: AppleEvents.typeType) // "dnam"
    public static let documentFile = FINSymbol(name: "documentFile", code: 0x646f6366, type: AppleEvents.typeType) // "docf"
    public static let doubleInteger = FINSymbol(name: "doubleInteger", code: 0x636f6d70, type: AppleEvents.typeType) // "comp"
    ...
    public static let fileURL = FINSymbol(name: "fileURL", code: 0x6675726c, type: AppleEvents.typeType) // "furl"
    public static let FinderPreferences = FINSymbol(name: "FinderPreferences", code: 0x70667270, type: AppleEvents.typeType) // "pfrp"
    public static let FinderWindow = FINSymbol(name: "FinderWindow", code: 0x62726f77, type: AppleEvents.typeType) // "brow"
    public static let fixed = FINSymbol(name: "fixed", code: 0x66697864, type: AppleEvents.typeType) // "fixd"
    public static let fixedPoint = FINSymbol(name: "fixedPoint", code: 0x66706e74, type: AppleEvents.typeType) // "fpnt"
    public static let fixedRectangle = FINSymbol(name: "fixedRectangle", code: 0x66726374, type: AppleEvents.typeType) // "frct"
    public static let floating = FINSymbol(name: "floating", code: 0x6973666c, type: AppleEvents.typeType) // "isfl"
    public static let folder = FINSymbol(name: "folder", code: 0x63666f6c, type: AppleEvents.typeType) // "cfol"
    public static let foldersOpenInNewTabs = FINSymbol(name: "foldersOpenInNewTabs", code: 0x706f6e74, type: AppleEvents.typeType) // "pont"
    public static let foldersOpenInNewWindows = FINSymbol(name: "foldersOpenInNewWindows", code: 0x706f6e77, type: AppleEvents.typeType) // "ponw"
    ...
    public static let group = FINSymbol(name: "group", code: 0x73677270, type: AppleEvents.typeType) // "sgrp"
    public static let groupPrivileges = FINSymbol(name: "groupPrivileges", code: 0x67707072, type: AppleEvents.typeType) // "gppr"
    public static let hasScriptingTerminology = FINSymbol(name: "hasScriptingTerminology", code: 0x68736372, type: AppleEvents.typeType) // "hscr"
    public static let home = FINSymbol(name: "home", code: 0x686f6d65, type: AppleEvents.typeType) // "home"
    public static let icl4 = FINSymbol(name: "icl4", code: 0x69636c34, type: AppleEvents.typeType) // "icl4"
    public static let icl8 = FINSymbol(name: "icl8", code: 0x69636c38, type: AppleEvents.typeType) // "icl8"
    public static let ICN_U0023_ = FINSymbol(name: "ICN_U0023_", code: 0x49434e23, type: AppleEvents.typeType) // "ICN#"
    public static let icon = FINSymbol(name: "icon", code: 0x69696d67, type: AppleEvents.typeType) // "iimg"
    public static let iconFamily = FINSymbol(name: "iconFamily", code: 0x6966616d, type: AppleEvents.typeType) // "ifam"
    public static let iconSize = FINSymbol(name: "iconSize", code: 0x6c766973, type: AppleEvents.typeType) // "lvis"
    public static let iconViewOptions = FINSymbol(name: "iconViewOptions", code: 0x69636f70, type: AppleEvents.typeType) // "icop"
    ...
    public static let informationWindow = FINSymbol(name: "informationWindow", code: 0x69776e64, type: AppleEvents.typeType) // "iwnd"
    public static let insertionLocation = FINSymbol(name: "insertionLocation", code: 0x70696e73, type: AppleEvents.typeType) // "pins"
    public static let integer = FINSymbol(name: "integer", code: 0x6c6f6e67, type: AppleEvents.typeType) // "long"
    public static let internationalText = FINSymbol(name: "internationalText", code: 0x69747874, type: AppleEvents.typeType) // "itxt"
    public static let internationalWritingCode = FINSymbol(name: "internationalWritingCode", code: 0x696e746c, type: AppleEvents.typeType) // "intl"
    ...
    public static let labelPosition = FINSymbol(name: "labelPosition", code: 0x6c706f73, type: AppleEvents.typeType) // "lpos"
    public static let large32BitIcon = FINSymbol(name: "large32BitIcon", code: 0x696c3332, type: AppleEvents.typeType) // "il32"
    public static let large4BitIcon = FINSymbol(name: "large4BitIcon", code: 0x69636c34, type: AppleEvents.typeType) // "icl4"
    public static let large8BitIcon = FINSymbol(name: "large8BitIcon", code: 0x69636c38, type: AppleEvents.typeType) // "icl8"
    public static let large8BitMask = FINSymbol(name: "large8BitMask", code: 0x6c386d6b, type: AppleEvents.typeType) // "l8mk"
    public static let largeMonochromeIconAndMask = FINSymbol(name: "largeMonochromeIconAndMask", code: 0x49434e23, type: AppleEvents.typeType) // "ICN#"
    public static let largeReal = FINSymbol(name: "largeReal", code: 0x6c64626c, type: AppleEvents.typeType) // "ldbl"
    public static let list = FINSymbol(name: "list", code: 0x6c697374, type: AppleEvents.typeType) // "list"
    public static let listViewOptions = FINSymbol(name: "listViewOptions", code: 0x6c766f70, type: AppleEvents.typeType) // "lvop"
    public static let localVolume = FINSymbol(name: "localVolume", code: 0x69737276, type: AppleEvents.typeType) // "isrv"
    public static let location = FINSymbol(name: "location", code: 0x696c6f63, type: AppleEvents.typeType) // "iloc"
    public static let locationReference = FINSymbol(name: "locationReference", code: 0x696e736c, type: AppleEvents.typeType) // "insl"
    public static let locked = FINSymbol(name: "locked", code: 0x61736c6b, type: AppleEvents.typeType) // "aslk"
    public static let longFixed = FINSymbol(name: "longFixed", code: 0x6c667864, type: AppleEvents.typeType) // "lfxd"
    public static let longFixedPoint = FINSymbol(name: "longFixedPoint", code: 0x6c667074, type: AppleEvents.typeType) // "lfpt"
    public static let longFixedRectangle = FINSymbol(name: "longFixedRectangle", code: 0x6c667263, type: AppleEvents.typeType) // "lfrc"
    public static let longPoint = FINSymbol(name: "longPoint", code: 0x6c706e74, type: AppleEvents.typeType) // "lpnt"
    public static let longRectangle = FINSymbol(name: "longRectangle", code: 0x6c726374, type: AppleEvents.typeType) // "lrct"
    ...
    public static let ownerPrivileges = FINSymbol(name: "ownerPrivileges", code: 0x6f776e72, type: AppleEvents.typeType) // "ownr"
    public static let package = FINSymbol(name: "package", code: 0x7061636b, type: AppleEvents.typeType) // "pack"
    public static let partitionSpaceUsed = FINSymbol(name: "partitionSpaceUsed", code: 0x70757364, type: AppleEvents.typeType) // "pusd"
    public static let physicalSize = FINSymbol(name: "physicalSize", code: 0x70687973, type: AppleEvents.typeType) // "phys"
    public static let PICTPicture = FINSymbol(name: "PICTPicture", code: 0x50494354, type: AppleEvents.typeType) // "PICT"
    public static let pixelMapRecord = FINSymbol(name: "pixelMapRecord", code: 0x74706d6d, type: AppleEvents.typeType) // "tpmm"
    public static let point = FINSymbol(name: "point", code: 0x51447074, type: AppleEvents.typeType) // "QDpt"
    public static let position = FINSymbol(name: "position", code: 0x706f736e, type: AppleEvents.typeType) // "posn"
    public static let preferences = FINSymbol(name: "preferences", code: 0x63707266, type: AppleEvents.typeType) // "cprf"
    ...
    public static let showsItemInfo = FINSymbol(name: "showsItemInfo", code: 0x6d6e666f, type: AppleEvents.typeType) // "mnfo"
    public static let showsPreviewColumn = FINSymbol(name: "showsPreviewColumn", code: 0x73687072, type: AppleEvents.typeType) // "shpr"
    public static let sidebarWidth = FINSymbol(name: "sidebarWidth", code: 0x73627769, type: AppleEvents.typeType) // "sbwi"
    public static let small32BitIcon = FINSymbol(name: "small32BitIcon", code: 0x69733332, type: AppleEvents.typeType) // "is32"
    public static let small4BitIcon = FINSymbol(name: "small4BitIcon", code: 0x69637334, type: AppleEvents.typeType) // "ics4"
    public static let small8BitIcon = FINSymbol(name: "small8BitIcon", code: 0x69637338, type: AppleEvents.typeType) // "ics8"
    public static let small8BitMask = FINSymbol(name: "small8BitMask", code: 0x69637338, type: AppleEvents.typeType) // "ics8"
    public static let smallMonochromeIconAndMask = FINSymbol(name: "smallMonochromeIconAndMask", code: 0x69637323, type: AppleEvents.typeType) // "ics#"
    public static let smallReal = FINSymbol(name: "smallReal", code: 0x73696e67, type: AppleEvents.typeType) // "sing"
    public static let sortColumn = FINSymbol(name: "sortColumn", code: 0x73727463, type: AppleEvents.typeType) // "srtc"
    public static let sortDirection = FINSymbol(name: "sortDirection", code: 0x736f7264, type: AppleEvents.typeType) // "sord"
    public static let startup = FINSymbol(name: "startup", code: 0x69737464, type: AppleEvents.typeType) // "istd"
    public static let startupDisk = FINSymbol(name: "startupDisk", code: 0x7364736b, type: AppleEvents.typeType) // "sdsk"
    public static let stationery = FINSymbol(name: "stationery", code: 0x70737064, type: AppleEvents.typeType) // "pspd"
    public static let statusbarVisible = FINSymbol(name: "statusbarVisible", code: 0x73747669, type: AppleEvents.typeType) // "stvi"
    public static let string = FINSymbol(name: "string", code: 0x54455854, type: AppleEvents.typeType) // "TEXT"
    ...
    public static let unsignedInteger = FINSymbol(name: "unsignedInteger", code: 0x6d61676e, type: AppleEvents.typeType) // "magn"
    public static let unsignedShortInteger = FINSymbol(name: "unsignedShortInteger", code: 0x75736872, type: AppleEvents.typeType) // "ushr"
    public static let URL = FINSymbol(name: "URL", code: 0x7055524c, type: AppleEvents.typeType) // "pURL"
    public static let usesRelativeDates = FINSymbol(name: "usesRelativeDates", code: 0x75726474, type: AppleEvents.typeType) // "urdt"
    public static let UTF16Text = FINSymbol(name: "UTF16Text", code: 0x75743136, type: AppleEvents.typeType) // "ut16"
    ...
    public static let zoomable = FINSymbol(name: "zoomable", code: 0x69737a6d, type: AppleEvents.typeType) // "iszm"
    public static let zoomed = FINSymbol(name: "zoomed", code: 0x707a756d, type: AppleEvents.typeType) // "pzum"

    // Enumerators
    public static let AdvancedPreferencesPanel = FINSymbol(name: "AdvancedPreferencesPanel", code: 0x70616476, type: AppleEvents.typeEnumerated) // "padv"
    public static let APFSFormat = FINSymbol(name: "APFSFormat", code: 0x64666170, type: AppleEvents.typeEnumerated) // "dfap"
    public static let ApplePhotoFormat = FINSymbol(name: "ApplePhotoFormat", code: 0x64667068, type: AppleEvents.typeEnumerated) // "dfph"
    public static let AppleShareFormat = FINSymbol(name: "AppleShareFormat", code: 0x64666173, type: AppleEvents.typeEnumerated) // "dfas"
    public static let ApplicationPanel = FINSymbol(name: "ApplicationPanel", code: 0x61706e6c, type: AppleEvents.typeEnumerated) // "apnl"
    public static let arrangedByCreationDate = FINSymbol(name: "arrangedByCreationDate", code: 0x63647461, type: AppleEvents.typeEnumerated) // "cdta"
    public static let arrangedByKind = FINSymbol(name: "arrangedByKind", code: 0x6b696e61, type: AppleEvents.typeEnumerated) // "kina"
    public static let arrangedByLabel = FINSymbol(name: "arrangedByLabel", code: 0x6c616261, type: AppleEvents.typeEnumerated) // "laba"
    ...
    public static let case_ = FINSymbol(name: "case_", code: 0x63617365, type: AppleEvents.typeEnumerated) // "case"
    public static let columnView = FINSymbol(name: "columnView", code: 0x636c7677, type: AppleEvents.typeEnumerated) // "clvw"
    public static let comment = FINSymbol(name: "comment", code: 0x636f6d74, type: AppleEvents.typeEnumerated) // "comt"
    public static let commentColumn = FINSymbol(name: "commentColumn", code: 0x656c7343, type: AppleEvents.typeEnumerated) // "elsC"
    public static let CommentsPanel = FINSymbol(name: "CommentsPanel", code: 0x63706e6c, type: AppleEvents.typeEnumerated) // "cpnl"
    public static let ContentIndexPanel = FINSymbol(name: "ContentIndexPanel", code: 0x63696e6c, type: AppleEvents.typeEnumerated) // "cinl"
    public static let creationDate = FINSymbol(name: "creationDate", code: 0x61736364, type: AppleEvents.typeEnumerated) // "ascd"
    public static let creationDateColumn = FINSymbol(name: "creationDateColumn", code: 0x656c7363, type: AppleEvents.typeEnumerated) // "elsc"
    public static let diacriticals = FINSymbol(name: "diacriticals", code: 0x64696163, type: AppleEvents.typeEnumerated) // "diac"
    public static let ExFATFormat = FINSymbol(name: "ExFATFormat", code: 0x64667866, type: AppleEvents.typeEnumerated) // "dfxf"
    public static let expansion = FINSymbol(name: "expansion", code: 0x65787061, type: AppleEvents.typeEnumerated) // "expa"
    public static let flowView = FINSymbol(name: "flowView", code: 0x666c7677, type: AppleEvents.typeEnumerated) // "flvw"
    public static let FTPFormat = FINSymbol(name: "FTPFormat", code: 0x64666674, type: AppleEvents.typeEnumerated) // "dfft"
    public static let GeneralInformationPanel = FINSymbol(name: "GeneralInformationPanel", code: 0x67706e6c, type: AppleEvents.typeEnumerated) // "gpnl"
    public static let GeneralPreferencesPanel = FINSymbol(name: "GeneralPreferencesPanel", code: 0x70676e70, type: AppleEvents.typeEnumerated) // "pgnp"
    public static let groupView = FINSymbol(name: "groupView", code: 0x666c7677, type: AppleEvents.typeEnumerated) // "flvw"
    public static let HighSierraFormat = FINSymbol(name: "HighSierraFormat", code: 0x64666873, type: AppleEvents.typeEnumerated) // "dfhs"
    public static let hyphens = FINSymbol(name: "hyphens", code: 0x68797068, type: AppleEvents.typeEnumerated) // "hyph"
    public static let iconView = FINSymbol(name: "iconView", code: 0x69636e76, type: AppleEvents.typeEnumerated) // "icnv"
    public static let ISO9660Format = FINSymbol(name: "ISO9660Format", code: 0x64663936, type: AppleEvents.typeEnumerated) // "df96"
    public static let kind = FINSymbol(name: "kind", code: 0x6b696e64, type: AppleEvents.typeEnumerated) // "kind"
    public static let kindColumn = FINSymbol(name: "kindColumn", code: 0x656c736b, type: AppleEvents.typeEnumerated) // "elsk"
    public static let labelColumn = FINSymbol(name: "labelColumn", code: 0x656c736c, type: AppleEvents.typeEnumerated) // "elsl"
    public static let labelIndex = FINSymbol(name: "labelIndex", code: 0x6c616269, type: AppleEvents.typeEnumerated) // "labi"
    public static let LabelPreferencesPanel = FINSymbol(name: "LabelPreferencesPanel", code: 0x706c6270, type: AppleEvents.typeEnumerated) // "plbp"
    public static let LanguagesPanel = FINSymbol(name: "LanguagesPanel", code: 0x706b6c67, type: AppleEvents.typeEnumerated) // "pklg"
    public static let large = FINSymbol(name: "large", code: 0x6c676963, type: AppleEvents.typeEnumerated) // "lgic"
    public static let largeIcon = FINSymbol(name: "largeIcon", code: 0x6c676963, type: AppleEvents.typeEnumerated) // "lgic"
    public static let listView = FINSymbol(name: "listView", code: 0x6c737677, type: AppleEvents.typeEnumerated) // "lsvw"
    public static let MacOSExtendedFormat = FINSymbol(name: "MacOSExtendedFormat", code: 0x6466682b, type: AppleEvents.typeEnumerated) // "dfh+"
    public static let MacOSFormat = FINSymbol(name: "MacOSFormat", code: 0x64666866, type: AppleEvents.typeEnumerated) // "dfhf"
    public static let MemoryPanel = FINSymbol(name: "MemoryPanel", code: 0x6d706e6c, type: AppleEvents.typeEnumerated) // "mpnl"
    public static let mini = FINSymbol(name: "mini", code: 0x6d696963, type: AppleEvents.typeEnumerated) // "miic"
    public static let modificationDate = FINSymbol(name: "modificationDate", code: 0x61736d6f, type: AppleEvents.typeEnumerated) // "asmo"
    public static let modificationDateColumn = FINSymbol(name: "modificationDateColumn", code: 0x656c736d, type: AppleEvents.typeEnumerated) // "elsm"
    public static let MoreInfoPanel = FINSymbol(name: "MoreInfoPanel", code: 0x6d696e6c, type: AppleEvents.typeEnumerated) // "minl"
    public static let MSDOSFormat = FINSymbol(name: "MSDOSFormat", code: 0x64666d73, type: AppleEvents.typeEnumerated) // "dfms"
    public static let name = FINSymbol(name: "name", code: 0x706e616d, type: AppleEvents.typeEnumerated) // "pnam"
    ...
    public static let NTFSFormat = FINSymbol(name: "NTFSFormat", code: 0x64666e74, type: AppleEvents.typeEnumerated) // "dfnt"
    public static let numericStrings = FINSymbol(name: "numericStrings", code: 0x6e756d65, type: AppleEvents.typeEnumerated) // "nume"
    public static let PacketWrittenUDFFormat = FINSymbol(name: "PacketWrittenUDFFormat", code: 0x64667075, type: AppleEvents.typeEnumerated) // "dfpu"
    public static let PluginsPanel = FINSymbol(name: "PluginsPanel", code: 0x706b7067, type: AppleEvents.typeEnumerated) // "pkpg"
    public static let PreviewPanel = FINSymbol(name: "PreviewPanel", code: 0x76706e6c, type: AppleEvents.typeEnumerated) // "vpnl"
    public static let ProDOSFormat = FINSymbol(name: "ProDOSFormat", code: 0x64667072, type: AppleEvents.typeEnumerated) // "dfpr"
    public static let punctuation = FINSymbol(name: "punctuation", code: 0x70756e63, type: AppleEvents.typeEnumerated) // "punc"
    public static let QuickTakeFormat = FINSymbol(name: "QuickTakeFormat", code: 0x64667174, type: AppleEvents.typeEnumerated) // "dfqt"
    public static let readOnly = FINSymbol(name: "readOnly", code: 0x72656164, type: AppleEvents.typeEnumerated) // "read"
    public static let readWrite = FINSymbol(name: "readWrite", code: 0x72647772, type: AppleEvents.typeEnumerated) // "rdwr"
    public static let reversed = FINSymbol(name: "reversed", code: 0x73727673, type: AppleEvents.typeEnumerated) // "srvs"
    public static let right = FINSymbol(name: "right", code: 0x6c726774, type: AppleEvents.typeEnumerated) // "lrgt"
    public static let SharingPanel = FINSymbol(name: "SharingPanel", code: 0x73706e6c, type: AppleEvents.typeEnumerated) // "spnl"
    public static let SidebarPreferencesPanel = FINSymbol(name: "SidebarPreferencesPanel", code: 0x70736964, type: AppleEvents.typeEnumerated) // "psid"
    public static let SimpleHeaderPanel = FINSymbol(name: "SimpleHeaderPanel", code: 0x73686e6c, type: AppleEvents.typeEnumerated) // "shnl"
    public static let size = FINSymbol(name: "size", code: 0x70687973, type: AppleEvents.typeEnumerated) // "phys"
    public static let sizeColumn = FINSymbol(name: "sizeColumn", code: 0x656c7373, type: AppleEvents.typeEnumerated) // "elss"
    public static let small = FINSymbol(name: "small", code: 0x736d6963, type: AppleEvents.typeEnumerated) // "smic"
    public static let smallIcon = FINSymbol(name: "smallIcon", code: 0x736d6963, type: AppleEvents.typeEnumerated) // "smic"
    public static let SMBFormat = FINSymbol(name: "SMBFormat", code: 0x6466736d, type: AppleEvents.typeEnumerated) // "dfsm"
    public static let snapToGrid = FINSymbol(name: "snapToGrid", code: 0x67726461, type: AppleEvents.typeEnumerated) // "grda"
    public static let UDFFormat = FINSymbol(name: "UDFFormat", code: 0x64667564, type: AppleEvents.typeEnumerated) // "dfud"
    public static let UFSFormat = FINSymbol(name: "UFSFormat", code: 0x64667566, type: AppleEvents.typeEnumerated) // "dfuf"
    public static let unknownFormat = FINSymbol(name: "unknownFormat", code: 0x64663f3f, type: AppleEvents.typeEnumerated) // "df??"
    public static let version = FINSymbol(name: "version", code: 0x76657273, type: AppleEvents.typeEnumerated) // "vers"
    public static let versionColumn = FINSymbol(name: "versionColumn", code: 0x656c7376, type: AppleEvents.typeEnumerated) // "elsv"
    public static let WebDAVFormat = FINSymbol(name: "WebDAVFormat", code: 0x64667764, type: AppleEvents.typeEnumerated) // "dfwd"

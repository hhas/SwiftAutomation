...
private let _specifierFormatter = SwiftAutomation.SpecifierFormatter(
        ...
        elementsNames: [
                0x66626166: ("AllFontsLibraryObject", "AllFontsLibraryObjects"), // "fbaf"
                0x63617070: ("application", "applications"), // "capp"
                0x636f6c72: ("color", "colors"), // "colr"
                0x646f6375: ("document", "documents"), // "docu"
                0x6662636c: ("fontCollection", "fontCollections"), // "fbcl"
                0x66626374: ("fontContainer", "fontContainers"), // "fbct"
                0x6662646f: ("fontDomain", "fontDomains"), // "fbdo"
                0x6662666d: ("fontFamily", "fontFamilies"), // "fbfm"
                0x66626c72: ("fontLibrary", "fontLibraries"), // "fblr"
                0x636f626a: ("item", "items"), // "cobj"
                0x66626d66: ("MyFontsLibrary", "MyFontsFontLibraries"), // "fbmf"
                0x66626663: ("typeface", "typefaces"), // "fbfc"
                0x6377696e: ("window", "windows"), // "cwin"
        ])

private let _glueClasses = SwiftAutomation.GlueClasses(
                                                insertionSpecifierType: FBOInsertion.self,
...
public class FBOSymbol: SwiftAutomation.Symbol {
    ...
    public override class func symbol(code: OSType, type: OSType = AppleEvents.typeType, descriptor: ScalarDescriptor? = nil) -> FBOSymbol {
        switch (code) {
        ...
        case 0x49442020: return self.ID_ // "ID  "
    ...
    // Types/properties
    public static let alias = FBOSymbol(name: "alias", code: 0x616c6973, type: AppleEvents.typeType) // "alis"
    public static let AllFontsLibraryObject = FBOSymbol(name: "AllFontsLibraryObject", code: 0x66626166, type: AppleEvents.typeType) // "fbaf"
    public static let anything = FBOSymbol(name: "anything", code: 0x2a2a2a2a, type: AppleEvents.typeType) // "****"
    public static let application = FBOSymbol(name: "application", code: 0x63617070, type: AppleEvents.typeType) // "capp"
    public static let applicationBundleID = FBOSymbol(name: "applicationBundleID", code: 0x62756e64, type: AppleEvents.typeType) // "bund"
    public static let applicationSignature = FBOSymbol(name: "applicationSignature", code: 0x7369676e, type: AppleEvents.typeType) // "sign"
    public static let applicationURL = FBOSymbol(name: "applicationURL", code: 0x6170726c, type: AppleEvents.typeType) // "aprl"
    public static let April = FBOSymbol(name: "April", code: 0x61707220, type: AppleEvents.typeType) // "apr "
    public static let August = FBOSymbol(name: "August", code: 0x61756720, type: AppleEvents.typeType) // "aug "
    public static let best = FBOSymbol(name: "best", code: 0x62657374, type: AppleEvents.typeType) // "best"
    public static let bookmarkData = FBOSymbol(name: "bookmarkData", code: 0x626d726b, type: AppleEvents.typeType) // "bmrk"
    public static let boolean = FBOSymbol(name: "boolean", code: 0x626f6f6c, type: AppleEvents.typeType) // "bool"
    public static let boundingRectangle = FBOSymbol(name: "boundingRectangle", code: 0x71647274, type: AppleEvents.typeType) // "qdrt"
    public static let bounds = FBOSymbol(name: "bounds", code: 0x70626e64, type: AppleEvents.typeType) // "pbnd"
    public static let class_ = FBOSymbol(name: "class_", code: 0x70636c73, type: AppleEvents.typeType) // "pcls"
    public static let closeable = FBOSymbol(name: "closeable", code: 0x68636c62, type: AppleEvents.typeType) // "hclb"
    public static let color = FBOSymbol(name: "color", code: 0x636f6c72, type: AppleEvents.typeType) // "colr"
    public static let colorTable = FBOSymbol(name: "colorTable", code: 0x636c7274, type: AppleEvents.typeType) // "clrt"
    public static let constant = FBOSymbol(name: "constant", code: 0x656e756d, type: AppleEvents.typeType) // "enum"
    public static let copyright = FBOSymbol(name: "copyright", code: 0x66626372, type: AppleEvents.typeType) // "fbcr"
    public static let dashStyle = FBOSymbol(name: "dashStyle", code: 0x74646173, type: AppleEvents.typeType) // "tdas"
    public static let data = FBOSymbol(name: "data", code: 0x74647461, type: AppleEvents.typeType) // "tdta"
    public static let date = FBOSymbol(name: "date", code: 0x6c647420, type: AppleEvents.typeType) // "ldt "
    public static let December = FBOSymbol(name: "December", code: 0x64656320, type: AppleEvents.typeType) // "dec "
    public static let decimalStruct = FBOSymbol(name: "decimalStruct", code: 0x6465636d, type: AppleEvents.typeType) // "decm"
    public static let displayedName = FBOSymbol(name: "displayedName", code: 0x646e616d, type: AppleEvents.typeType) // "dnam"
    public static let displayName = FBOSymbol(name: "displayName", code: 0x646e616d, type: AppleEvents.typeType) // "dnam"
    public static let document = FBOSymbol(name: "document", code: 0x646f6375, type: AppleEvents.typeType) // "docu"
    public static let domain = FBOSymbol(name: "domain", code: 0x6662646f, type: AppleEvents.typeType) // "fbdo"
    public static let doubleInteger = FBOSymbol(name: "doubleInteger", code: 0x636f6d70, type: AppleEvents.typeType) // "comp"
    public static let duplicated = FBOSymbol(name: "duplicated", code: 0x66626964, type: AppleEvents.typeType) // "fbid"
    public static let enabled = FBOSymbol(name: "enabled", code: 0x6662656e, type: AppleEvents.typeType) // "fben"
    public static let encodedString = FBOSymbol(name: "encodedString", code: 0x656e6373, type: AppleEvents.typeType) // "encs"
    public static let EPSPicture = FBOSymbol(name: "EPSPicture", code: 0x45505320, type: AppleEvents.typeType) // "EPS "
    public static let familyName = FBOSymbol(name: "familyName", code: 0x6662666e, type: AppleEvents.typeType) // "fbfn"
    public static let February = FBOSymbol(name: "February", code: 0x66656220, type: AppleEvents.typeType) // "feb "
    public static let fileRef = FBOSymbol(name: "fileRef", code: 0x66737266, type: AppleEvents.typeType) // "fsrf"
    public static let files = FBOSymbol(name: "files", code: 0x66626673, type: AppleEvents.typeType) // "fbfs"
    public static let fileURL = FBOSymbol(name: "fileURL", code: 0x6675726c, type: AppleEvents.typeType) // "furl"
    public static let fixed = FBOSymbol(name: "fixed", code: 0x66697864, type: AppleEvents.typeType) // "fixd"
    public static let fixedPoint = FBOSymbol(name: "fixedPoint", code: 0x66706e74, type: AppleEvents.typeType) // "fpnt"
    public static let fixedRectangle = FBOSymbol(name: "fixedRectangle", code: 0x66726374, type: AppleEvents.typeType) // "frct"
    public static let floating = FBOSymbol(name: "floating", code: 0x6973666c, type: AppleEvents.typeType) // "isfl"
    public static let fontCollection = FBOSymbol(name: "fontCollection", code: 0x6662636c, type: AppleEvents.typeType) // "fbcl"
    public static let fontContainer = FBOSymbol(name: "fontContainer", code: 0x66626374, type: AppleEvents.typeType) // "fbct"
    public static let fontDomain = FBOSymbol(name: "fontDomain", code: 0x6662646f, type: AppleEvents.typeType) // "fbdo"
    public static let fontFamily = FBOSymbol(name: "fontFamily", code: 0x6662666d, type: AppleEvents.typeType) // "fbfm"
    public static let fontLibrary = FBOSymbol(name: "fontLibrary", code: 0x66626c72, type: AppleEvents.typeType) // "fblr"
    public static let fontsLibrary = FBOSymbol(name: "fontsLibrary", code: 0x66626c62, type: AppleEvents.typeType) // "fblb"
    public static let fontType = FBOSymbol(name: "fontType", code: 0x66626674, type: AppleEvents.typeType) // "fbft"
    public static let Friday = FBOSymbol(name: "Friday", code: 0x66726920, type: AppleEvents.typeType) // "fri "
    public static let frontmost = FBOSymbol(name: "frontmost", code: 0x70697366, type: AppleEvents.typeType) // "pisf"
    public static let GIFPicture = FBOSymbol(name: "GIFPicture", code: 0x47494666, type: AppleEvents.typeType) // "GIFf"
    public static let graphicText = FBOSymbol(name: "graphicText", code: 0x63677478, type: AppleEvents.typeType) // "cgtx"
    public static let id = FBOSymbol(name: "id", code: 0x49442020, type: AppleEvents.typeType) // "ID  "
    public static let ID_ = FBOSymbol(name: "ID_", code: 0x49442020, type: AppleEvents.typeType) // "ID  "
    public static let index = FBOSymbol(name: "index", code: 0x70696478, type: AppleEvents.typeType) // "pidx"
    public static let installationTarget = FBOSymbol(name: "installationTarget", code: 0x66626974, type: AppleEvents.typeType) // "fbit"
    public static let integer = FBOSymbol(name: "integer", code: 0x6c6f6e67, type: AppleEvents.typeType) // "long"
    public static let internationalText = FBOSymbol(name: "internationalText", code: 0x69747874, type: AppleEvents.typeType) // "itxt"
    public static let internationalWritingCode = FBOSymbol(name: "internationalWritingCode", code: 0x696e746c, type: AppleEvents.typeType) // "intl"
    public static let item = FBOSymbol(name: "item", code: 0x636f626a, type: AppleEvents.typeType) // "cobj"
    public static let January = FBOSymbol(name: "January", code: 0x6a616e20, type: AppleEvents.typeType) // "jan "
    public static let JPEGPicture = FBOSymbol(name: "JPEGPicture", code: 0x4a504547, type: AppleEvents.typeType) // "JPEG"
    public static let July = FBOSymbol(name: "July", code: 0x6a756c20, type: AppleEvents.typeType) // "jul "
    public static let June = FBOSymbol(name: "June", code: 0x6a756e20, type: AppleEvents.typeType) // "jun "
    public static let kernelProcessID = FBOSymbol(name: "kernelProcessID", code: 0x6b706964, type: AppleEvents.typeType) // "kpid"
    public static let largeReal = FBOSymbol(name: "largeReal", code: 0x6c64626c, type: AppleEvents.typeType) // "ldbl"
    public static let list = FBOSymbol(name: "list", code: 0x6c697374, type: AppleEvents.typeType) // "list"
    public static let locationReference = FBOSymbol(name: "locationReference", code: 0x696e736c, type: AppleEvents.typeType) // "insl"
    public static let longFixed = FBOSymbol(name: "longFixed", code: 0x6c667864, type: AppleEvents.typeType) // "lfxd"
    public static let longFixedPoint = FBOSymbol(name: "longFixedPoint", code: 0x6c667074, type: AppleEvents.typeType) // "lfpt"
    public static let longFixedRectangle = FBOSymbol(name: "longFixedRectangle", code: 0x6c667263, type: AppleEvents.typeType) // "lfrc"
    public static let longPoint = FBOSymbol(name: "longPoint", code: 0x6c706e74, type: AppleEvents.typeType) // "lpnt"
    public static let longRectangle = FBOSymbol(name: "longRectangle", code: 0x6c726374, type: AppleEvents.typeType) // "lrct"
    public static let machine = FBOSymbol(name: "machine", code: 0x6d616368, type: AppleEvents.typeType) // "mach"
    public static let machineLocation = FBOSymbol(name: "machineLocation", code: 0x6d4c6f63, type: AppleEvents.typeType) // "mLoc"
    public static let machPort = FBOSymbol(name: "machPort", code: 0x706f7274, type: AppleEvents.typeType) // "port"
    public static let March = FBOSymbol(name: "March", code: 0x6d617220, type: AppleEvents.typeType) // "mar "
    public static let May = FBOSymbol(name: "May", code: 0x6d617920, type: AppleEvents.typeType) // "may "
    public static let miniaturizable = FBOSymbol(name: "miniaturizable", code: 0x69736d6e, type: AppleEvents.typeType) // "ismn"
    public static let miniaturized = FBOSymbol(name: "miniaturized", code: 0x706d6e64, type: AppleEvents.typeType) // "pmnd"
    public static let modal = FBOSymbol(name: "modal", code: 0x706d6f64, type: AppleEvents.typeType) // "pmod"
    public static let modified = FBOSymbol(name: "modified", code: 0x696d6f64, type: AppleEvents.typeType) // "imod"
    public static let Monday = FBOSymbol(name: "Monday", code: 0x6d6f6e20, type: AppleEvents.typeType) // "mon "
    public static let MyFontsLibrary = FBOSymbol(name: "MyFontsLibrary", code: 0x66626d66, type: AppleEvents.typeType) // "fbmf"
    public static let name = FBOSymbol(name: "name", code: 0x706e616d, type: AppleEvents.typeType) // "pnam"
    public static let November = FBOSymbol(name: "November", code: 0x6e6f7620, type: AppleEvents.typeType) // "nov "
    public static let null = FBOSymbol(name: "null", code: 0x6e756c6c, type: AppleEvents.typeType) // "null"
    public static let October = FBOSymbol(name: "October", code: 0x6f637420, type: AppleEvents.typeType) // "oct "
    public static let path = FBOSymbol(name: "path", code: 0x70707468, type: AppleEvents.typeType) // "ppth"
    public static let PICTPicture = FBOSymbol(name: "PICTPicture", code: 0x50494354, type: AppleEvents.typeType) // "PICT"
    public static let pixelMapRecord = FBOSymbol(name: "pixelMapRecord", code: 0x74706d6d, type: AppleEvents.typeType) // "tpmm"
    public static let point = FBOSymbol(name: "point", code: 0x51447074, type: AppleEvents.typeType) // "QDpt"
    public static let PostScriptName = FBOSymbol(name: "PostScriptName", code: 0x66627073, type: AppleEvents.typeType) // "fbps"
    public static let processSerialNumber = FBOSymbol(name: "processSerialNumber", code: 0x70736e20, type: AppleEvents.typeType) // "psn "
    public static let properties = FBOSymbol(name: "properties", code: 0x70414c4c, type: AppleEvents.typeType) // "pALL"
    public static let property_ = FBOSymbol(name: "property_", code: 0x70726f70, type: AppleEvents.typeType) // "prop"
    public static let real = FBOSymbol(name: "real", code: 0x646f7562, type: AppleEvents.typeType) // "doub"
    public static let record = FBOSymbol(name: "record", code: 0x7265636f, type: AppleEvents.typeType) // "reco"
    public static let reference = FBOSymbol(name: "reference", code: 0x6f626a20, type: AppleEvents.typeType) // "obj "
    public static let resizable = FBOSymbol(name: "resizable", code: 0x7072737a, type: AppleEvents.typeType) // "prsz"
    public static let RGB16Color = FBOSymbol(name: "RGB16Color", code: 0x74723136, type: AppleEvents.typeType) // "tr16"
    public static let RGB96Color = FBOSymbol(name: "RGB96Color", code: 0x74723936, type: AppleEvents.typeType) // "tr96"
    public static let RGBColor = FBOSymbol(name: "RGBColor", code: 0x63524742, type: AppleEvents.typeType) // "cRGB"
    public static let rotation = FBOSymbol(name: "rotation", code: 0x74726f74, type: AppleEvents.typeType) // "trot"
    public static let Saturday = FBOSymbol(name: "Saturday", code: 0x73617420, type: AppleEvents.typeType) // "sat "
    public static let script = FBOSymbol(name: "script", code: 0x73637074, type: AppleEvents.typeType) // "scpt"
    public static let selectedCollections = FBOSymbol(name: "selectedCollections", code: 0x66626363, type: AppleEvents.typeType) // "fbcc"
    public static let selectedFontFamilies = FBOSymbol(name: "selectedFontFamilies", code: 0x66626666, type: AppleEvents.typeType) // "fbff"
    public static let selection = FBOSymbol(name: "selection", code: 0x73656c63, type: AppleEvents.typeType) // "selc"
    public static let September = FBOSymbol(name: "September", code: 0x73657020, type: AppleEvents.typeType) // "sep "
    public static let shortInteger = FBOSymbol(name: "shortInteger", code: 0x73686f72, type: AppleEvents.typeType) // "shor"
    public static let smallReal = FBOSymbol(name: "smallReal", code: 0x73696e67, type: AppleEvents.typeType) // "sing"
    public static let string = FBOSymbol(name: "string", code: 0x54455854, type: AppleEvents.typeType) // "TEXT"
    public static let styledClipboardText = FBOSymbol(name: "styledClipboardText", code: 0x7374796c, type: AppleEvents.typeType) // "styl"
    public static let styledText = FBOSymbol(name: "styledText", code: 0x53545854, type: AppleEvents.typeType) // "STXT"
    public static let styleName = FBOSymbol(name: "styleName", code: 0x6662736e, type: AppleEvents.typeType) // "fbsn"
    public static let Sunday = FBOSymbol(name: "Sunday", code: 0x73756e20, type: AppleEvents.typeType) // "sun "
    public static let textStyleInfo = FBOSymbol(name: "textStyleInfo", code: 0x74737479, type: AppleEvents.typeType) // "tsty"
    public static let Thursday = FBOSymbol(name: "Thursday", code: 0x74687520, type: AppleEvents.typeType) // "thu "
    public static let TIFFPicture = FBOSymbol(name: "TIFFPicture", code: 0x54494646, type: AppleEvents.typeType) // "TIFF"
    public static let titled = FBOSymbol(name: "titled", code: 0x70746974, type: AppleEvents.typeType) // "ptit"
    public static let Tuesday = FBOSymbol(name: "Tuesday", code: 0x74756520, type: AppleEvents.typeType) // "tue "
    public static let typeClass = FBOSymbol(name: "typeClass", code: 0x74797065, type: AppleEvents.typeType) // "type"
    public static let typeface = FBOSymbol(name: "typeface", code: 0x66626663, type: AppleEvents.typeType) // "fbfc"
    public static let typefaceAdditionalInfo = FBOSymbol(name: "typefaceAdditionalInfo", code: 0x66626173, type: AppleEvents.typeType) // "fbas"
    public static let UnicodeText = FBOSymbol(name: "UnicodeText", code: 0x75747874, type: AppleEvents.typeType) // "utxt"
    public static let unsignedDoubleInteger = FBOSymbol(name: "unsignedDoubleInteger", code: 0x75636f6d, type: AppleEvents.typeType) // "ucom"
    public static let unsignedInteger = FBOSymbol(name: "unsignedInteger", code: 0x6d61676e, type: AppleEvents.typeType) // "magn"
    public static let unsignedShortInteger = FBOSymbol(name: "unsignedShortInteger", code: 0x75736872, type: AppleEvents.typeType) // "ushr"
    public static let UTF16Text = FBOSymbol(name: "UTF16Text", code: 0x75743136, type: AppleEvents.typeType) // "ut16"
    public static let UTF8Text = FBOSymbol(name: "UTF8Text", code: 0x75746638, type: AppleEvents.typeType) // "utf8"
    public static let validateFontsBeforeInstalling = FBOSymbol(name: "validateFontsBeforeInstalling", code: 0x66627666, type: AppleEvents.typeType) // "fbvf"
    public static let version = FBOSymbol(name: "version", code: 0x76657273, type: AppleEvents.typeType) // "vers"
    public static let visible = FBOSymbol(name: "visible", code: 0x70766973, type: AppleEvents.typeType) // "pvis"
    public static let Wednesday = FBOSymbol(name: "Wednesday", code: 0x77656420, type: AppleEvents.typeType) // "wed "
    public static let window = FBOSymbol(name: "window", code: 0x6377696e, type: AppleEvents.typeType) // "cwin"
    public static let writingCode = FBOSymbol(name: "writingCode", code: 0x70736374, type: AppleEvents.typeType) // "psct"
    public static let zoomable = FBOSymbol(name: "zoomable", code: 0x69737a6d, type: AppleEvents.typeType) // "iszm"
    public static let zoomed = FBOSymbol(name: "zoomed", code: 0x707a756d, type: AppleEvents.typeType) // "pzum"

    // Enumerators
    public static let ask = FBOSymbol(name: "ask", code: 0x61736b20, type: AppleEvents.typeEnumerated) // "ask "
    public static let case_ = FBOSymbol(name: "case_", code: 0x63617365, type: AppleEvents.typeEnumerated) // "case"
    public static let diacriticals = FBOSymbol(name: "diacriticals", code: 0x64696163, type: AppleEvents.typeEnumerated) // "diac"
    public static let expansion = FBOSymbol(name: "expansion", code: 0x65787061, type: AppleEvents.typeEnumerated) // "expa"
    public static let hyphens = FBOSymbol(name: "hyphens", code: 0x68797068, type: AppleEvents.typeEnumerated) // "hyph"
    public static let no = FBOSymbol(name: "no", code: 0x6e6f2020, type: AppleEvents.typeEnumerated) // "no  "
    public static let numericStrings = FBOSymbol(name: "numericStrings", code: 0x6e756d65, type: AppleEvents.typeEnumerated) // "nume"
    public static let punctuation = FBOSymbol(name: "punctuation", code: 0x70756e63, type: AppleEvents.typeEnumerated) // "punc"
    public static let whitespace = FBOSymbol(name: "whitespace", code: 0x77686974, type: AppleEvents.typeEnumerated) // "whit"
    public static let yes = FBOSymbol(name: "yes", code: 0x79657320, type: AppleEvents.typeEnumerated) // "yes "
}
...
extension FBOCommand {
    ...
    @discardableResult public func add(_ directParameter: Any = SwiftAutomation.noParameter,
            ...
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "add", event: 0x66626f6b_66626164, // "fbokfbad"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
    ...
    @discardableResult public func export(_ directParameter: Any = SwiftAutomation.noParameter,
            ...
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "export", event: 0x66626f6b_66626578, // "fbokfbex"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                    ("to", 0x6662746f, to), // "fbto"
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    ...
    @discardableResult public func remove(_ directParameter: Any = SwiftAutomation.noParameter,
            ...
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "remove", event: 0x66626f6b_6662726d, // "fbokfbrm"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
    ...
    @discardableResult public func validateFontFile(_ directParameter: Any = SwiftAutomation.noParameter,
            ...
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "validateFontFile", event: 0x66626f6b_6662766c, // "fbokfbvl"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
...
extension FBOObject {
    ...
    public var id: FBOItem {return self.property(0x49442020) as! FBOItem} // "ID  "
    public var ID_: FBOItem {return self.property(0x49442020) as! FBOItem} // "ID  "

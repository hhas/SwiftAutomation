...
public class FBOSymbol: SwiftAutomation.Symbol {
    ...
    public override class func symbol(code: OSType, type: OSType = typeType, descriptor: ScalarDescriptor? = nil) -> FBOSymbol {
        switch (code) {
    ...
    public static let April = FBOSymbol(name: "April", code: 0x61707220, type: typeType) // "apr "
    public static let August = FBOSymbol(name: "August", code: 0x61756720, type: typeType) // "aug "
    ...
    public static let date = FBOSymbol(name: "date", code: 0x6c647420, type: typeType) // "ldt "
    public static let December = FBOSymbol(name: "December", code: 0x64656320, type: typeType) // "dec "
    ...
    public static let EPSPicture = FBOSymbol(name: "EPSPicture", code: 0x45505320, type: typeType) // "EPS "
    public static let familyName = FBOSymbol(name: "familyName", code: 0x6662666e, type: typeType) // "fbfn"
    public static let February = FBOSymbol(name: "February", code: 0x66656220, type: typeType) // "feb "
    ...
    public static let Friday = FBOSymbol(name: "Friday", code: 0x66726920, type: typeType) // "fri "
    ...
    public static let id = FBOSymbol(name: "id", code: 0x49442020, type: typeType) // "ID  "
    public static let ID_ = FBOSymbol(name: "ID_", code: 0x49442020, type: typeType) // "ID  "
    ...
    public static let January = FBOSymbol(name: "January", code: 0x6a616e20, type: typeType) // "jan "
    public static let JPEGPicture = FBOSymbol(name: "JPEGPicture", code: 0x4a504547, type: typeType) // "JPEG"
    public static let July = FBOSymbol(name: "July", code: 0x6a756c20, type: typeType) // "jul "
    public static let June = FBOSymbol(name: "June", code: 0x6a756e20, type: typeType) // "jun "
    ...
    public static let March = FBOSymbol(name: "March", code: 0x6d617220, type: typeType) // "mar "
    public static let May = FBOSymbol(name: "May", code: 0x6d617920, type: typeType) // "may "
    ...
    public static let Monday = FBOSymbol(name: "Monday", code: 0x6d6f6e20, type: typeType) // "mon "
    ...
    public static let November = FBOSymbol(name: "November", code: 0x6e6f7620, type: typeType) // "nov "
    public static let null = FBOSymbol(name: "null", code: 0x6e756c6c, type: typeType) // "null"
    public static let October = FBOSymbol(name: "October", code: 0x6f637420, type: typeType) // "oct "
    ...
    public static let processSerialNumber = FBOSymbol(name: "processSerialNumber", code: 0x70736e20, type: typeType) // "psn "
    ...
    public static let reference = FBOSymbol(name: "reference", code: 0x6f626a20, type: typeType) // "obj "
    ...
    public static let Saturday = FBOSymbol(name: "Saturday", code: 0x73617420, type: typeType) // "sat "
    ...
    public static let September = FBOSymbol(name: "September", code: 0x73657020, type: typeType) // "sep "
    ...
    public static let Sunday = FBOSymbol(name: "Sunday", code: 0x73756e20, type: typeType) // "sun "
    public static let textStyleInfo = FBOSymbol(name: "textStyleInfo", code: 0x74737479, type: typeType) // "tsty"
    public static let Thursday = FBOSymbol(name: "Thursday", code: 0x74687520, type: typeType) // "thu "
    ...
    public static let Tuesday = FBOSymbol(name: "Tuesday", code: 0x74756520, type: typeType) // "tue "
    ...
    public static let Wednesday = FBOSymbol(name: "Wednesday", code: 0x77656420, type: typeType) // "wed "
    ...
    // Enumerators
    public static let ask = FBOSymbol(name: "ask", code: 0x61736b20, type: typeEnumerated) // "ask "
    ...
    public static let no = FBOSymbol(name: "no", code: 0x6e6f2020, type: typeEnumerated) // "no  "
    ...
    public static let yes = FBOSymbol(name: "yes", code: 0x79657320, type: typeEnumerated) // "yes "
}

...
private let _specifierFormatter = SwiftAutomation.SpecifierFormatter(applicationClassName: "BluetoothFileExchange",
                                                     classNamePrefix: "BFE",
                                                     typeNames: [
...
public class BFESymbol: SwiftAutomation.Symbol {
    ...
    public override class func symbol(code: OSType, type: OSType = typeType, descriptor: NSAppleEventDescriptor? = nil) -> BFESymbol {
        switch (code) {
    ...
    public static let April = BFESymbol(name: "April", code: 0x61707220, type: typeType) // "apr\0x20"
    public static let August = BFESymbol(name: "August", code: 0x61756720, type: typeType) // "aug\0x20"
    ...
    public static let date = BFESymbol(name: "date", code: 0x6c647420, type: typeType) // "ldt\0x20"
    public static let December = BFESymbol(name: "December", code: 0x64656320, type: typeType) // "dec\0x20"
    ...
    public static let EPSPicture = BFESymbol(name: "EPSPicture", code: 0x45505320, type: typeType) // "EPS\0x20"
    public static let extendedReal = BFESymbol(name: "extendedReal", code: 0x65787465, type: typeType) // "exte"
    public static let February = BFESymbol(name: "February", code: 0x66656220, type: typeType) // "feb\0x20"
    public static let fileRef = BFESymbol(name: "fileRef", code: 0x66737266, type: typeType) // "fsrf"
    public static let fileSpecification = BFESymbol(name: "fileSpecification", code: 0x66737320, type: typeType) // "fss\0x20"
    ...
    public static let Friday = BFESymbol(name: "Friday", code: 0x66726920, type: typeType) // "fri\0x20"
    ...
    public static let id = BFESymbol(name: "id", code: 0x49442020, type: typeType) // "ID\0x20\0x20"
    ...
    public static let January = BFESymbol(name: "January", code: 0x6a616e20, type: typeType) // "jan\0x20"
    public static let JPEGPicture = BFESymbol(name: "JPEGPicture", code: 0x4a504547, type: typeType) // "JPEG"
    public static let July = BFESymbol(name: "July", code: 0x6a756c20, type: typeType) // "jul\0x20"
    public static let June = BFESymbol(name: "June", code: 0x6a756e20, type: typeType) // "jun\0x20"
    ...
    public static let March = BFESymbol(name: "March", code: 0x6d617220, type: typeType) // "mar\0x20"
    public static let May = BFESymbol(name: "May", code: 0x6d617920, type: typeType) // "may\0x20"
    public static let Monday = BFESymbol(name: "Monday", code: 0x6d6f6e20, type: typeType) // "mon\0x20"
    public static let November = BFESymbol(name: "November", code: 0x6e6f7620, type: typeType) // "nov\0x20"
    public static let null = BFESymbol(name: "null", code: 0x6e756c6c, type: typeType) // "null"
    public static let October = BFESymbol(name: "October", code: 0x6f637420, type: typeType) // "oct\0x20"
    ...
    public static let processSerialNumber = BFESymbol(name: "processSerialNumber", code: 0x70736e20, type: typeType) // "psn\0x20"
    ...
    public static let reference = BFESymbol(name: "reference", code: 0x6f626a20, type: typeType) // "obj\0x20"
    ...
    public static let Saturday = BFESymbol(name: "Saturday", code: 0x73617420, type: typeType) // "sat\0x20"
    public static let script = BFESymbol(name: "script", code: 0x73637074, type: typeType) // "scpt"
    public static let September = BFESymbol(name: "September", code: 0x73657020, type: typeType) // "sep\0x20"
    ...
    public static let Sunday = BFESymbol(name: "Sunday", code: 0x73756e20, type: typeType) // "sun\0x20"
    public static let textStyleInfo = BFESymbol(name: "textStyleInfo", code: 0x74737479, type: typeType) // "tsty"
    public static let Thursday = BFESymbol(name: "Thursday", code: 0x74687520, type: typeType) // "thu\0x20"
    public static let TIFFPicture = BFESymbol(name: "TIFFPicture", code: 0x54494646, type: typeType) // "TIFF"
    public static let Tuesday = BFESymbol(name: "Tuesday", code: 0x74756520, type: typeType) // "tue\0x20"
    ...
    public static let Wednesday = BFESymbol(name: "Wednesday", code: 0x77656420, type: typeType) // "wed\0x20"
    public static let writingCode = BFESymbol(name: "writingCode", code: 0x70736374, type: typeType) // "psct"

    // Enumerators
    public static let ask = BFESymbol(name: "ask", code: 0x61736b20, type: typeEnumerated) // "ask\0x20"
    ...
    public static let no = BFESymbol(name: "no", code: 0x6e6f2020, type: typeEnumerated) // "no\0x20\0x20"
    ...
    public static let yes = BFESymbol(name: "yes", code: 0x79657320, type: typeEnumerated) // "yes\0x20"
}
...
extension BFECommand {
    ...
    @discardableResult public func browse(_ directParameter: Any = SwiftAutomation.NoParameter,
            ...
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "browse", eventClass: 0x61657674, eventID: 0x6f465450, // "aevt"/"oFTP"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
    ...
    @discardableResult public func send(_ directParameter: Any = SwiftAutomation.NoParameter,
            ...
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "send", eventClass: 0x61657674, eventID: 0x6f4f5050, // "aevt"/"oOPP"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
...
extension BFEObject {
    ...
    public var id: BFEItem {return self.property(0x49442020) as! BFEItem} // "ID\0x20\0x20"

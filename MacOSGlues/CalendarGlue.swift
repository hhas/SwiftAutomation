...
public class CALSymbol: SwiftAutomation.Symbol {
    ...
    public override class func symbol(code: OSType, type: OSType = typeType, descriptor: ScalarDescriptor? = nil) -> CALSymbol {
        switch (code) {
    ...
    public static let April = CALSymbol(name: "April", code: 0x61707220, type: typeType) // "apr "
    public static let attendee = CALSymbol(name: "attendee", code: 0x77726561, type: typeType) // "wrea"
    public static let August = CALSymbol(name: "August", code: 0x61756720, type: typeType) // "aug "
    ...
    public static let date = CALSymbol(name: "date", code: 0x6c647420, type: typeType) // "ldt "
    public static let December = CALSymbol(name: "December", code: 0x64656320, type: typeType) // "dec "
    ...
    public static let EPSPicture = CALSymbol(name: "EPSPicture", code: 0x45505320, type: typeType) // "EPS "
    ...
    public static let February = CALSymbol(name: "February", code: 0x66656220, type: typeType) // "feb "
    ...
    public static let Friday = CALSymbol(name: "Friday", code: 0x66726920, type: typeType) // "fri "
    ...
    public static let id = CALSymbol(name: "id", code: 0x49442020, type: typeType) // "ID  "
    ...
    public static let January = CALSymbol(name: "January", code: 0x6a616e20, type: typeType) // "jan "
    public static let JPEGPicture = CALSymbol(name: "JPEGPicture", code: 0x4a504547, type: typeType) // "JPEG"
    public static let July = CALSymbol(name: "July", code: 0x6a756c20, type: typeType) // "jul "
    public static let June = CALSymbol(name: "June", code: 0x6a756e20, type: typeType) // "jun "
    ...
    public static let March = CALSymbol(name: "March", code: 0x6d617220, type: typeType) // "mar "
    public static let May = CALSymbol(name: "May", code: 0x6d617920, type: typeType) // "may "
    ...
    public static let Monday = CALSymbol(name: "Monday", code: 0x6d6f6e20, type: typeType) // "mon "
    public static let name = CALSymbol(name: "name", code: 0x706e616d, type: typeType) // "pnam"
    public static let November = CALSymbol(name: "November", code: 0x6e6f7620, type: typeType) // "nov "
    public static let null = CALSymbol(name: "null", code: 0x6e756c6c, type: typeType) // "null"
    public static let October = CALSymbol(name: "October", code: 0x6f637420, type: typeType) // "oct "
    ...
    public static let processSerialNumber = CALSymbol(name: "processSerialNumber", code: 0x70736e20, type: typeType) // "psn "
    ...
    public static let reference = CALSymbol(name: "reference", code: 0x6f626a20, type: typeType) // "obj "
    ...
    public static let Saturday = CALSymbol(name: "Saturday", code: 0x73617420, type: typeType) // "sat "
    public static let script = CALSymbol(name: "script", code: 0x73637074, type: typeType) // "scpt"
    public static let September = CALSymbol(name: "September", code: 0x73657020, type: typeType) // "sep "
    ...
    public static let Sunday = CALSymbol(name: "Sunday", code: 0x73756e20, type: typeType) // "sun "
    ...
    public static let Thursday = CALSymbol(name: "Thursday", code: 0x74687520, type: typeType) // "thu "
    ...
    public static let Tuesday = CALSymbol(name: "Tuesday", code: 0x74756520, type: typeType) // "tue "
    public static let typeClass = CALSymbol(name: "typeClass", code: 0x74797065, type: typeType) // "type"
    public static let uid = CALSymbol(name: "uid", code: 0x49442020, type: typeType) // "ID  "
    ...
    public static let Wednesday = CALSymbol(name: "Wednesday", code: 0x77656420, type: typeType) // "wed "
    ...
    public static let ask = CALSymbol(name: "ask", code: 0x61736b20, type: typeEnumerated) // "ask "
    ...
    public static let no = CALSymbol(name: "no", code: 0x6e6f2020, type: typeEnumerated) // "no  "
    ...
    public static let yes = CALSymbol(name: "yes", code: 0x79657320, type: typeEnumerated) // "yes "
}

...
public class CALSymbol: SwiftAutomation.Symbol {
    ...
    public static let enumerator = CALSymbol(name: "enumerator", code: 0x656e756d, type: typeType) // "enum"
    ...
    public static let extendedFloat = CALSymbol(name: "extendedFloat", code: 0x65787465, type: typeType) // "exte"
    ...
    public static let float = CALSymbol(name: "float", code: 0x646f7562, type: typeType) // "doub"
    public static let float128bit = CALSymbol(name: "float128bit", code: 0x6c64626c, type: typeType) // "ldbl"
    ...
    public static let shortFloat = CALSymbol(name: "shortFloat", code: 0x73696e67, type: typeType) // "sing"

...
private let _specifierFormatter = SwiftAutomation.SpecifierFormatter(
        ...
        elementsNames: [
                ...
                0x77616c31: ("displayAlarm", "displayAlarms"), // "wal1"
                0x646f6375: ("document", "documents"), // "docu"
                0x77726576: ("event", "events"), // "wrev"
                0x636f626a: ("item", "items"), // "cobj"
                0x77616c32: ("mailAlarm", "mailAlarms"), // "wal2"
                0x77616c33: ("openFileAlarm", "openFileAlarms"), // "wal3"
                0x77616c34: ("soundAlarm", "soundAlarms"), // "wal4"
                0x6377696e: ("window", "windows"), // "cwin"
        ])

private let _glueClasses = SwiftAutomation.GlueClasses(
                                                insertionSpecifierType: CALInsertion.self,
...
public class CALSymbol: SwiftAutomation.Symbol {
    ...
    public override class func symbol(code: OSType, type: OSType = AppleEvents.typeType, descriptor: ScalarDescriptor? = nil) -> CALSymbol {
        switch (code) {
        ...
        case 0x49442020: return self.uid // "ID  "
    ...
    // Types/properties
    public static let alias = CALSymbol(name: "alias", code: 0x616c6973, type: AppleEvents.typeType) // "alis"
    public static let alldayEvent = CALSymbol(name: "alldayEvent", code: 0x77726164, type: AppleEvents.typeType) // "wrad"
    public static let allowCancel = CALSymbol(name: "allowCancel", code: 0x77727033, type: AppleEvents.typeType) // "wrp3"
    public static let anything = CALSymbol(name: "anything", code: 0x2a2a2a2a, type: AppleEvents.typeType) // "****"
    public static let application = CALSymbol(name: "application", code: 0x63617070, type: AppleEvents.typeType) // "capp"
    public static let applicationBundleID = CALSymbol(name: "applicationBundleID", code: 0x62756e64, type: AppleEvents.typeType) // "bund"
    public static let applicationSignature = CALSymbol(name: "applicationSignature", code: 0x7369676e, type: AppleEvents.typeType) // "sign"
    public static let applicationURL = CALSymbol(name: "applicationURL", code: 0x6170726c, type: AppleEvents.typeType) // "aprl"
    public static let April = CALSymbol(name: "April", code: 0x61707220, type: AppleEvents.typeType) // "apr "
    public static let attendee = CALSymbol(name: "attendee", code: 0x77726561, type: AppleEvents.typeType) // "wrea"
    public static let August = CALSymbol(name: "August", code: 0x61756720, type: AppleEvents.typeType) // "aug "
    public static let best = CALSymbol(name: "best", code: 0x62657374, type: AppleEvents.typeType) // "best"
    public static let bookmarkData = CALSymbol(name: "bookmarkData", code: 0x626d726b, type: AppleEvents.typeType) // "bmrk"
    public static let boolean = CALSymbol(name: "boolean", code: 0x626f6f6c, type: AppleEvents.typeType) // "bool"
    public static let boundingRectangle = CALSymbol(name: "boundingRectangle", code: 0x71647274, type: AppleEvents.typeType) // "qdrt"
    public static let bounds = CALSymbol(name: "bounds", code: 0x70626e64, type: AppleEvents.typeType) // "pbnd"
    public static let calendar = CALSymbol(name: "calendar", code: 0x77726573, type: AppleEvents.typeType) // "wres"
    public static let class_ = CALSymbol(name: "class_", code: 0x70636c73, type: AppleEvents.typeType) // "pcls"
    public static let closeable = CALSymbol(name: "closeable", code: 0x68636c62, type: AppleEvents.typeType) // "hclb"
    public static let collating = CALSymbol(name: "collating", code: 0x6c77636c, type: AppleEvents.typeType) // "lwcl"
    public static let color = CALSymbol(name: "color", code: 0x636f6c72, type: AppleEvents.typeType) // "colr"
    public static let colorTable = CALSymbol(name: "colorTable", code: 0x636c7274, type: AppleEvents.typeType) // "clrt"
    public static let constant = CALSymbol(name: "constant", code: 0x656e756d, type: AppleEvents.typeType) // "enum"
    public static let copies = CALSymbol(name: "copies", code: 0x6c776370, type: AppleEvents.typeType) // "lwcp"
    public static let dashStyle = CALSymbol(name: "dashStyle", code: 0x74646173, type: AppleEvents.typeType) // "tdas"
    public static let data = CALSymbol(name: "data", code: 0x74647461, type: AppleEvents.typeType) // "tdta"
    public static let date = CALSymbol(name: "date", code: 0x6c647420, type: AppleEvents.typeType) // "ldt "
    public static let December = CALSymbol(name: "December", code: 0x64656320, type: AppleEvents.typeType) // "dec "
    public static let decimalStruct = CALSymbol(name: "decimalStruct", code: 0x6465636d, type: AppleEvents.typeType) // "decm"
    public static let description_ = CALSymbol(name: "description_", code: 0x77723132, type: AppleEvents.typeType) // "wr12"
    public static let displayAlarm = CALSymbol(name: "displayAlarm", code: 0x77616c31, type: AppleEvents.typeType) // "wal1"
    public static let displayName = CALSymbol(name: "displayName", code: 0x77726131, type: AppleEvents.typeType) // "wra1"
    public static let document = CALSymbol(name: "document", code: 0x646f6375, type: AppleEvents.typeType) // "docu"
    public static let doubleInteger = CALSymbol(name: "doubleInteger", code: 0x636f6d70, type: AppleEvents.typeType) // "comp"
    public static let email = CALSymbol(name: "email", code: 0x77726132, type: AppleEvents.typeType) // "wra2"
    public static let encodedString = CALSymbol(name: "encodedString", code: 0x656e6373, type: AppleEvents.typeType) // "encs"
    public static let endDate = CALSymbol(name: "endDate", code: 0x77723573, type: AppleEvents.typeType) // "wr5s"
    public static let endingPage = CALSymbol(name: "endingPage", code: 0x6c776c70, type: AppleEvents.typeType) // "lwlp"
    public static let EPSPicture = CALSymbol(name: "EPSPicture", code: 0x45505320, type: AppleEvents.typeType) // "EPS "
    public static let errorHandling = CALSymbol(name: "errorHandling", code: 0x6c776568, type: AppleEvents.typeType) // "lweh"
    public static let event = CALSymbol(name: "event", code: 0x77726576, type: AppleEvents.typeType) // "wrev"
    public static let excludedDates = CALSymbol(name: "excludedDates", code: 0x77723273, type: AppleEvents.typeType) // "wr2s"
    public static let faxNumber = CALSymbol(name: "faxNumber", code: 0x6661786e, type: AppleEvents.typeType) // "faxn"
    public static let February = CALSymbol(name: "February", code: 0x66656220, type: AppleEvents.typeType) // "feb "
    public static let file = CALSymbol(name: "file", code: 0x66696c65, type: AppleEvents.typeType) // "file"
    public static let filepath = CALSymbol(name: "filepath", code: 0x77616c70, type: AppleEvents.typeType) // "walp"
    public static let fileRef = CALSymbol(name: "fileRef", code: 0x66737266, type: AppleEvents.typeType) // "fsrf"
    public static let fileURL = CALSymbol(name: "fileURL", code: 0x6675726c, type: AppleEvents.typeType) // "furl"
    public static let fixed = CALSymbol(name: "fixed", code: 0x66697864, type: AppleEvents.typeType) // "fixd"
    public static let fixedPoint = CALSymbol(name: "fixedPoint", code: 0x66706e74, type: AppleEvents.typeType) // "fpnt"
    public static let fixedRectangle = CALSymbol(name: "fixedRectangle", code: 0x66726374, type: AppleEvents.typeType) // "frct"
    public static let Friday = CALSymbol(name: "Friday", code: 0x66726920, type: AppleEvents.typeType) // "fri "
    public static let frontmost = CALSymbol(name: "frontmost", code: 0x70697366, type: AppleEvents.typeType) // "pisf"
    public static let GIFPicture = CALSymbol(name: "GIFPicture", code: 0x47494666, type: AppleEvents.typeType) // "GIFf"
    public static let graphicText = CALSymbol(name: "graphicText", code: 0x63677478, type: AppleEvents.typeType) // "cgtx"
    public static let id = CALSymbol(name: "id", code: 0x49442020, type: AppleEvents.typeType) // "ID  "
    public static let index = CALSymbol(name: "index", code: 0x70696478, type: AppleEvents.typeType) // "pidx"
    public static let integer = CALSymbol(name: "integer", code: 0x6c6f6e67, type: AppleEvents.typeType) // "long"
    public static let internationalText = CALSymbol(name: "internationalText", code: 0x69747874, type: AppleEvents.typeType) // "itxt"
    public static let internationalWritingCode = CALSymbol(name: "internationalWritingCode", code: 0x696e746c, type: AppleEvents.typeType) // "intl"
    public static let item = CALSymbol(name: "item", code: 0x636f626a, type: AppleEvents.typeType) // "cobj"
    public static let January = CALSymbol(name: "January", code: 0x6a616e20, type: AppleEvents.typeType) // "jan "
    public static let JPEGPicture = CALSymbol(name: "JPEGPicture", code: 0x4a504547, type: AppleEvents.typeType) // "JPEG"
    public static let July = CALSymbol(name: "July", code: 0x6a756c20, type: AppleEvents.typeType) // "jul "
    public static let June = CALSymbol(name: "June", code: 0x6a756e20, type: AppleEvents.typeType) // "jun "
    public static let kernelProcessID = CALSymbol(name: "kernelProcessID", code: 0x6b706964, type: AppleEvents.typeType) // "kpid"
    public static let largeReal = CALSymbol(name: "largeReal", code: 0x6c64626c, type: AppleEvents.typeType) // "ldbl"
    public static let list = CALSymbol(name: "list", code: 0x6c697374, type: AppleEvents.typeType) // "list"
    public static let location = CALSymbol(name: "location", code: 0x77723134, type: AppleEvents.typeType) // "wr14"
    public static let locationReference = CALSymbol(name: "locationReference", code: 0x696e736c, type: AppleEvents.typeType) // "insl"
    public static let longFixed = CALSymbol(name: "longFixed", code: 0x6c667864, type: AppleEvents.typeType) // "lfxd"
    public static let longFixedPoint = CALSymbol(name: "longFixedPoint", code: 0x6c667074, type: AppleEvents.typeType) // "lfpt"
    public static let longFixedRectangle = CALSymbol(name: "longFixedRectangle", code: 0x6c667263, type: AppleEvents.typeType) // "lfrc"
    public static let longPoint = CALSymbol(name: "longPoint", code: 0x6c706e74, type: AppleEvents.typeType) // "lpnt"
    public static let longRectangle = CALSymbol(name: "longRectangle", code: 0x6c726374, type: AppleEvents.typeType) // "lrct"
    public static let machine = CALSymbol(name: "machine", code: 0x6d616368, type: AppleEvents.typeType) // "mach"
    public static let machineLocation = CALSymbol(name: "machineLocation", code: 0x6d4c6f63, type: AppleEvents.typeType) // "mLoc"
    public static let machPort = CALSymbol(name: "machPort", code: 0x706f7274, type: AppleEvents.typeType) // "port"
    public static let mailAlarm = CALSymbol(name: "mailAlarm", code: 0x77616c32, type: AppleEvents.typeType) // "wal2"
    public static let March = CALSymbol(name: "March", code: 0x6d617220, type: AppleEvents.typeType) // "mar "
    public static let May = CALSymbol(name: "May", code: 0x6d617920, type: AppleEvents.typeType) // "may "
    public static let miniaturizable = CALSymbol(name: "miniaturizable", code: 0x69736d6e, type: AppleEvents.typeType) // "ismn"
    public static let miniaturized = CALSymbol(name: "miniaturized", code: 0x706d6e64, type: AppleEvents.typeType) // "pmnd"
    public static let modified = CALSymbol(name: "modified", code: 0x696d6f64, type: AppleEvents.typeType) // "imod"
    public static let Monday = CALSymbol(name: "Monday", code: 0x6d6f6e20, type: AppleEvents.typeType) // "mon "
    public static let name = CALSymbol(name: "name", code: 0x706e616d, type: AppleEvents.typeType) // "pnam"
    public static let November = CALSymbol(name: "November", code: 0x6e6f7620, type: AppleEvents.typeType) // "nov "
    public static let null = CALSymbol(name: "null", code: 0x6e756c6c, type: AppleEvents.typeType) // "null"
    public static let October = CALSymbol(name: "October", code: 0x6f637420, type: AppleEvents.typeType) // "oct "
    public static let openFileAlarm = CALSymbol(name: "openFileAlarm", code: 0x77616c33, type: AppleEvents.typeType) // "wal3"
    public static let pagesAcross = CALSymbol(name: "pagesAcross", code: 0x6c776c61, type: AppleEvents.typeType) // "lwla"
    public static let pagesDown = CALSymbol(name: "pagesDown", code: 0x6c776c64, type: AppleEvents.typeType) // "lwld"
    public static let participationStatus = CALSymbol(name: "participationStatus", code: 0x77726133, type: AppleEvents.typeType) // "wra3"
    public static let PICTPicture = CALSymbol(name: "PICTPicture", code: 0x50494354, type: AppleEvents.typeType) // "PICT"
    public static let pixelMapRecord = CALSymbol(name: "pixelMapRecord", code: 0x74706d6d, type: AppleEvents.typeType) // "tpmm"
    public static let point = CALSymbol(name: "point", code: 0x51447074, type: AppleEvents.typeType) // "QDpt"
    public static let printSettings = CALSymbol(name: "printSettings", code: 0x70736574, type: AppleEvents.typeType) // "pset"
    public static let processSerialNumber = CALSymbol(name: "processSerialNumber", code: 0x70736e20, type: AppleEvents.typeType) // "psn "
    public static let progression = CALSymbol(name: "progression", code: 0x77727032, type: AppleEvents.typeType) // "wrp2"
    public static let properties = CALSymbol(name: "properties", code: 0x70414c4c, type: AppleEvents.typeType) // "pALL"
    public static let property_ = CALSymbol(name: "property_", code: 0x70726f70, type: AppleEvents.typeType) // "prop"
    public static let real = CALSymbol(name: "real", code: 0x646f7562, type: AppleEvents.typeType) // "doub"
    public static let record = CALSymbol(name: "record", code: 0x7265636f, type: AppleEvents.typeType) // "reco"
    public static let recurrence = CALSymbol(name: "recurrence", code: 0x77723135, type: AppleEvents.typeType) // "wr15"
    public static let reference = CALSymbol(name: "reference", code: 0x6f626a20, type: AppleEvents.typeType) // "obj "
    public static let requestedPrintTime = CALSymbol(name: "requestedPrintTime", code: 0x6c777174, type: AppleEvents.typeType) // "lwqt"
    public static let resizable = CALSymbol(name: "resizable", code: 0x7072737a, type: AppleEvents.typeType) // "prsz"
    public static let RGB16Color = CALSymbol(name: "RGB16Color", code: 0x74723136, type: AppleEvents.typeType) // "tr16"
    public static let RGB96Color = CALSymbol(name: "RGB96Color", code: 0x74723936, type: AppleEvents.typeType) // "tr96"
    public static let RGBColor = CALSymbol(name: "RGBColor", code: 0x63524742, type: AppleEvents.typeType) // "cRGB"
    public static let rotation = CALSymbol(name: "rotation", code: 0x74726f74, type: AppleEvents.typeType) // "trot"
    public static let Saturday = CALSymbol(name: "Saturday", code: 0x73617420, type: AppleEvents.typeType) // "sat "
    public static let script = CALSymbol(name: "script", code: 0x73637074, type: AppleEvents.typeType) // "scpt"
    public static let September = CALSymbol(name: "September", code: 0x73657020, type: AppleEvents.typeType) // "sep "
    public static let sequence = CALSymbol(name: "sequence", code: 0x77723133, type: AppleEvents.typeType) // "wr13"
    public static let shortInteger = CALSymbol(name: "shortInteger", code: 0x73686f72, type: AppleEvents.typeType) // "shor"
    public static let smallReal = CALSymbol(name: "smallReal", code: 0x73696e67, type: AppleEvents.typeType) // "sing"
    public static let soundAlarm = CALSymbol(name: "soundAlarm", code: 0x77616c34, type: AppleEvents.typeType) // "wal4"
    public static let soundFile = CALSymbol(name: "soundFile", code: 0x77616c66, type: AppleEvents.typeType) // "walf"
    public static let soundName = CALSymbol(name: "soundName", code: 0x77616c73, type: AppleEvents.typeType) // "wals"
    public static let stampDate = CALSymbol(name: "stampDate", code: 0x77723473, type: AppleEvents.typeType) // "wr4s"
    public static let startDate = CALSymbol(name: "startDate", code: 0x77723173, type: AppleEvents.typeType) // "wr1s"
    public static let startingPage = CALSymbol(name: "startingPage", code: 0x6c776670, type: AppleEvents.typeType) // "lwfp"
    public static let status = CALSymbol(name: "status", code: 0x77726534, type: AppleEvents.typeType) // "wre4"
    public static let string = CALSymbol(name: "string", code: 0x54455854, type: AppleEvents.typeType) // "TEXT"
    public static let styledClipboardText = CALSymbol(name: "styledClipboardText", code: 0x7374796c, type: AppleEvents.typeType) // "styl"
    public static let styledText = CALSymbol(name: "styledText", code: 0x53545854, type: AppleEvents.typeType) // "STXT"
    public static let summary = CALSymbol(name: "summary", code: 0x77723131, type: AppleEvents.typeType) // "wr11"
    public static let Sunday = CALSymbol(name: "Sunday", code: 0x73756e20, type: AppleEvents.typeType) // "sun "
    public static let targetPrinter = CALSymbol(name: "targetPrinter", code: 0x74727072, type: AppleEvents.typeType) // "trpr"
    public static let textStyleInfo = CALSymbol(name: "textStyleInfo", code: 0x74737479, type: AppleEvents.typeType) // "tsty"
    public static let Thursday = CALSymbol(name: "Thursday", code: 0x74687520, type: AppleEvents.typeType) // "thu "
    public static let TIFFPicture = CALSymbol(name: "TIFFPicture", code: 0x54494646, type: AppleEvents.typeType) // "TIFF"
    public static let title = CALSymbol(name: "title", code: 0x77723032, type: AppleEvents.typeType) // "wr02"
    public static let triggerDate = CALSymbol(name: "triggerDate", code: 0x77616c65, type: AppleEvents.typeType) // "wale"
    public static let triggerInterval = CALSymbol(name: "triggerInterval", code: 0x77616c64, type: AppleEvents.typeType) // "wald"
    public static let Tuesday = CALSymbol(name: "Tuesday", code: 0x74756520, type: AppleEvents.typeType) // "tue "
    public static let typeClass = CALSymbol(name: "typeClass", code: 0x74797065, type: AppleEvents.typeType) // "type"
    public static let uid = CALSymbol(name: "uid", code: 0x49442020, type: AppleEvents.typeType) // "ID  "
    public static let UnicodeText = CALSymbol(name: "UnicodeText", code: 0x75747874, type: AppleEvents.typeType) // "utxt"
    public static let unsignedDoubleInteger = CALSymbol(name: "unsignedDoubleInteger", code: 0x75636f6d, type: AppleEvents.typeType) // "ucom"
    public static let unsignedInteger = CALSymbol(name: "unsignedInteger", code: 0x6d61676e, type: AppleEvents.typeType) // "magn"
    public static let unsignedShortInteger = CALSymbol(name: "unsignedShortInteger", code: 0x75736872, type: AppleEvents.typeType) // "ushr"
    public static let url = CALSymbol(name: "url", code: 0x77723136, type: AppleEvents.typeType) // "wr16"
    public static let UTF16Text = CALSymbol(name: "UTF16Text", code: 0x75743136, type: AppleEvents.typeType) // "ut16"
    public static let UTF8Text = CALSymbol(name: "UTF8Text", code: 0x75746638, type: AppleEvents.typeType) // "utf8"
    public static let version = CALSymbol(name: "version", code: 0x76657273, type: AppleEvents.typeType) // "vers"
    public static let visible = CALSymbol(name: "visible", code: 0x70766973, type: AppleEvents.typeType) // "pvis"
    public static let Wednesday = CALSymbol(name: "Wednesday", code: 0x77656420, type: AppleEvents.typeType) // "wed "
    public static let window = CALSymbol(name: "window", code: 0x6377696e, type: AppleEvents.typeType) // "cwin"
    public static let writable = CALSymbol(name: "writable", code: 0x77723035, type: AppleEvents.typeType) // "wr05"
    public static let writingCode = CALSymbol(name: "writingCode", code: 0x70736374, type: AppleEvents.typeType) // "psct"
    public static let zoomable = CALSymbol(name: "zoomable", code: 0x69737a6d, type: AppleEvents.typeType) // "iszm"
    public static let zoomed = CALSymbol(name: "zoomed", code: 0x707a756d, type: AppleEvents.typeType) // "pzum"

    // Enumerators
    public static let accepted = CALSymbol(name: "accepted", code: 0x45366170, type: AppleEvents.typeEnumerated) // "E6ap"
    public static let ask = CALSymbol(name: "ask", code: 0x61736b20, type: AppleEvents.typeEnumerated) // "ask "
    public static let cancelled = CALSymbol(name: "cancelled", code: 0x45346361, type: AppleEvents.typeEnumerated) // "E4ca"
    public static let case_ = CALSymbol(name: "case_", code: 0x63617365, type: AppleEvents.typeEnumerated) // "case"
    public static let confirmed = CALSymbol(name: "confirmed", code: 0x4534636e, type: AppleEvents.typeEnumerated) // "E4cn"
    public static let dayView = CALSymbol(name: "dayView", code: 0x45356461, type: AppleEvents.typeEnumerated) // "E5da"
    public static let declined = CALSymbol(name: "declined", code: 0x45366470, type: AppleEvents.typeEnumerated) // "E6dp"
    public static let detailed = CALSymbol(name: "detailed", code: 0x6c776474, type: AppleEvents.typeEnumerated) // "lwdt"
    public static let diacriticals = CALSymbol(name: "diacriticals", code: 0x64696163, type: AppleEvents.typeEnumerated) // "diac"
    public static let expansion = CALSymbol(name: "expansion", code: 0x65787061, type: AppleEvents.typeEnumerated) // "expa"
    public static let highPriority = CALSymbol(name: "highPriority", code: 0x74647031, type: AppleEvents.typeEnumerated) // "tdp1"
    public static let hyphens = CALSymbol(name: "hyphens", code: 0x68797068, type: AppleEvents.typeEnumerated) // "hyph"
    public static let lowPriority = CALSymbol(name: "lowPriority", code: 0x74647039, type: AppleEvents.typeEnumerated) // "tdp9"
    public static let mediumPriority = CALSymbol(name: "mediumPriority", code: 0x74647035, type: AppleEvents.typeEnumerated) // "tdp5"
    public static let monthView = CALSymbol(name: "monthView", code: 0x45356d6f, type: AppleEvents.typeEnumerated) // "E5mo"
    public static let no = CALSymbol(name: "no", code: 0x6e6f2020, type: AppleEvents.typeEnumerated) // "no  "
    public static let none = CALSymbol(name: "none", code: 0x45346e6f, type: AppleEvents.typeEnumerated) // "E4no"
    public static let noPriority = CALSymbol(name: "noPriority", code: 0x74647030, type: AppleEvents.typeEnumerated) // "tdp0"
    public static let numericStrings = CALSymbol(name: "numericStrings", code: 0x6e756d65, type: AppleEvents.typeEnumerated) // "nume"
    public static let punctuation = CALSymbol(name: "punctuation", code: 0x70756e63, type: AppleEvents.typeEnumerated) // "punc"
    public static let standard = CALSymbol(name: "standard", code: 0x6c777374, type: AppleEvents.typeEnumerated) // "lwst"
    public static let tentative = CALSymbol(name: "tentative", code: 0x45367470, type: AppleEvents.typeEnumerated) // "E6tp"
    public static let unknown = CALSymbol(name: "unknown", code: 0x45366e61, type: AppleEvents.typeEnumerated) // "E6na"
    public static let weekView = CALSymbol(name: "weekView", code: 0x45357765, type: AppleEvents.typeEnumerated) // "E5we"
    public static let whitespace = CALSymbol(name: "whitespace", code: 0x77686974, type: AppleEvents.typeEnumerated) // "whit"
    public static let yes = CALSymbol(name: "yes", code: 0x79657320, type: AppleEvents.typeEnumerated) // "yes "
}
...
extension CALCommand {
    ...
    @discardableResult public func createCalendar(_ directParameter: Any = SwiftAutomation.noParameter,
            ...
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "createCalendar", event: 0x77726274_61656332, // "wrbtaec2"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
    ...
    @discardableResult public func reloadCalendars(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "reloadCalendars", event: 0x77726274_61656338, // "wrbtaec8"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func show(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "show", event: 0x77726274_61656333, // "wrbtaec3"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func switchView(_ directParameter: Any = SwiftAutomation.noParameter,
            ...
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "switchView", event: 0x77726274_61656361, // "wrbtaeca"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
    ...
    @discardableResult public func viewCalendar(_ directParameter: Any = SwiftAutomation.noParameter,
            ...
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "viewCalendar", event: 0x77726274_61656339, // "wrbtaec9"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
...
extension CALObject {
    ...
    public var id: CALItem {return self.property(0x49442020) as! CALItem} // "ID  "
    ...
    public var uid: CALItem {return self.property(0x49442020) as! CALItem} // "ID  "

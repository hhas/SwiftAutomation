...
public class KEYSymbol: SwiftAutomation.Symbol {
    ...
    public override class func symbol(code: OSType, type: OSType = typeType, descriptor: ScalarDescriptor? = nil) -> KEYSymbol {
        switch (code) {
    ...
    public static let April = KEYSymbol(name: "April", code: 0x61707220, type: typeType) // "apr "
    public static let audioClip = KEYSymbol(name: "audioClip", code: 0x73686175, type: typeType) // "shau"
    public static let August = KEYSymbol(name: "August", code: 0x61756720, type: typeType) // "aug "
    ...
    public static let character = KEYSymbol(name: "character", code: 0x63686120, type: typeType) // "cha "
    ...
    public static let date = KEYSymbol(name: "date", code: 0x6c647420, type: typeType) // "ldt "
    public static let date_ = KEYSymbol(name: "date_", code: 0x4b787064, type: typeType) // "Kxpd"
    public static let December = KEYSymbol(name: "December", code: 0x64656320, type: typeType) // "dec "
    ...
    public static let EPSPicture = KEYSymbol(name: "EPSPicture", code: 0x45505320, type: typeType) // "EPS "
    ...
    public static let February = KEYSymbol(name: "February", code: 0x66656220, type: typeType) // "feb "
    ...
    public static let Friday = KEYSymbol(name: "Friday", code: 0x66726920, type: typeType) // "fri "
    ...
    public static let id = KEYSymbol(name: "id", code: 0x49442020, type: typeType) // "ID  "
    ...
    public static let January = KEYSymbol(name: "January", code: 0x6a616e20, type: typeType) // "jan "
    public static let JPEGPicture = KEYSymbol(name: "JPEGPicture", code: 0x4a504547, type: typeType) // "JPEG"
    public static let July = KEYSymbol(name: "July", code: 0x6a756c20, type: typeType) // "jul "
    public static let June = KEYSymbol(name: "June", code: 0x6a756e20, type: typeType) // "jun "
    ...
    public static let March = KEYSymbol(name: "March", code: 0x6d617220, type: typeType) // "mar "
    ...
    public static let May = KEYSymbol(name: "May", code: 0x6d617920, type: typeType) // "may "
    ...
    public static let Monday = KEYSymbol(name: "Monday", code: 0x6d6f6e20, type: typeType) // "mon "
    ...
    public static let November = KEYSymbol(name: "November", code: 0x6e6f7620, type: typeType) // "nov "
    ...
    public static let October = KEYSymbol(name: "October", code: 0x6f637420, type: typeType) // "oct "
    ...
    public static let processSerialNumber = KEYSymbol(name: "processSerialNumber", code: 0x70736e20, type: typeType) // "psn "
    ...
    public static let reference = KEYSymbol(name: "reference", code: 0x6f626a20, type: typeType) // "obj "
    ...
    public static let Saturday = KEYSymbol(name: "Saturday", code: 0x73617420, type: typeType) // "sat "
    public static let script = KEYSymbol(name: "script", code: 0x73637074, type: typeType) // "scpt"
    public static let selection = KEYSymbol(name: "selection", code: 0x73656c65, type: typeType) // "sele"
    public static let selectionRange = KEYSymbol(name: "selectionRange", code: 0x4e4d5473, type: typeType) // "NMTs"
    public static let September = KEYSymbol(name: "September", code: 0x73657020, type: typeType) // "sep "
    ...
    public static let Sunday = KEYSymbol(name: "Sunday", code: 0x73756e20, type: typeType) // "sun "
    ...
    public static let Thursday = KEYSymbol(name: "Thursday", code: 0x74687520, type: typeType) // "thu "
    ...
    public static let Tuesday = KEYSymbol(name: "Tuesday", code: 0x74756520, type: typeType) // "tue "
    ...
    public static let Wednesday = KEYSymbol(name: "Wednesday", code: 0x77656420, type: typeType) // "wed "
    ...
    public static let ask = KEYSymbol(name: "ask", code: 0x61736b20, type: typeEnumerated) // "ask "
    ...
    public static let no = KEYSymbol(name: "no", code: 0x6e6f2020, type: typeEnumerated) // "no  "
    ...
    public static let yes = KEYSymbol(name: "yes", code: 0x79657320, type: typeEnumerated) // "yes "
}

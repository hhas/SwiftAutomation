...
private let _specifierFormatter = SwiftAutomation.SpecifierFormatter(
        ...
        elementsNames: [
                ...
                0x73686175: ("audioClip", "audioClips"), // "shau"
...
private let _glueClasses = SwiftAutomation.GlueClasses(
                                                insertionSpecifierType: KEYInsertion.self,
...
public class KEYSymbol: SwiftAutomation.Symbol {
    ...
    public override class func symbol(code: OSType, type: OSType = AppleEvents.typeType, descriptor: ScalarDescriptor? = nil) -> KEYSymbol {
        switch (code) {
    ...
    // Types/properties
    public static let address = KEYSymbol(name: "address", code: 0x4e4d6164, type: AppleEvents.typeType) // "NMad"
    public static let alias = KEYSymbol(name: "alias", code: 0x616c6973, type: AppleEvents.typeType) // "alis"
    public static let alignment = KEYSymbol(name: "alignment", code: 0x74657841, type: AppleEvents.typeType) // "texA"
    public static let allStages = KEYSymbol(name: "allStages", code: 0x4b787061, type: AppleEvents.typeType) // "Kxpa"
    public static let anything = KEYSymbol(name: "anything", code: 0x2a2a2a2a, type: AppleEvents.typeType) // "****"
    public static let application = KEYSymbol(name: "application", code: 0x63617070, type: AppleEvents.typeType) // "capp"
    public static let applicationBundleID = KEYSymbol(name: "applicationBundleID", code: 0x62756e64, type: AppleEvents.typeType) // "bund"
    public static let applicationSignature = KEYSymbol(name: "applicationSignature", code: 0x7369676e, type: AppleEvents.typeType) // "sign"
    public static let applicationURL = KEYSymbol(name: "applicationURL", code: 0x6170726c, type: AppleEvents.typeType) // "aprl"
    public static let April = KEYSymbol(name: "April", code: 0x61707220, type: AppleEvents.typeType) // "apr "
    public static let audioClip = KEYSymbol(name: "audioClip", code: 0x73686175, type: AppleEvents.typeType) // "shau"
    public static let August = KEYSymbol(name: "August", code: 0x61756720, type: AppleEvents.typeType) // "aug "
    public static let autoLoop = KEYSymbol(name: "autoLoop", code: 0x61756c70, type: AppleEvents.typeType) // "aulp"
    public static let automaticTransition = KEYSymbol(name: "automaticTransition", code: 0x78617574, type: AppleEvents.typeType) // "xaut"
    public static let autoPlay = KEYSymbol(name: "autoPlay", code: 0x61757079, type: AppleEvents.typeType) // "aupy"
    public static let autoRestart = KEYSymbol(name: "autoRestart", code: 0x61757374, type: AppleEvents.typeType) // "aust"
    public static let backgroundColor = KEYSymbol(name: "backgroundColor", code: 0x63654243, type: AppleEvents.typeType) // "ceBC"
    public static let backgroundFillType = KEYSymbol(name: "backgroundFillType", code: 0x626b6674, type: AppleEvents.typeType) // "bkft"
    public static let baseSlide = KEYSymbol(name: "baseSlide", code: 0x736d6173, type: AppleEvents.typeType) // "smas"
    public static let best = KEYSymbol(name: "best", code: 0x62657374, type: AppleEvents.typeType) // "best"
    public static let bodyShowing = KEYSymbol(name: "bodyShowing", code: 0x4b627368, type: AppleEvents.typeType) // "Kbsh"
    public static let bookmarkData = KEYSymbol(name: "bookmarkData", code: 0x626d726b, type: AppleEvents.typeType) // "bmrk"
    public static let boolean = KEYSymbol(name: "boolean", code: 0x626f6f6c, type: AppleEvents.typeType) // "bool"
    public static let borders = KEYSymbol(name: "borders", code: 0x4b787062, type: AppleEvents.typeType) // "Kxpb"
    public static let boundingRectangle = KEYSymbol(name: "boundingRectangle", code: 0x71647274, type: AppleEvents.typeType) // "qdrt"
    public static let bounds = KEYSymbol(name: "bounds", code: 0x70626e64, type: AppleEvents.typeType) // "pbnd"
    public static let cell = KEYSymbol(name: "cell", code: 0x4e6d436c, type: AppleEvents.typeType) // "NmCl"
    public static let cellRange = KEYSymbol(name: "cellRange", code: 0x4e4d5463, type: AppleEvents.typeType) // "NMTc"
    public static let character = KEYSymbol(name: "character", code: 0x63686120, type: AppleEvents.typeType) // "cha "
    public static let chart = KEYSymbol(name: "chart", code: 0x73686374, type: AppleEvents.typeType) // "shct"
    public static let class_ = KEYSymbol(name: "class_", code: 0x70636c73, type: AppleEvents.typeType) // "pcls"
    public static let clipVolume = KEYSymbol(name: "clipVolume", code: 0x61766f6c, type: AppleEvents.typeType) // "avol"
    public static let closeable = KEYSymbol(name: "closeable", code: 0x68636c62, type: AppleEvents.typeType) // "hclb"
    public static let collating = KEYSymbol(name: "collating", code: 0x6c77636c, type: AppleEvents.typeType) // "lwcl"
    public static let color = KEYSymbol(name: "color", code: 0x636f6c72, type: AppleEvents.typeType) // "colr"
    public static let colorTable = KEYSymbol(name: "colorTable", code: 0x636c7274, type: AppleEvents.typeType) // "clrt"
    public static let column = KEYSymbol(name: "column", code: 0x4e4d436f, type: AppleEvents.typeType) // "NMCo"
    public static let columnCount = KEYSymbol(name: "columnCount", code: 0x4e6d5463, type: AppleEvents.typeType) // "NmTc"
    public static let compressionFactor = KEYSymbol(name: "compressionFactor", code: 0x4b786963, type: AppleEvents.typeType) // "Kxic"
    public static let constant = KEYSymbol(name: "constant", code: 0x656e756d, type: AppleEvents.typeType) // "enum"
    public static let copies = KEYSymbol(name: "copies", code: 0x6c776370, type: AppleEvents.typeType) // "lwcp"
    public static let currentSlide = KEYSymbol(name: "currentSlide", code: 0x6372736c, type: AppleEvents.typeType) // "crsl"
    public static let dashStyle = KEYSymbol(name: "dashStyle", code: 0x74646173, type: AppleEvents.typeType) // "tdas"
    public static let data = KEYSymbol(name: "data", code: 0x74647461, type: AppleEvents.typeType) // "tdta"
    public static let date = KEYSymbol(name: "date", code: 0x6c647420, type: AppleEvents.typeType) // "ldt "
    public static let date_ = KEYSymbol(name: "date_", code: 0x4b787064, type: AppleEvents.typeType) // "Kxpd"
    public static let December = KEYSymbol(name: "December", code: 0x64656320, type: AppleEvents.typeType) // "dec "
    public static let decimalStruct = KEYSymbol(name: "decimalStruct", code: 0x6465636d, type: AppleEvents.typeType) // "decm"
    public static let defaultBodyItem = KEYSymbol(name: "defaultBodyItem", code: 0x73646269, type: AppleEvents.typeType) // "sdbi"
    public static let defaultTitleItem = KEYSymbol(name: "defaultTitleItem", code: 0x73647469, type: AppleEvents.typeType) // "sdti"
    public static let description_ = KEYSymbol(name: "description_", code: 0x64736372, type: AppleEvents.typeType) // "dscr"
    public static let document = KEYSymbol(name: "document", code: 0x646f6375, type: AppleEvents.typeType) // "docu"
    public static let documentTheme = KEYSymbol(name: "documentTheme", code: 0x4b6e6474, type: AppleEvents.typeType) // "Kndt"
    public static let doubleInteger = KEYSymbol(name: "doubleInteger", code: 0x636f6d70, type: AppleEvents.typeType) // "comp"
    public static let encodedString = KEYSymbol(name: "encodedString", code: 0x656e6373, type: AppleEvents.typeType) // "encs"
    public static let endingPage = KEYSymbol(name: "endingPage", code: 0x6c776c70, type: AppleEvents.typeType) // "lwlp"
    public static let endPoint = KEYSymbol(name: "endPoint", code: 0x6c6e6570, type: AppleEvents.typeType) // "lnep"
    public static let EPSPicture = KEYSymbol(name: "EPSPicture", code: 0x45505320, type: AppleEvents.typeType) // "EPS "
    public static let errorHandling = KEYSymbol(name: "errorHandling", code: 0x6c776568, type: AppleEvents.typeType) // "lweh"
    public static let exportOptions = KEYSymbol(name: "exportOptions", code: 0x4b786f70, type: AppleEvents.typeType) // "Kxop"
    public static let exportStyle = KEYSymbol(name: "exportStyle", code: 0x4b787077, type: AppleEvents.typeType) // "Kxpw"
    public static let faxNumber = KEYSymbol(name: "faxNumber", code: 0x6661786e, type: AppleEvents.typeType) // "faxn"
    public static let February = KEYSymbol(name: "February", code: 0x66656220, type: AppleEvents.typeType) // "feb "
    public static let file = KEYSymbol(name: "file", code: 0x66696c65, type: AppleEvents.typeType) // "file"
    public static let fileName = KEYSymbol(name: "fileName", code: 0x6174666e, type: AppleEvents.typeType) // "atfn"
    public static let fileRef = KEYSymbol(name: "fileRef", code: 0x66737266, type: AppleEvents.typeType) // "fsrf"
    public static let fileURL = KEYSymbol(name: "fileURL", code: 0x6675726c, type: AppleEvents.typeType) // "furl"
    public static let fixed = KEYSymbol(name: "fixed", code: 0x66697864, type: AppleEvents.typeType) // "fixd"
    public static let fixedPoint = KEYSymbol(name: "fixedPoint", code: 0x66706e74, type: AppleEvents.typeType) // "fpnt"
    public static let fixedRectangle = KEYSymbol(name: "fixedRectangle", code: 0x66726374, type: AppleEvents.typeType) // "frct"
    public static let font = KEYSymbol(name: "font", code: 0x666f6e74, type: AppleEvents.typeType) // "font"
    public static let fontName = KEYSymbol(name: "fontName", code: 0x4e4d666e, type: AppleEvents.typeType) // "NMfn"
    public static let fontSize = KEYSymbol(name: "fontSize", code: 0x4e4d6673, type: AppleEvents.typeType) // "NMfs"
    public static let footerRowCount = KEYSymbol(name: "footerRowCount", code: 0x4e6d4672, type: AppleEvents.typeType) // "NmFr"
    public static let format = KEYSymbol(name: "format", code: 0x4e4d4354, type: AppleEvents.typeType) // "NMCT"
    public static let formattedValue = KEYSymbol(name: "formattedValue", code: 0x4e4d6676, type: AppleEvents.typeType) // "NMfv"
    public static let formula = KEYSymbol(name: "formula", code: 0x4e4d4366, type: AppleEvents.typeType) // "NMCf"
    public static let Friday = KEYSymbol(name: "Friday", code: 0x66726920, type: AppleEvents.typeType) // "fri "
    public static let frontmost = KEYSymbol(name: "frontmost", code: 0x70697366, type: AppleEvents.typeType) // "pisf"
    public static let frozen = KEYSymbol(name: "frozen", code: 0x46727a6e, type: AppleEvents.typeType) // "Frzn"
    public static let GIFPicture = KEYSymbol(name: "GIFPicture", code: 0x47494666, type: AppleEvents.typeType) // "GIFf"
    public static let graphicText = KEYSymbol(name: "graphicText", code: 0x63677478, type: AppleEvents.typeType) // "cgtx"
    public static let group = KEYSymbol(name: "group", code: 0x69677270, type: AppleEvents.typeType) // "igrp"
    public static let headerColumnCount = KEYSymbol(name: "headerColumnCount", code: 0x4e6d4843, type: AppleEvents.typeType) // "NmHC"
    public static let headerRowCount = KEYSymbol(name: "headerRowCount", code: 0x4e6d4872, type: AppleEvents.typeType) // "NmHr"
    public static let height = KEYSymbol(name: "height", code: 0x73697468, type: AppleEvents.typeType) // "sith"
    public static let id = KEYSymbol(name: "id", code: 0x49442020, type: AppleEvents.typeType) // "ID  "
    public static let image = KEYSymbol(name: "image", code: 0x696d6167, type: AppleEvents.typeType) // "imag"
    public static let imageFormat = KEYSymbol(name: "imageFormat", code: 0x4b786966, type: AppleEvents.typeType) // "Kxif"
    public static let index = KEYSymbol(name: "index", code: 0x70696478, type: AppleEvents.typeType) // "pidx"
    public static let integer = KEYSymbol(name: "integer", code: 0x6c6f6e67, type: AppleEvents.typeType) // "long"
    public static let internationalText = KEYSymbol(name: "internationalText", code: 0x69747874, type: AppleEvents.typeType) // "itxt"
    public static let internationalWritingCode = KEYSymbol(name: "internationalWritingCode", code: 0x696e746c, type: AppleEvents.typeType) // "intl"
    public static let item = KEYSymbol(name: "item", code: 0x636f626a, type: AppleEvents.typeType) // "cobj"
    public static let iWorkContainer = KEYSymbol(name: "iWorkContainer", code: 0x69776b63, type: AppleEvents.typeType) // "iwkc"
    public static let iWorkItem = KEYSymbol(name: "iWorkItem", code: 0x666d7469, type: AppleEvents.typeType) // "fmti"
    public static let January = KEYSymbol(name: "January", code: 0x6a616e20, type: AppleEvents.typeType) // "jan "
    public static let JPEGPicture = KEYSymbol(name: "JPEGPicture", code: 0x4a504547, type: AppleEvents.typeType) // "JPEG"
    public static let July = KEYSymbol(name: "July", code: 0x6a756c20, type: AppleEvents.typeType) // "jul "
    public static let June = KEYSymbol(name: "June", code: 0x6a756e20, type: AppleEvents.typeType) // "jun "
    public static let kernelProcessID = KEYSymbol(name: "kernelProcessID", code: 0x6b706964, type: AppleEvents.typeType) // "kpid"
    public static let largeReal = KEYSymbol(name: "largeReal", code: 0x6c64626c, type: AppleEvents.typeType) // "ldbl"
    public static let line = KEYSymbol(name: "line", code: 0x69576c6e, type: AppleEvents.typeType) // "iWln"
    public static let list = KEYSymbol(name: "list", code: 0x6c697374, type: AppleEvents.typeType) // "list"
    public static let locationReference = KEYSymbol(name: "locationReference", code: 0x696e736c, type: AppleEvents.typeType) // "insl"
    public static let locked = KEYSymbol(name: "locked", code: 0x704c636b, type: AppleEvents.typeType) // "pLck"
    public static let longFixed = KEYSymbol(name: "longFixed", code: 0x6c667864, type: AppleEvents.typeType) // "lfxd"
    public static let longFixedPoint = KEYSymbol(name: "longFixedPoint", code: 0x6c667074, type: AppleEvents.typeType) // "lfpt"
    public static let longFixedRectangle = KEYSymbol(name: "longFixedRectangle", code: 0x6c667263, type: AppleEvents.typeType) // "lfrc"
    public static let longPoint = KEYSymbol(name: "longPoint", code: 0x6c706e74, type: AppleEvents.typeType) // "lpnt"
    public static let longRectangle = KEYSymbol(name: "longRectangle", code: 0x6c726374, type: AppleEvents.typeType) // "lrct"
    public static let machine = KEYSymbol(name: "machine", code: 0x6d616368, type: AppleEvents.typeType) // "mach"
    public static let machineLocation = KEYSymbol(name: "machineLocation", code: 0x6d4c6f63, type: AppleEvents.typeType) // "mLoc"
    public static let machPort = KEYSymbol(name: "machPort", code: 0x706f7274, type: AppleEvents.typeType) // "port"
    public static let March = KEYSymbol(name: "March", code: 0x6d617220, type: AppleEvents.typeType) // "mar "
    public static let masterSlide = KEYSymbol(name: "masterSlide", code: 0x4b6e4d73, type: AppleEvents.typeType) // "KnMs"
    public static let maximumIdleDuration = KEYSymbol(name: "maximumIdleDuration", code: 0x6d696472, type: AppleEvents.typeType) // "midr"
    public static let May = KEYSymbol(name: "May", code: 0x6d617920, type: AppleEvents.typeType) // "may "
    public static let miniaturizable = KEYSymbol(name: "miniaturizable", code: 0x69736d6e, type: AppleEvents.typeType) // "ismn"
    public static let miniaturized = KEYSymbol(name: "miniaturized", code: 0x706d6e64, type: AppleEvents.typeType) // "pmnd"
    public static let modified = KEYSymbol(name: "modified", code: 0x696d6f64, type: AppleEvents.typeType) // "imod"
    public static let Monday = KEYSymbol(name: "Monday", code: 0x6d6f6e20, type: AppleEvents.typeType) // "mon "
    public static let movie = KEYSymbol(name: "movie", code: 0x73686d76, type: AppleEvents.typeType) // "shmv"
    public static let movieFormat = KEYSymbol(name: "movieFormat", code: 0x4b786d66, type: AppleEvents.typeType) // "Kxmf"
    public static let movieVolume = KEYSymbol(name: "movieVolume", code: 0x6d766f6c, type: AppleEvents.typeType) // "mvol"
    public static let name = KEYSymbol(name: "name", code: 0x706e616d, type: AppleEvents.typeType) // "pnam"
    public static let November = KEYSymbol(name: "November", code: 0x6e6f7620, type: AppleEvents.typeType) // "nov "
    public static let null = KEYSymbol(name: "null", code: 0x6e756c6c, type: AppleEvents.typeType) // "null"
    public static let objectText = KEYSymbol(name: "objectText", code: 0x70445478, type: AppleEvents.typeType) // "pDTx"
    public static let October = KEYSymbol(name: "October", code: 0x6f637420, type: AppleEvents.typeType) // "oct "
    public static let opacity = KEYSymbol(name: "opacity", code: 0x70534f70, type: AppleEvents.typeType) // "pSOp"
    public static let pagesAcross = KEYSymbol(name: "pagesAcross", code: 0x6c776c61, type: AppleEvents.typeType) // "lwla"
    public static let pagesDown = KEYSymbol(name: "pagesDown", code: 0x6c776c64, type: AppleEvents.typeType) // "lwld"
    public static let paragraph = KEYSymbol(name: "paragraph", code: 0x63706172, type: AppleEvents.typeType) // "cpar"
    public static let parent = KEYSymbol(name: "parent", code: 0x73697074, type: AppleEvents.typeType) // "sipt"
    public static let password = KEYSymbol(name: "password", code: 0x4b785057, type: AppleEvents.typeType) // "KxPW"
    public static let passwordHint = KEYSymbol(name: "passwordHint", code: 0x4b785048, type: AppleEvents.typeType) // "KxPH"
    public static let PDFImageQuality = KEYSymbol(name: "PDFImageQuality", code: 0x4b785049, type: AppleEvents.typeType) // "KxPI"
    public static let PICTPicture = KEYSymbol(name: "PICTPicture", code: 0x50494354, type: AppleEvents.typeType) // "PICT"
    public static let pixelMapRecord = KEYSymbol(name: "pixelMapRecord", code: 0x74706d6d, type: AppleEvents.typeType) // "tpmm"
    public static let playing = KEYSymbol(name: "playing", code: 0x506c6e67, type: AppleEvents.typeType) // "Plng"
    public static let point = KEYSymbol(name: "point", code: 0x51447074, type: AppleEvents.typeType) // "QDpt"
    public static let position = KEYSymbol(name: "position", code: 0x7369706f, type: AppleEvents.typeType) // "sipo"
    public static let presenterNotes = KEYSymbol(name: "presenterNotes", code: 0x6b736e74, type: AppleEvents.typeType) // "ksnt"
    public static let printSettings = KEYSymbol(name: "printSettings", code: 0x70736574, type: AppleEvents.typeType) // "pset"
    public static let processSerialNumber = KEYSymbol(name: "processSerialNumber", code: 0x70736e20, type: AppleEvents.typeType) // "psn "
    public static let properties = KEYSymbol(name: "properties", code: 0x70414c4c, type: AppleEvents.typeType) // "pALL"
    public static let property_ = KEYSymbol(name: "property_", code: 0x70726f70, type: AppleEvents.typeType) // "prop"
    public static let range = KEYSymbol(name: "range", code: 0x4e6d4352, type: AppleEvents.typeType) // "NmCR"
    public static let rawKPF = KEYSymbol(name: "rawKPF", code: 0x4b786b66, type: AppleEvents.typeType) // "Kxkf"
    public static let real = KEYSymbol(name: "real", code: 0x646f7562, type: AppleEvents.typeType) // "doub"
    public static let record = KEYSymbol(name: "record", code: 0x7265636f, type: AppleEvents.typeType) // "reco"
    public static let reference = KEYSymbol(name: "reference", code: 0x6f626a20, type: AppleEvents.typeType) // "obj "
    public static let reflectionShowing = KEYSymbol(name: "reflectionShowing", code: 0x73697273, type: AppleEvents.typeType) // "sirs"
    public static let reflectionValue = KEYSymbol(name: "reflectionValue", code: 0x73697276, type: AppleEvents.typeType) // "sirv"
    public static let repetitionMethod = KEYSymbol(name: "repetitionMethod", code: 0x6d767270, type: AppleEvents.typeType) // "mvrp"
    public static let requestedPrintTime = KEYSymbol(name: "requestedPrintTime", code: 0x6c777174, type: AppleEvents.typeType) // "lwqt"
    public static let resizable = KEYSymbol(name: "resizable", code: 0x7072737a, type: AppleEvents.typeType) // "prsz"
    public static let RGB16Color = KEYSymbol(name: "RGB16Color", code: 0x74723136, type: AppleEvents.typeType) // "tr16"
    public static let RGB96Color = KEYSymbol(name: "RGB96Color", code: 0x74723936, type: AppleEvents.typeType) // "tr96"
    public static let RGBColor = KEYSymbol(name: "RGBColor", code: 0x63524742, type: AppleEvents.typeType) // "cRGB"
    public static let richText = KEYSymbol(name: "richText", code: 0x72747874, type: AppleEvents.typeType) // "rtxt"
    public static let rotation = KEYSymbol(name: "rotation", code: 0x74726f74, type: AppleEvents.typeType) // "trot"
    public static let rotation_ = KEYSymbol(name: "rotation_", code: 0x7369726f, type: AppleEvents.typeType) // "siro"
    public static let row = KEYSymbol(name: "row", code: 0x4e4d5277, type: AppleEvents.typeType) // "NMRw"
    public static let rowCount = KEYSymbol(name: "rowCount", code: 0x4e6d5472, type: AppleEvents.typeType) // "NmTr"
    public static let Saturday = KEYSymbol(name: "Saturday", code: 0x73617420, type: AppleEvents.typeType) // "sat "
    public static let script = KEYSymbol(name: "script", code: 0x73637074, type: AppleEvents.typeType) // "scpt"
    public static let selection = KEYSymbol(name: "selection", code: 0x73656c65, type: AppleEvents.typeType) // "sele"
    public static let selectionRange = KEYSymbol(name: "selectionRange", code: 0x4e4d5473, type: AppleEvents.typeType) // "NMTs"
    public static let September = KEYSymbol(name: "September", code: 0x73657020, type: AppleEvents.typeType) // "sep "
    public static let shape = KEYSymbol(name: "shape", code: 0x73736870, type: AppleEvents.typeType) // "sshp"
    public static let shortInteger = KEYSymbol(name: "shortInteger", code: 0x73686f72, type: AppleEvents.typeType) // "shor"
    public static let size = KEYSymbol(name: "size", code: 0x7074737a, type: AppleEvents.typeType) // "ptsz"
    public static let skipped = KEYSymbol(name: "skipped", code: 0x4b736b70, type: AppleEvents.typeType) // "Kskp"
    public static let skippedSlides = KEYSymbol(name: "skippedSlides", code: 0x4b787073, type: AppleEvents.typeType) // "Kxps"
    public static let slide = KEYSymbol(name: "slide", code: 0x4b6e5364, type: AppleEvents.typeType) // "KnSd"
    public static let slideNumber = KEYSymbol(name: "slideNumber", code: 0x4b53644e, type: AppleEvents.typeType) // "KSdN"
    public static let slideNumbers = KEYSymbol(name: "slideNumbers", code: 0x4b78706e, type: AppleEvents.typeType) // "Kxpn"
    public static let slideNumbersShowing = KEYSymbol(name: "slideNumbersShowing", code: 0x4b6e7368, type: AppleEvents.typeType) // "Knsh"
    public static let slideSwitcherVisible = KEYSymbol(name: "slideSwitcherVisible", code: 0x53737673, type: AppleEvents.typeType) // "Ssvs"
    public static let smallReal = KEYSymbol(name: "smallReal", code: 0x73696e67, type: AppleEvents.typeType) // "sing"
    public static let startingPage = KEYSymbol(name: "startingPage", code: 0x6c776670, type: AppleEvents.typeType) // "lwfp"
    public static let startPoint = KEYSymbol(name: "startPoint", code: 0x6c6e7370, type: AppleEvents.typeType) // "lnsp"
    public static let string = KEYSymbol(name: "string", code: 0x54455854, type: AppleEvents.typeType) // "TEXT"
    public static let styledClipboardText = KEYSymbol(name: "styledClipboardText", code: 0x7374796c, type: AppleEvents.typeType) // "styl"
    public static let styledText = KEYSymbol(name: "styledText", code: 0x53545854, type: AppleEvents.typeType) // "STXT"
    public static let Sunday = KEYSymbol(name: "Sunday", code: 0x73756e20, type: AppleEvents.typeType) // "sun "
    public static let table = KEYSymbol(name: "table", code: 0x4e6d5462, type: AppleEvents.typeType) // "NmTb"
    public static let targetPrinter = KEYSymbol(name: "targetPrinter", code: 0x74727072, type: AppleEvents.typeType) // "trpr"
    public static let textColor = KEYSymbol(name: "textColor", code: 0x74657843, type: AppleEvents.typeType) // "texC"
    public static let textItem = KEYSymbol(name: "textItem", code: 0x73687478, type: AppleEvents.typeType) // "shtx"
    public static let textStyleInfo = KEYSymbol(name: "textStyleInfo", code: 0x74737479, type: AppleEvents.typeType) // "tsty"
    public static let textWrap = KEYSymbol(name: "textWrap", code: 0x77726170, type: AppleEvents.typeType) // "wrap"
    public static let theme = KEYSymbol(name: "theme", code: 0x4b6e7468, type: AppleEvents.typeType) // "Knth"
    public static let Thursday = KEYSymbol(name: "Thursday", code: 0x74687520, type: AppleEvents.typeType) // "thu "
    public static let TIFFPicture = KEYSymbol(name: "TIFFPicture", code: 0x54494646, type: AppleEvents.typeType) // "TIFF"
    public static let titleShowing = KEYSymbol(name: "titleShowing", code: 0x4b747368, type: AppleEvents.typeType) // "Ktsh"
    public static let transitionDelay = KEYSymbol(name: "transitionDelay", code: 0x78646c79, type: AppleEvents.typeType) // "xdly"
    public static let transitionDuration = KEYSymbol(name: "transitionDuration", code: 0x78647572, type: AppleEvents.typeType) // "xdur"
    public static let transitionEffect = KEYSymbol(name: "transitionEffect", code: 0x78656674, type: AppleEvents.typeType) // "xeft"
    public static let transitionProperties = KEYSymbol(name: "transitionProperties", code: 0x7374726e, type: AppleEvents.typeType) // "strn"
    public static let transitionSettings = KEYSymbol(name: "transitionSettings", code: 0x78736574, type: AppleEvents.typeType) // "xset"
    public static let Tuesday = KEYSymbol(name: "Tuesday", code: 0x74756520, type: AppleEvents.typeType) // "tue "
    public static let typeClass = KEYSymbol(name: "typeClass", code: 0x74797065, type: AppleEvents.typeType) // "type"
    public static let UnicodeText = KEYSymbol(name: "UnicodeText", code: 0x75747874, type: AppleEvents.typeType) // "utxt"
    public static let unsignedDoubleInteger = KEYSymbol(name: "unsignedDoubleInteger", code: 0x75636f6d, type: AppleEvents.typeType) // "ucom"
    public static let unsignedInteger = KEYSymbol(name: "unsignedInteger", code: 0x6d61676e, type: AppleEvents.typeType) // "magn"
    public static let unsignedShortInteger = KEYSymbol(name: "unsignedShortInteger", code: 0x75736872, type: AppleEvents.typeType) // "ushr"
    public static let UTF16Text = KEYSymbol(name: "UTF16Text", code: 0x75743136, type: AppleEvents.typeType) // "ut16"
    public static let UTF8Text = KEYSymbol(name: "UTF8Text", code: 0x75746638, type: AppleEvents.typeType) // "utf8"
    public static let value = KEYSymbol(name: "value", code: 0x4e4d4376, type: AppleEvents.typeType) // "NMCv"
    public static let version = KEYSymbol(name: "version", code: 0x76657273, type: AppleEvents.typeType) // "vers"
    public static let verticalAlignment = KEYSymbol(name: "verticalAlignment", code: 0x74785641, type: AppleEvents.typeType) // "txVA"
    public static let visible = KEYSymbol(name: "visible", code: 0x70766973, type: AppleEvents.typeType) // "pvis"
    public static let Wednesday = KEYSymbol(name: "Wednesday", code: 0x77656420, type: AppleEvents.typeType) // "wed "
    public static let width = KEYSymbol(name: "width", code: 0x73697477, type: AppleEvents.typeType) // "sitw"
    public static let window = KEYSymbol(name: "window", code: 0x6377696e, type: AppleEvents.typeType) // "cwin"
    public static let word = KEYSymbol(name: "word", code: 0x63776f72, type: AppleEvents.typeType) // "cwor"
    public static let writingCode = KEYSymbol(name: "writingCode", code: 0x70736374, type: AppleEvents.typeType) // "psct"
    public static let zoomable = KEYSymbol(name: "zoomable", code: 0x69737a6d, type: AppleEvents.typeType) // "iszm"
    public static let zoomed = KEYSymbol(name: "zoomed", code: 0x707a756d, type: AppleEvents.typeType) // "pzum"

    // Enumerators
    public static let _1080p_ = KEYSymbol(name: "_1080p_", code: 0x4b6d6638, type: AppleEvents.typeEnumerated) // "Kmf8"
    public static let _2160p_ = KEYSymbol(name: "_2160p_", code: 0x4b6d6634, type: AppleEvents.typeEnumerated) // "Kmf4"
    public static let _360p_ = KEYSymbol(name: "_360p_", code: 0x4b6d6633, type: AppleEvents.typeEnumerated) // "Kmf3"
    public static let _540p_ = KEYSymbol(name: "_540p_", code: 0x4b6d6635, type: AppleEvents.typeEnumerated) // "Kmf5"
    public static let _720p_ = KEYSymbol(name: "_720p_", code: 0x4b6d6637, type: AppleEvents.typeEnumerated) // "Kmf7"
    public static let advancedGradientFill = KEYSymbol(name: "advancedGradientFill", code: 0x66696167, type: AppleEvents.typeEnumerated) // "fiag"
    public static let advancedImageFill = KEYSymbol(name: "advancedImageFill", code: 0x66696169, type: AppleEvents.typeEnumerated) // "fiai"
    public static let area_2d = KEYSymbol(name: "area_2d", code: 0x61726532, type: AppleEvents.typeEnumerated) // "are2"
    public static let area_3d = KEYSymbol(name: "area_3d", code: 0x61726533, type: AppleEvents.typeEnumerated) // "are3"
    public static let ascending = KEYSymbol(name: "ascending", code: 0x6173636e, type: AppleEvents.typeEnumerated) // "ascn"
    public static let ask = KEYSymbol(name: "ask", code: 0x61736b20, type: AppleEvents.typeEnumerated) // "ask "
    public static let autoAlign = KEYSymbol(name: "autoAlign", code: 0x61617574, type: AppleEvents.typeEnumerated) // "aaut"
    public static let automatic = KEYSymbol(name: "automatic", code: 0x66617574, type: AppleEvents.typeEnumerated) // "faut"
    public static let Best = KEYSymbol(name: "Best", code: 0x4b6e5032, type: AppleEvents.typeEnumerated) // "KnP2"
    public static let Better = KEYSymbol(name: "Better", code: 0x4b6e5031, type: AppleEvents.typeEnumerated) // "KnP1"
    public static let blinds = KEYSymbol(name: "blinds", code: 0x74626c64, type: AppleEvents.typeEnumerated) // "tbld"
    public static let bottom = KEYSymbol(name: "bottom", code: 0x61766274, type: AppleEvents.typeEnumerated) // "avbt"
    public static let case_ = KEYSymbol(name: "case_", code: 0x63617365, type: AppleEvents.typeEnumerated) // "case"
    public static let center = KEYSymbol(name: "center", code: 0x61637472, type: AppleEvents.typeEnumerated) // "actr"
    public static let chartColumn = KEYSymbol(name: "chartColumn", code: 0x4b436763, type: AppleEvents.typeEnumerated) // "KCgc"
    public static let chartRow = KEYSymbol(name: "chartRow", code: 0x4b436772, type: AppleEvents.typeEnumerated) // "KCgr"
    public static let checkbox = KEYSymbol(name: "checkbox", code: 0x66636368, type: AppleEvents.typeEnumerated) // "fcch"
    public static let clothesline = KEYSymbol(name: "clothesline", code: 0x74636c6f, type: AppleEvents.typeEnumerated) // "tclo"
    public static let colorFill = KEYSymbol(name: "colorFill", code: 0x6669636f, type: AppleEvents.typeEnumerated) // "fico"
    public static let colorPlanes = KEYSymbol(name: "colorPlanes", code: 0x7463706c, type: AppleEvents.typeEnumerated) // "tcpl"
    public static let confetti = KEYSymbol(name: "confetti", code: 0x74636674, type: AppleEvents.typeEnumerated) // "tcft"
    public static let cube = KEYSymbol(name: "cube", code: 0x74637562, type: AppleEvents.typeEnumerated) // "tcub"
    public static let currency = KEYSymbol(name: "currency", code: 0x66637572, type: AppleEvents.typeEnumerated) // "fcur"
    public static let dateAndTime = KEYSymbol(name: "dateAndTime", code: 0x6664746d, type: AppleEvents.typeEnumerated) // "fdtm"
    public static let descending = KEYSymbol(name: "descending", code: 0x6473636e, type: AppleEvents.typeEnumerated) // "dscn"
    public static let detailed = KEYSymbol(name: "detailed", code: 0x6c776474, type: AppleEvents.typeEnumerated) // "lwdt"
    public static let diacriticals = KEYSymbol(name: "diacriticals", code: 0x64696163, type: AppleEvents.typeEnumerated) // "diac"
    public static let dissolve = KEYSymbol(name: "dissolve", code: 0x74646973, type: AppleEvents.typeEnumerated) // "tdis"
    public static let doorway = KEYSymbol(name: "doorway", code: 0x74647779, type: AppleEvents.typeEnumerated) // "tdwy"
    public static let drop = KEYSymbol(name: "drop", code: 0x74647270, type: AppleEvents.typeEnumerated) // "tdrp"
    public static let droplet = KEYSymbol(name: "droplet", code: 0x7464706c, type: AppleEvents.typeEnumerated) // "tdpl"
    public static let duration = KEYSymbol(name: "duration", code: 0x66647572, type: AppleEvents.typeEnumerated) // "fdur"
    public static let expansion = KEYSymbol(name: "expansion", code: 0x65787061, type: AppleEvents.typeEnumerated) // "expa"
    public static let fadeAndMove = KEYSymbol(name: "fadeAndMove", code: 0x74666164, type: AppleEvents.typeEnumerated) // "tfad"
    public static let fadeThroughColor = KEYSymbol(name: "fadeThroughColor", code: 0x74667463, type: AppleEvents.typeEnumerated) // "tftc"
    public static let fall = KEYSymbol(name: "fall", code: 0x7466616c, type: AppleEvents.typeEnumerated) // "tfal"
    public static let flip = KEYSymbol(name: "flip", code: 0x74666970, type: AppleEvents.typeEnumerated) // "tfip"
    public static let flop = KEYSymbol(name: "flop", code: 0x74666f70, type: AppleEvents.typeEnumerated) // "tfop"
    public static let fraction = KEYSymbol(name: "fraction", code: 0x66667261, type: AppleEvents.typeEnumerated) // "ffra"
    public static let Good = KEYSymbol(name: "Good", code: 0x4b6e5030, type: AppleEvents.typeEnumerated) // "KnP0"
    public static let gradientFill = KEYSymbol(name: "gradientFill", code: 0x66696772, type: AppleEvents.typeEnumerated) // "figr"
    public static let grid = KEYSymbol(name: "grid", code: 0x74677264, type: AppleEvents.typeEnumerated) // "tgrd"
    public static let Handouts = KEYSymbol(name: "Handouts", code: 0x4b707768, type: AppleEvents.typeEnumerated) // "Kpwh"
    public static let horizontal_bar_2d = KEYSymbol(name: "horizontal_bar_2d", code: 0x68627232, type: AppleEvents.typeEnumerated) // "hbr2"
    public static let horizontal_bar_3d = KEYSymbol(name: "horizontal_bar_3d", code: 0x68627233, type: AppleEvents.typeEnumerated) // "hbr3"
    public static let HTML = KEYSymbol(name: "HTML", code: 0x4b68746d, type: AppleEvents.typeEnumerated) // "Khtm"
    public static let hyphens = KEYSymbol(name: "hyphens", code: 0x68797068, type: AppleEvents.typeEnumerated) // "hyph"
    public static let imageFill = KEYSymbol(name: "imageFill", code: 0x6669696d, type: AppleEvents.typeEnumerated) // "fiim"
    public static let IndividualSlides = KEYSymbol(name: "IndividualSlides", code: 0x4b707769, type: AppleEvents.typeEnumerated) // "Kpwi"
    public static let iris = KEYSymbol(name: "iris", code: 0x74697273, type: AppleEvents.typeEnumerated) // "tirs"
    public static let JPEG = KEYSymbol(name: "JPEG", code: 0x4b69666a, type: AppleEvents.typeEnumerated) // "Kifj"
    public static let justify = KEYSymbol(name: "justify", code: 0x616a7374, type: AppleEvents.typeEnumerated) // "ajst"
    public static let Keynote = KEYSymbol(name: "Keynote", code: 0x4b6e6666, type: AppleEvents.typeEnumerated) // "Knff"
    public static let Keynote09 = KEYSymbol(name: "Keynote09", code: 0x4b6b6579, type: AppleEvents.typeEnumerated) // "Kkey"
    public static let left = KEYSymbol(name: "left", code: 0x616c6674, type: AppleEvents.typeEnumerated) // "alft"
    public static let line_2d = KEYSymbol(name: "line_2d", code: 0x6c696e32, type: AppleEvents.typeEnumerated) // "lin2"
    public static let line_3d = KEYSymbol(name: "line_3d", code: 0x6c696e33, type: AppleEvents.typeEnumerated) // "lin3"
    public static let loop = KEYSymbol(name: "loop", code: 0x6d766c70, type: AppleEvents.typeEnumerated) // "mvlp"
    public static let loopBackAndForth = KEYSymbol(name: "loopBackAndForth", code: 0x6d766266, type: AppleEvents.typeEnumerated) // "mvbf"
    public static let magicMove = KEYSymbol(name: "magicMove", code: 0x746d6a76, type: AppleEvents.typeEnumerated) // "tmjv"
    public static let MicrosoftPowerPoint = KEYSymbol(name: "MicrosoftPowerPoint", code: 0x4b707074, type: AppleEvents.typeEnumerated) // "Kppt"
    public static let mosaic = KEYSymbol(name: "mosaic", code: 0x746d7363, type: AppleEvents.typeEnumerated) // "tmsc"
    public static let moveIn = KEYSymbol(name: "moveIn", code: 0x746d7669, type: AppleEvents.typeEnumerated) // "tmvi"
    public static let nativeSize = KEYSymbol(name: "nativeSize", code: 0x4b6d664e, type: AppleEvents.typeEnumerated) // "KmfN"
    public static let no = KEYSymbol(name: "no", code: 0x6e6f2020, type: AppleEvents.typeEnumerated) // "no  "
    public static let noFill = KEYSymbol(name: "noFill", code: 0x66696e6f, type: AppleEvents.typeEnumerated) // "fino"
    public static let none = KEYSymbol(name: "none", code: 0x6d76726e, type: AppleEvents.typeEnumerated) // "mvrn"
    public static let noTransitionEffect = KEYSymbol(name: "noTransitionEffect", code: 0x746e696c, type: AppleEvents.typeEnumerated) // "tnil"
    public static let number = KEYSymbol(name: "number", code: 0x6e6d6272, type: AppleEvents.typeEnumerated) // "nmbr"
    public static let numeralSystem = KEYSymbol(name: "numeralSystem", code: 0x66636e73, type: AppleEvents.typeEnumerated) // "fcns"
    public static let numericStrings = KEYSymbol(name: "numericStrings", code: 0x6e756d65, type: AppleEvents.typeEnumerated) // "nume"
    public static let objectCube = KEYSymbol(name: "objectCube", code: 0x746f6362, type: AppleEvents.typeEnumerated) // "tocb"
    public static let objectFlip = KEYSymbol(name: "objectFlip", code: 0x746f6670, type: AppleEvents.typeEnumerated) // "tofp"
    public static let objectPop = KEYSymbol(name: "objectPop", code: 0x746f7070, type: AppleEvents.typeEnumerated) // "topp"
    public static let objectPush = KEYSymbol(name: "objectPush", code: 0x746f7068, type: AppleEvents.typeEnumerated) // "toph"
    public static let objectRevolve = KEYSymbol(name: "objectRevolve", code: 0x746f7276, type: AppleEvents.typeEnumerated) // "torv"
    public static let objectZoom = KEYSymbol(name: "objectZoom", code: 0x746f7a6d, type: AppleEvents.typeEnumerated) // "tozm"
    public static let pageFlip = KEYSymbol(name: "pageFlip", code: 0x7470666c, type: AppleEvents.typeEnumerated) // "tpfl"
    public static let PDF = KEYSymbol(name: "PDF", code: 0x4b706466, type: AppleEvents.typeEnumerated) // "Kpdf"
    public static let percent = KEYSymbol(name: "percent", code: 0x66706572, type: AppleEvents.typeEnumerated) // "fper"
    public static let perspective = KEYSymbol(name: "perspective", code: 0x74707273, type: AppleEvents.typeEnumerated) // "tprs"
    public static let pie_2d = KEYSymbol(name: "pie_2d", code: 0x70696532, type: AppleEvents.typeEnumerated) // "pie2"
    public static let pie_3d = KEYSymbol(name: "pie_3d", code: 0x70696533, type: AppleEvents.typeEnumerated) // "pie3"
    public static let pivot = KEYSymbol(name: "pivot", code: 0x74707674, type: AppleEvents.typeEnumerated) // "tpvt"
    public static let PNG = KEYSymbol(name: "PNG", code: 0x4b696670, type: AppleEvents.typeEnumerated) // "Kifp"
    public static let popUpMenu = KEYSymbol(name: "popUpMenu", code: 0x66637070, type: AppleEvents.typeEnumerated) // "fcpp"
    public static let punctuation = KEYSymbol(name: "punctuation", code: 0x70756e63, type: AppleEvents.typeEnumerated) // "punc"
    public static let push = KEYSymbol(name: "push", code: 0x74707368, type: AppleEvents.typeEnumerated) // "tpsh"
    public static let QuickTimeMovie = KEYSymbol(name: "QuickTimeMovie", code: 0x4b6d6f76, type: AppleEvents.typeEnumerated) // "Kmov"
    public static let rating = KEYSymbol(name: "rating", code: 0x66726174, type: AppleEvents.typeEnumerated) // "frat"
    public static let reflection = KEYSymbol(name: "reflection", code: 0x7472666c, type: AppleEvents.typeEnumerated) // "trfl"
    public static let reveal = KEYSymbol(name: "reveal", code: 0x7472766c, type: AppleEvents.typeEnumerated) // "trvl"
    public static let revolvingDoor = KEYSymbol(name: "revolvingDoor", code: 0x74726576, type: AppleEvents.typeEnumerated) // "trev"
    public static let right = KEYSymbol(name: "right", code: 0x61726974, type: AppleEvents.typeEnumerated) // "arit"
    public static let scale = KEYSymbol(name: "scale", code: 0x7473636c, type: AppleEvents.typeEnumerated) // "tscl"
    public static let scatterplot_2d = KEYSymbol(name: "scatterplot_2d", code: 0x73637032, type: AppleEvents.typeEnumerated) // "scp2"
    public static let scientific = KEYSymbol(name: "scientific", code: 0x66736369, type: AppleEvents.typeEnumerated) // "fsci"
    public static let shimmer = KEYSymbol(name: "shimmer", code: 0x7473686d, type: AppleEvents.typeEnumerated) // "tshm"
    public static let slideImages = KEYSymbol(name: "slideImages", code: 0x4b696d67, type: AppleEvents.typeEnumerated) // "Kimg"
    public static let slider = KEYSymbol(name: "slider", code: 0x6663736c, type: AppleEvents.typeEnumerated) // "fcsl"
    public static let SlideWithNotes = KEYSymbol(name: "SlideWithNotes", code: 0x4b70776e, type: AppleEvents.typeEnumerated) // "Kpwn"
    public static let sparkle = KEYSymbol(name: "sparkle", code: 0x7473706b, type: AppleEvents.typeEnumerated) // "tspk"
    public static let stacked_area_2d = KEYSymbol(name: "stacked_area_2d", code: 0x73617232, type: AppleEvents.typeEnumerated) // "sar2"
    public static let stacked_area_3d = KEYSymbol(name: "stacked_area_3d", code: 0x73617233, type: AppleEvents.typeEnumerated) // "sar3"
    public static let stacked_horizontal_bar_2d = KEYSymbol(name: "stacked_horizontal_bar_2d", code: 0x73686232, type: AppleEvents.typeEnumerated) // "shb2"
    public static let stacked_horizontal_bar_3d = KEYSymbol(name: "stacked_horizontal_bar_3d", code: 0x73686233, type: AppleEvents.typeEnumerated) // "shb3"
    public static let stacked_vertical_bar_2d = KEYSymbol(name: "stacked_vertical_bar_2d", code: 0x73766232, type: AppleEvents.typeEnumerated) // "svb2"
    public static let stacked_vertical_bar_3d = KEYSymbol(name: "stacked_vertical_bar_3d", code: 0x73766233, type: AppleEvents.typeEnumerated) // "svb3"
    public static let standard = KEYSymbol(name: "standard", code: 0x6c777374, type: AppleEvents.typeEnumerated) // "lwst"
    public static let stepper = KEYSymbol(name: "stepper", code: 0x66637374, type: AppleEvents.typeEnumerated) // "fcst"
    public static let swap = KEYSymbol(name: "swap", code: 0x74737770, type: AppleEvents.typeEnumerated) // "tswp"
    public static let swing = KEYSymbol(name: "swing", code: 0x74737767, type: AppleEvents.typeEnumerated) // "tswg"
    public static let switch_ = KEYSymbol(name: "switch_", code: 0x74737769, type: AppleEvents.typeEnumerated) // "tswi"
    public static let swoosh = KEYSymbol(name: "swoosh", code: 0x74737773, type: AppleEvents.typeEnumerated) // "tsws"
    public static let text = KEYSymbol(name: "text", code: 0x63747874, type: AppleEvents.typeEnumerated) // "ctxt"
    public static let TIFF = KEYSymbol(name: "TIFF", code: 0x4b696674, type: AppleEvents.typeEnumerated) // "Kift"
    public static let top = KEYSymbol(name: "top", code: 0x61767470, type: AppleEvents.typeEnumerated) // "avtp"
    public static let twirl = KEYSymbol(name: "twirl", code: 0x7474776c, type: AppleEvents.typeEnumerated) // "ttwl"
    public static let twist = KEYSymbol(name: "twist", code: 0x74747769, type: AppleEvents.typeEnumerated) // "ttwi"
    public static let vertical_bar_2d = KEYSymbol(name: "vertical_bar_2d", code: 0x76627232, type: AppleEvents.typeEnumerated) // "vbr2"
    public static let vertical_bar_3d = KEYSymbol(name: "vertical_bar_3d", code: 0x76627233, type: AppleEvents.typeEnumerated) // "vbr3"
    public static let whitespace = KEYSymbol(name: "whitespace", code: 0x77686974, type: AppleEvents.typeEnumerated) // "whit"
    public static let wipe = KEYSymbol(name: "wipe", code: 0x74777065, type: AppleEvents.typeEnumerated) // "twpe"
    public static let yes = KEYSymbol(name: "yes", code: 0x79657320, type: AppleEvents.typeEnumerated) // "yes "
}
...
extension KEYCommand {
    @discardableResult public func acceptSlideSwitcher(_ directParameter: Any = SwiftAutomation.noParameter,
        ...
        return try self.appData.sendAppleEvent(name: "acceptSlideSwitcher", event: 0x4b6e7463_61737377, // "Kntcassw"
    ...
    @discardableResult public func addChart(_ directParameter: Any = SwiftAutomation.noParameter,
            ...
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "addChart", event: 0x4b6e7463_41646463, // "KntcAddc"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
    ...
    @discardableResult public func cancelSlideSwitcher(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "cancelSlideSwitcher", event: 0x4b6e7463_63737377, // "Kntccssw"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func clear(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "clear", event: 0x4e6d5462_434c5220, // "NmTbCLR "
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func export(_ directParameter: Any = SwiftAutomation.noParameter,
            ...
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "export", event: 0x4b6e7374_6578706f, // "Knstexpo"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
    ...
    @discardableResult public func hideSlideSwitcher(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "hideSlideSwitcher", event: 0x4b6e7463_63737377, // "Kntccssw"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func makeImageSlides(_ directParameter: Any = SwiftAutomation.noParameter,
            ...
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "makeImageSlides", event: 0x4b6e7463_4d496d53, // "KntcMImS"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
    ...
    @discardableResult public func merge(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "merge", event: 0x4e4d5462_4d524745, // "NMTbMRGE"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func moveSlideSwitcherBackward(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "moveSlideSwitcherBackward", event: 0x4b6e7463_6d737362, // "Kntcmssb"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func moveSlideSwitcherForward(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "moveSlideSwitcherForward", event: 0x4b6e7463_6d737366, // "Kntcmssf"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func show(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "show", event: 0x4b6e7463_4b6a6d70, // "KntcKjmp"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func showNext(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "showNext", event: 0x4b6e7463_73746546, // "KntcsteF"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func showPrevious(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "showPrevious", event: 0x4b6e7463_73746542, // "KntcsteB"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func showSlideSwitcher(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "showSlideSwitcher", event: 0x4b6e7463_7373736c, // "Kntcsssl"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func sort(_ directParameter: Any = SwiftAutomation.noParameter,
            ...
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "sort", event: 0x4e6d5462_534f5254, // "NmTbSORT"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
    ...
    @discardableResult public func start(_ directParameter: Any = SwiftAutomation.noParameter,
            ...
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "start", event: 0x4b6e7374_706c6159, // "KnstplaY"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
    ...
    @discardableResult public func startFrom(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "startFrom", event: 0x4b6e7463_706c6146, // "KntcplaF"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func startSlideshow(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "startSlideshow", event: 0x4b6e7463_706c614c, // "KntcplaL"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func stop(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "stop", event: 0x4b6e7374_73746f50, // "KnststoP"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func stopSlideshow(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "stopSlideshow", event: 0x4b6e7463_73746f54, // "KntcstoT"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func unmerge(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "unmerge", event: 0x4e6d5462_5370556d, // "NmTbSpUm"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
...
extension KEYObject {
    ...
    public var id: KEYItem {return self.property(0x49442020) as! KEYItem} // "ID  "
    ...
    public var selection: KEYItem {return self.property(0x73656c65) as! KEYItem} // "sele"
    ...
    public var characters: KEYItems {return self.elements(0x63686120) as! KEYItems} // "cha "

...
public class SEDSymbol: SwiftAutomation.Symbol {
    ...
    public override class func symbol(code: OSType, type: OSType = typeType, descriptor: ScalarDescriptor? = nil) -> SEDSymbol {
        switch (code) {
    ...
    public static let April = SEDSymbol(name: "April", code: 0x61707220, type: typeType) // "apr "
    ...
    public static let August = SEDSymbol(name: "August", code: 0x61756720, type: typeType) // "aug "
    ...
    public static let character = SEDSymbol(name: "character", code: 0x63686120, type: typeType) // "cha "
    ...
    public static let date = SEDSymbol(name: "date", code: 0x6c647420, type: typeType) // "ldt "
    public static let December = SEDSymbol(name: "December", code: 0x64656320, type: typeType) // "dec "
    ...
    public static let EPSPicture = SEDSymbol(name: "EPSPicture", code: 0x45505320, type: typeType) // "EPS "
    ...
    public static let February = SEDSymbol(name: "February", code: 0x66656220, type: typeType) // "feb "
    ...
    public static let Friday = SEDSymbol(name: "Friday", code: 0x66726920, type: typeType) // "fri "
    ...
    public static let id = SEDSymbol(name: "id", code: 0x49442020, type: typeType) // "ID  "
    ...
    public static let January = SEDSymbol(name: "January", code: 0x6a616e20, type: typeType) // "jan "
    public static let JPEGPicture = SEDSymbol(name: "JPEGPicture", code: 0x4a504547, type: typeType) // "JPEG"
    public static let July = SEDSymbol(name: "July", code: 0x6a756c20, type: typeType) // "jul "
    public static let June = SEDSymbol(name: "June", code: 0x6a756e20, type: typeType) // "jun "
    ...
    public static let March = SEDSymbol(name: "March", code: 0x6d617220, type: typeType) // "mar "
    public static let May = SEDSymbol(name: "May", code: 0x6d617920, type: typeType) // "may "
    ...
    public static let Monday = SEDSymbol(name: "Monday", code: 0x6d6f6e20, type: typeType) // "mon "
    public static let name = SEDSymbol(name: "name", code: 0x706e616d, type: typeType) // "pnam"
    public static let November = SEDSymbol(name: "November", code: 0x6e6f7620, type: typeType) // "nov "
    public static let null = SEDSymbol(name: "null", code: 0x6e756c6c, type: typeType) // "null"
    public static let October = SEDSymbol(name: "October", code: 0x6f637420, type: typeType) // "oct "
    ...
    public static let processSerialNumber = SEDSymbol(name: "processSerialNumber", code: 0x70736e20, type: typeType) // "psn "
    ...
    public static let reference = SEDSymbol(name: "reference", code: 0x6f626a20, type: typeType) // "obj "
    ...
    public static let Saturday = SEDSymbol(name: "Saturday", code: 0x73617420, type: typeType) // "sat "
    ...
    public static let September = SEDSymbol(name: "September", code: 0x73657020, type: typeType) // "sep "
    ...
    public static let Sunday = SEDSymbol(name: "Sunday", code: 0x73756e20, type: typeType) // "sun "
    ...
    public static let Thursday = SEDSymbol(name: "Thursday", code: 0x74687520, type: typeType) // "thu "
    ...
    public static let Tuesday = SEDSymbol(name: "Tuesday", code: 0x74756520, type: typeType) // "tue "
    ...
    public static let Wednesday = SEDSymbol(name: "Wednesday", code: 0x77656420, type: typeType) // "wed "
    ...
    // Enumerators
    public static let ask = SEDSymbol(name: "ask", code: 0x61736b20, type: typeEnumerated) // "ask "
    ...
    public static let no = SEDSymbol(name: "no", code: 0x6e6f2020, type: typeEnumerated) // "no  "
    ...
    public static let yes = SEDSymbol(name: "yes", code: 0x79657320, type: typeEnumerated) // "yes "
}

...
public class CONSymbol: SwiftAutomation.Symbol {
    ...
    public static let enumerator = CONSymbol(name: "enumerator", code: 0x656e756d, type: typeType) // "enum"
    public static let EPSPicture = CONSymbol(name: "EPSPicture", code: 0x45505320, type: typeType) // "EPS\0x20"
    public static let extendedFloat = CONSymbol(name: "extendedFloat", code: 0x65787465, type: typeType) // "exte"
    ...
    public static let float = CONSymbol(name: "float", code: 0x646f7562, type: typeType) // "doub"
    public static let float128bit = CONSymbol(name: "float128bit", code: 0x6c64626c, type: typeType) // "ldbl"
    ...
    public static let shortFloat = CONSymbol(name: "shortFloat", code: 0x73696e67, type: typeType) // "sing"

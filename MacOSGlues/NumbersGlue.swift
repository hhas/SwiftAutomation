...
public class NUMSymbol: SwiftAutomation.Symbol {
    ...
    public override class func symbol(code: OSType, type: OSType = typeType, descriptor: ScalarDescriptor? = nil) -> NUMSymbol {
        switch (code) {
    ...
    public static let April = NUMSymbol(name: "April", code: 0x61707220, type: typeType) // "apr "
    public static let audioClip = NUMSymbol(name: "audioClip", code: 0x73686175, type: typeType) // "shau"
    public static let August = NUMSymbol(name: "August", code: 0x61756720, type: typeType) // "aug "
    ...
    public static let character = NUMSymbol(name: "character", code: 0x63686120, type: typeType) // "cha "
    ...
    public static let date = NUMSymbol(name: "date", code: 0x6c647420, type: typeType) // "ldt "
    public static let December = NUMSymbol(name: "December", code: 0x64656320, type: typeType) // "dec "
    ...
    public static let EPSPicture = NUMSymbol(name: "EPSPicture", code: 0x45505320, type: typeType) // "EPS "
    ...
    public static let February = NUMSymbol(name: "February", code: 0x66656220, type: typeType) // "feb "
    ...
    public static let Friday = NUMSymbol(name: "Friday", code: 0x66726920, type: typeType) // "fri "
    ...
    public static let id = NUMSymbol(name: "id", code: 0x49442020, type: typeType) // "ID  "
    ...
    public static let January = NUMSymbol(name: "January", code: 0x6a616e20, type: typeType) // "jan "
    public static let JPEGPicture = NUMSymbol(name: "JPEGPicture", code: 0x4a504547, type: typeType) // "JPEG"
    public static let July = NUMSymbol(name: "July", code: 0x6a756c20, type: typeType) // "jul "
    public static let June = NUMSymbol(name: "June", code: 0x6a756e20, type: typeType) // "jun "
    ...
    public static let March = NUMSymbol(name: "March", code: 0x6d617220, type: typeType) // "mar "
    public static let May = NUMSymbol(name: "May", code: 0x6d617920, type: typeType) // "may "
    ...
    public static let Monday = NUMSymbol(name: "Monday", code: 0x6d6f6e20, type: typeType) // "mon "
    ...
    public static let November = NUMSymbol(name: "November", code: 0x6e6f7620, type: typeType) // "nov "
    ...
    public static let October = NUMSymbol(name: "October", code: 0x6f637420, type: typeType) // "oct "
    ...
    public static let processSerialNumber = NUMSymbol(name: "processSerialNumber", code: 0x70736e20, type: typeType) // "psn "
    ...
    public static let reference = NUMSymbol(name: "reference", code: 0x6f626a20, type: typeType) // "obj "
    ...
    public static let Saturday = NUMSymbol(name: "Saturday", code: 0x73617420, type: typeType) // "sat "
    public static let script = NUMSymbol(name: "script", code: 0x73637074, type: typeType) // "scpt"
    public static let selection = NUMSymbol(name: "selection", code: 0x73656c65, type: typeType) // "sele"
    public static let selectionRange = NUMSymbol(name: "selectionRange", code: 0x4e4d5473, type: typeType) // "NMTs"
    public static let September = NUMSymbol(name: "September", code: 0x73657020, type: typeType) // "sep "
    ...
    public static let Sunday = NUMSymbol(name: "Sunday", code: 0x73756e20, type: typeType) // "sun "
    ...
    public static let Thursday = NUMSymbol(name: "Thursday", code: 0x74687520, type: typeType) // "thu "
    public static let TIFFPicture = NUMSymbol(name: "TIFFPicture", code: 0x54494646, type: typeType) // "TIFF"
    public static let Tuesday = NUMSymbol(name: "Tuesday", code: 0x74756520, type: typeType) // "tue "
    ...
    public static let Wednesday = NUMSymbol(name: "Wednesday", code: 0x77656420, type: typeType) // "wed "
    ...
    public static let ask = NUMSymbol(name: "ask", code: 0x61736b20, type: typeEnumerated) // "ask "
    ...
    public static let no = NUMSymbol(name: "no", code: 0x6e6f2020, type: typeEnumerated) // "no  "
    ...
    public static let yes = NUMSymbol(name: "yes", code: 0x79657320, type: typeEnumerated) // "yes "
}

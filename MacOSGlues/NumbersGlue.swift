...
private let _glueClasses = SwiftAutomation.GlueClasses(
                                                insertionSpecifierType: NUMInsertion.self,
...
public class NUMSymbol: SwiftAutomation.Symbol {
    ...
    public override class func symbol(code: OSType, type: OSType = AppleEvents.typeType, descriptor: ScalarDescriptor? = nil) -> NUMSymbol {
        switch (code) {
    ...
    // Types/properties
    public static let activeSheet = NUMSymbol(name: "activeSheet", code: 0x4e6d4153, type: AppleEvents.typeType) // "NmAS"
    public static let address = NUMSymbol(name: "address", code: 0x4e4d6164, type: AppleEvents.typeType) // "NMad"
    public static let alias = NUMSymbol(name: "alias", code: 0x616c6973, type: AppleEvents.typeType) // "alis"
    public static let alignment = NUMSymbol(name: "alignment", code: 0x74657841, type: AppleEvents.typeType) // "texA"
    public static let anything = NUMSymbol(name: "anything", code: 0x2a2a2a2a, type: AppleEvents.typeType) // "****"
    public static let application = NUMSymbol(name: "application", code: 0x63617070, type: AppleEvents.typeType) // "capp"
    public static let applicationBundleID = NUMSymbol(name: "applicationBundleID", code: 0x62756e64, type: AppleEvents.typeType) // "bund"
    public static let applicationSignature = NUMSymbol(name: "applicationSignature", code: 0x7369676e, type: AppleEvents.typeType) // "sign"
    public static let applicationURL = NUMSymbol(name: "applicationURL", code: 0x6170726c, type: AppleEvents.typeType) // "aprl"
    public static let April = NUMSymbol(name: "April", code: 0x61707220, type: AppleEvents.typeType) // "apr "
    public static let audioClip = NUMSymbol(name: "audioClip", code: 0x73686175, type: AppleEvents.typeType) // "shau"
    public static let August = NUMSymbol(name: "August", code: 0x61756720, type: AppleEvents.typeType) // "aug "
    public static let backgroundColor = NUMSymbol(name: "backgroundColor", code: 0x63654243, type: AppleEvents.typeType) // "ceBC"
    public static let backgroundFillType = NUMSymbol(name: "backgroundFillType", code: 0x626b6674, type: AppleEvents.typeType) // "bkft"
    public static let best = NUMSymbol(name: "best", code: 0x62657374, type: AppleEvents.typeType) // "best"
    public static let bookmarkData = NUMSymbol(name: "bookmarkData", code: 0x626d726b, type: AppleEvents.typeType) // "bmrk"
    public static let boolean = NUMSymbol(name: "boolean", code: 0x626f6f6c, type: AppleEvents.typeType) // "bool"
    public static let boundingRectangle = NUMSymbol(name: "boundingRectangle", code: 0x71647274, type: AppleEvents.typeType) // "qdrt"
    public static let bounds = NUMSymbol(name: "bounds", code: 0x70626e64, type: AppleEvents.typeType) // "pbnd"
    public static let cell = NUMSymbol(name: "cell", code: 0x4e6d436c, type: AppleEvents.typeType) // "NmCl"
    public static let cellRange = NUMSymbol(name: "cellRange", code: 0x4e4d5463, type: AppleEvents.typeType) // "NMTc"
    public static let character = NUMSymbol(name: "character", code: 0x63686120, type: AppleEvents.typeType) // "cha "
    public static let chart = NUMSymbol(name: "chart", code: 0x73686374, type: AppleEvents.typeType) // "shct"
    public static let class_ = NUMSymbol(name: "class_", code: 0x70636c73, type: AppleEvents.typeType) // "pcls"
    public static let clipVolume = NUMSymbol(name: "clipVolume", code: 0x61766f6c, type: AppleEvents.typeType) // "avol"
    public static let closeable = NUMSymbol(name: "closeable", code: 0x68636c62, type: AppleEvents.typeType) // "hclb"
    public static let collating = NUMSymbol(name: "collating", code: 0x6c77636c, type: AppleEvents.typeType) // "lwcl"
    public static let color = NUMSymbol(name: "color", code: 0x636f6c72, type: AppleEvents.typeType) // "colr"
    public static let colorTable = NUMSymbol(name: "colorTable", code: 0x636c7274, type: AppleEvents.typeType) // "clrt"
    public static let column = NUMSymbol(name: "column", code: 0x4e4d436f, type: AppleEvents.typeType) // "NMCo"
    public static let columnCount = NUMSymbol(name: "columnCount", code: 0x4e6d5463, type: AppleEvents.typeType) // "NmTc"
    public static let constant = NUMSymbol(name: "constant", code: 0x656e756d, type: AppleEvents.typeType) // "enum"
    public static let copies = NUMSymbol(name: "copies", code: 0x6c776370, type: AppleEvents.typeType) // "lwcp"
    public static let dashStyle = NUMSymbol(name: "dashStyle", code: 0x74646173, type: AppleEvents.typeType) // "tdas"
    public static let data = NUMSymbol(name: "data", code: 0x74647461, type: AppleEvents.typeType) // "tdta"
    public static let date = NUMSymbol(name: "date", code: 0x6c647420, type: AppleEvents.typeType) // "ldt "
    public static let December = NUMSymbol(name: "December", code: 0x64656320, type: AppleEvents.typeType) // "dec "
    public static let decimalStruct = NUMSymbol(name: "decimalStruct", code: 0x6465636d, type: AppleEvents.typeType) // "decm"
    public static let description_ = NUMSymbol(name: "description_", code: 0x64736372, type: AppleEvents.typeType) // "dscr"
    public static let document = NUMSymbol(name: "document", code: 0x646f6375, type: AppleEvents.typeType) // "docu"
    public static let documentTemplate = NUMSymbol(name: "documentTemplate", code: 0x546d706c, type: AppleEvents.typeType) // "Tmpl"
    public static let doubleInteger = NUMSymbol(name: "doubleInteger", code: 0x636f6d70, type: AppleEvents.typeType) // "comp"
    public static let encodedString = NUMSymbol(name: "encodedString", code: 0x656e6373, type: AppleEvents.typeType) // "encs"
    public static let endingPage = NUMSymbol(name: "endingPage", code: 0x6c776c70, type: AppleEvents.typeType) // "lwlp"
    public static let endPoint = NUMSymbol(name: "endPoint", code: 0x6c6e6570, type: AppleEvents.typeType) // "lnep"
    public static let EPSPicture = NUMSymbol(name: "EPSPicture", code: 0x45505320, type: AppleEvents.typeType) // "EPS "
    public static let errorHandling = NUMSymbol(name: "errorHandling", code: 0x6c776568, type: AppleEvents.typeType) // "lweh"
    public static let excludeSummaryWorksheet = NUMSymbol(name: "excludeSummaryWorksheet", code: 0x4e784553, type: AppleEvents.typeType) // "NxES"
    public static let exportOptions = NUMSymbol(name: "exportOptions", code: 0x4e786f70, type: AppleEvents.typeType) // "Nxop"
    public static let faxNumber = NUMSymbol(name: "faxNumber", code: 0x6661786e, type: AppleEvents.typeType) // "faxn"
    public static let February = NUMSymbol(name: "February", code: 0x66656220, type: AppleEvents.typeType) // "feb "
    public static let file = NUMSymbol(name: "file", code: 0x66696c65, type: AppleEvents.typeType) // "file"
    public static let fileName = NUMSymbol(name: "fileName", code: 0x6174666e, type: AppleEvents.typeType) // "atfn"
    public static let fileRef = NUMSymbol(name: "fileRef", code: 0x66737266, type: AppleEvents.typeType) // "fsrf"
    public static let fileURL = NUMSymbol(name: "fileURL", code: 0x6675726c, type: AppleEvents.typeType) // "furl"
    public static let filtered = NUMSymbol(name: "filtered", code: 0x4e4d5466, type: AppleEvents.typeType) // "NMTf"
    public static let fixed = NUMSymbol(name: "fixed", code: 0x66697864, type: AppleEvents.typeType) // "fixd"
    public static let fixedPoint = NUMSymbol(name: "fixedPoint", code: 0x66706e74, type: AppleEvents.typeType) // "fpnt"
    public static let fixedRectangle = NUMSymbol(name: "fixedRectangle", code: 0x66726374, type: AppleEvents.typeType) // "frct"
    public static let font = NUMSymbol(name: "font", code: 0x666f6e74, type: AppleEvents.typeType) // "font"
    public static let fontName = NUMSymbol(name: "fontName", code: 0x4e4d666e, type: AppleEvents.typeType) // "NMfn"
    public static let fontSize = NUMSymbol(name: "fontSize", code: 0x4e4d6673, type: AppleEvents.typeType) // "NMfs"
    public static let footerRowCount = NUMSymbol(name: "footerRowCount", code: 0x4e6d4672, type: AppleEvents.typeType) // "NmFr"
    public static let format = NUMSymbol(name: "format", code: 0x4e4d4354, type: AppleEvents.typeType) // "NMCT"
    public static let formattedValue = NUMSymbol(name: "formattedValue", code: 0x4e4d6676, type: AppleEvents.typeType) // "NMfv"
    public static let formula = NUMSymbol(name: "formula", code: 0x4e4d4366, type: AppleEvents.typeType) // "NMCf"
    public static let Friday = NUMSymbol(name: "Friday", code: 0x66726920, type: AppleEvents.typeType) // "fri "
    public static let frontmost = NUMSymbol(name: "frontmost", code: 0x70697366, type: AppleEvents.typeType) // "pisf"
    public static let GIFPicture = NUMSymbol(name: "GIFPicture", code: 0x47494666, type: AppleEvents.typeType) // "GIFf"
    public static let graphicText = NUMSymbol(name: "graphicText", code: 0x63677478, type: AppleEvents.typeType) // "cgtx"
    public static let group = NUMSymbol(name: "group", code: 0x69677270, type: AppleEvents.typeType) // "igrp"
    public static let headerColumnCount = NUMSymbol(name: "headerColumnCount", code: 0x4e6d4843, type: AppleEvents.typeType) // "NmHC"
    public static let headerColumnsFrozen = NUMSymbol(name: "headerColumnsFrozen", code: 0x4e6d4643, type: AppleEvents.typeType) // "NmFC"
    public static let headerRowCount = NUMSymbol(name: "headerRowCount", code: 0x4e6d4872, type: AppleEvents.typeType) // "NmHr"
    public static let headerRowsFrozen = NUMSymbol(name: "headerRowsFrozen", code: 0x4e6d4648, type: AppleEvents.typeType) // "NmFH"
    public static let height = NUMSymbol(name: "height", code: 0x73697468, type: AppleEvents.typeType) // "sith"
    public static let id = NUMSymbol(name: "id", code: 0x49442020, type: AppleEvents.typeType) // "ID  "
    public static let image = NUMSymbol(name: "image", code: 0x696d6167, type: AppleEvents.typeType) // "imag"
    public static let imageQuality = NUMSymbol(name: "imageQuality", code: 0x4e785049, type: AppleEvents.typeType) // "NxPI"
    public static let index = NUMSymbol(name: "index", code: 0x70696478, type: AppleEvents.typeType) // "pidx"
    public static let integer = NUMSymbol(name: "integer", code: 0x6c6f6e67, type: AppleEvents.typeType) // "long"
    public static let internationalText = NUMSymbol(name: "internationalText", code: 0x69747874, type: AppleEvents.typeType) // "itxt"
    public static let internationalWritingCode = NUMSymbol(name: "internationalWritingCode", code: 0x696e746c, type: AppleEvents.typeType) // "intl"
    public static let item = NUMSymbol(name: "item", code: 0x636f626a, type: AppleEvents.typeType) // "cobj"
    public static let iWorkContainer = NUMSymbol(name: "iWorkContainer", code: 0x69776b63, type: AppleEvents.typeType) // "iwkc"
    public static let iWorkItem = NUMSymbol(name: "iWorkItem", code: 0x666d7469, type: AppleEvents.typeType) // "fmti"
    public static let January = NUMSymbol(name: "January", code: 0x6a616e20, type: AppleEvents.typeType) // "jan "
    public static let JPEGPicture = NUMSymbol(name: "JPEGPicture", code: 0x4a504547, type: AppleEvents.typeType) // "JPEG"
    public static let July = NUMSymbol(name: "July", code: 0x6a756c20, type: AppleEvents.typeType) // "jul "
    public static let June = NUMSymbol(name: "June", code: 0x6a756e20, type: AppleEvents.typeType) // "jun "
    public static let kernelProcessID = NUMSymbol(name: "kernelProcessID", code: 0x6b706964, type: AppleEvents.typeType) // "kpid"
    public static let largeReal = NUMSymbol(name: "largeReal", code: 0x6c64626c, type: AppleEvents.typeType) // "ldbl"
    public static let line = NUMSymbol(name: "line", code: 0x69576c6e, type: AppleEvents.typeType) // "iWln"
    public static let list = NUMSymbol(name: "list", code: 0x6c697374, type: AppleEvents.typeType) // "list"
    public static let locationReference = NUMSymbol(name: "locationReference", code: 0x696e736c, type: AppleEvents.typeType) // "insl"
    public static let locked = NUMSymbol(name: "locked", code: 0x704c636b, type: AppleEvents.typeType) // "pLck"
    public static let longFixed = NUMSymbol(name: "longFixed", code: 0x6c667864, type: AppleEvents.typeType) // "lfxd"
    public static let longFixedPoint = NUMSymbol(name: "longFixedPoint", code: 0x6c667074, type: AppleEvents.typeType) // "lfpt"
    public static let longFixedRectangle = NUMSymbol(name: "longFixedRectangle", code: 0x6c667263, type: AppleEvents.typeType) // "lfrc"
    public static let longPoint = NUMSymbol(name: "longPoint", code: 0x6c706e74, type: AppleEvents.typeType) // "lpnt"
    public static let longRectangle = NUMSymbol(name: "longRectangle", code: 0x6c726374, type: AppleEvents.typeType) // "lrct"
    public static let machine = NUMSymbol(name: "machine", code: 0x6d616368, type: AppleEvents.typeType) // "mach"
    public static let machineLocation = NUMSymbol(name: "machineLocation", code: 0x6d4c6f63, type: AppleEvents.typeType) // "mLoc"
    public static let machPort = NUMSymbol(name: "machPort", code: 0x706f7274, type: AppleEvents.typeType) // "port"
    public static let March = NUMSymbol(name: "March", code: 0x6d617220, type: AppleEvents.typeType) // "mar "
    public static let May = NUMSymbol(name: "May", code: 0x6d617920, type: AppleEvents.typeType) // "may "
    public static let miniaturizable = NUMSymbol(name: "miniaturizable", code: 0x69736d6e, type: AppleEvents.typeType) // "ismn"
    public static let miniaturized = NUMSymbol(name: "miniaturized", code: 0x706d6e64, type: AppleEvents.typeType) // "pmnd"
    public static let modified = NUMSymbol(name: "modified", code: 0x696d6f64, type: AppleEvents.typeType) // "imod"
    public static let Monday = NUMSymbol(name: "Monday", code: 0x6d6f6e20, type: AppleEvents.typeType) // "mon "
    public static let movie = NUMSymbol(name: "movie", code: 0x73686d76, type: AppleEvents.typeType) // "shmv"
    public static let movieVolume = NUMSymbol(name: "movieVolume", code: 0x6d766f6c, type: AppleEvents.typeType) // "mvol"
    public static let name = NUMSymbol(name: "name", code: 0x706e616d, type: AppleEvents.typeType) // "pnam"
    public static let November = NUMSymbol(name: "November", code: 0x6e6f7620, type: AppleEvents.typeType) // "nov "
    public static let null = NUMSymbol(name: "null", code: 0x6e756c6c, type: AppleEvents.typeType) // "null"
    public static let objectText = NUMSymbol(name: "objectText", code: 0x70445478, type: AppleEvents.typeType) // "pDTx"
    public static let October = NUMSymbol(name: "October", code: 0x6f637420, type: AppleEvents.typeType) // "oct "
    public static let opacity = NUMSymbol(name: "opacity", code: 0x70534f70, type: AppleEvents.typeType) // "pSOp"
    public static let pagesAcross = NUMSymbol(name: "pagesAcross", code: 0x6c776c61, type: AppleEvents.typeType) // "lwla"
    public static let pagesDown = NUMSymbol(name: "pagesDown", code: 0x6c776c64, type: AppleEvents.typeType) // "lwld"
    public static let paragraph = NUMSymbol(name: "paragraph", code: 0x63706172, type: AppleEvents.typeType) // "cpar"
    public static let parent = NUMSymbol(name: "parent", code: 0x73697074, type: AppleEvents.typeType) // "sipt"
    public static let password = NUMSymbol(name: "password", code: 0x4e785057, type: AppleEvents.typeType) // "NxPW"
    public static let passwordHint = NUMSymbol(name: "passwordHint", code: 0x4e785048, type: AppleEvents.typeType) // "NxPH"
    public static let PICTPicture = NUMSymbol(name: "PICTPicture", code: 0x50494354, type: AppleEvents.typeType) // "PICT"
    public static let pixelMapRecord = NUMSymbol(name: "pixelMapRecord", code: 0x74706d6d, type: AppleEvents.typeType) // "tpmm"
    public static let point = NUMSymbol(name: "point", code: 0x51447074, type: AppleEvents.typeType) // "QDpt"
    public static let position = NUMSymbol(name: "position", code: 0x7369706f, type: AppleEvents.typeType) // "sipo"
    public static let printSettings = NUMSymbol(name: "printSettings", code: 0x70736574, type: AppleEvents.typeType) // "pset"
    public static let processSerialNumber = NUMSymbol(name: "processSerialNumber", code: 0x70736e20, type: AppleEvents.typeType) // "psn "
    public static let properties = NUMSymbol(name: "properties", code: 0x70414c4c, type: AppleEvents.typeType) // "pALL"
    public static let property_ = NUMSymbol(name: "property_", code: 0x70726f70, type: AppleEvents.typeType) // "prop"
    public static let range = NUMSymbol(name: "range", code: 0x4e6d4352, type: AppleEvents.typeType) // "NmCR"
    public static let real = NUMSymbol(name: "real", code: 0x646f7562, type: AppleEvents.typeType) // "doub"
    public static let record = NUMSymbol(name: "record", code: 0x7265636f, type: AppleEvents.typeType) // "reco"
    public static let reference = NUMSymbol(name: "reference", code: 0x6f626a20, type: AppleEvents.typeType) // "obj "
    public static let reflectionShowing = NUMSymbol(name: "reflectionShowing", code: 0x73697273, type: AppleEvents.typeType) // "sirs"
    public static let reflectionValue = NUMSymbol(name: "reflectionValue", code: 0x73697276, type: AppleEvents.typeType) // "sirv"
    public static let repetitionMethod = NUMSymbol(name: "repetitionMethod", code: 0x6d767270, type: AppleEvents.typeType) // "mvrp"
    public static let requestedPrintTime = NUMSymbol(name: "requestedPrintTime", code: 0x6c777174, type: AppleEvents.typeType) // "lwqt"
    public static let resizable = NUMSymbol(name: "resizable", code: 0x7072737a, type: AppleEvents.typeType) // "prsz"
    public static let RGB16Color = NUMSymbol(name: "RGB16Color", code: 0x74723136, type: AppleEvents.typeType) // "tr16"
    public static let RGB96Color = NUMSymbol(name: "RGB96Color", code: 0x74723936, type: AppleEvents.typeType) // "tr96"
    public static let RGBColor = NUMSymbol(name: "RGBColor", code: 0x63524742, type: AppleEvents.typeType) // "cRGB"
    public static let richText = NUMSymbol(name: "richText", code: 0x72747874, type: AppleEvents.typeType) // "rtxt"
    public static let rotation = NUMSymbol(name: "rotation", code: 0x74726f74, type: AppleEvents.typeType) // "trot"
    public static let rotation_ = NUMSymbol(name: "rotation_", code: 0x7369726f, type: AppleEvents.typeType) // "siro"
    public static let row = NUMSymbol(name: "row", code: 0x4e4d5277, type: AppleEvents.typeType) // "NMRw"
    public static let rowCount = NUMSymbol(name: "rowCount", code: 0x4e6d5472, type: AppleEvents.typeType) // "NmTr"
    public static let Saturday = NUMSymbol(name: "Saturday", code: 0x73617420, type: AppleEvents.typeType) // "sat "
    public static let script = NUMSymbol(name: "script", code: 0x73637074, type: AppleEvents.typeType) // "scpt"
    public static let selection = NUMSymbol(name: "selection", code: 0x73656c65, type: AppleEvents.typeType) // "sele"
    public static let selectionRange = NUMSymbol(name: "selectionRange", code: 0x4e4d5473, type: AppleEvents.typeType) // "NMTs"
    public static let September = NUMSymbol(name: "September", code: 0x73657020, type: AppleEvents.typeType) // "sep "
    public static let shape = NUMSymbol(name: "shape", code: 0x73736870, type: AppleEvents.typeType) // "sshp"
    public static let sheet = NUMSymbol(name: "sheet", code: 0x4e6d5368, type: AppleEvents.typeType) // "NmSh"
    public static let shortInteger = NUMSymbol(name: "shortInteger", code: 0x73686f72, type: AppleEvents.typeType) // "shor"
    public static let size = NUMSymbol(name: "size", code: 0x7074737a, type: AppleEvents.typeType) // "ptsz"
    public static let smallReal = NUMSymbol(name: "smallReal", code: 0x73696e67, type: AppleEvents.typeType) // "sing"
    public static let startingPage = NUMSymbol(name: "startingPage", code: 0x6c776670, type: AppleEvents.typeType) // "lwfp"
    public static let startPoint = NUMSymbol(name: "startPoint", code: 0x6c6e7370, type: AppleEvents.typeType) // "lnsp"
    public static let string = NUMSymbol(name: "string", code: 0x54455854, type: AppleEvents.typeType) // "TEXT"
    public static let styledClipboardText = NUMSymbol(name: "styledClipboardText", code: 0x7374796c, type: AppleEvents.typeType) // "styl"
    public static let styledText = NUMSymbol(name: "styledText", code: 0x53545854, type: AppleEvents.typeType) // "STXT"
    public static let Sunday = NUMSymbol(name: "Sunday", code: 0x73756e20, type: AppleEvents.typeType) // "sun "
    public static let table = NUMSymbol(name: "table", code: 0x4e6d5462, type: AppleEvents.typeType) // "NmTb"
    public static let targetPrinter = NUMSymbol(name: "targetPrinter", code: 0x74727072, type: AppleEvents.typeType) // "trpr"
    public static let template = NUMSymbol(name: "template", code: 0x746d706c, type: AppleEvents.typeType) // "tmpl"
    public static let textColor = NUMSymbol(name: "textColor", code: 0x74657843, type: AppleEvents.typeType) // "texC"
    public static let textItem = NUMSymbol(name: "textItem", code: 0x73687478, type: AppleEvents.typeType) // "shtx"
    public static let textStyleInfo = NUMSymbol(name: "textStyleInfo", code: 0x74737479, type: AppleEvents.typeType) // "tsty"
    public static let textWrap = NUMSymbol(name: "textWrap", code: 0x77726170, type: AppleEvents.typeType) // "wrap"
    public static let Thursday = NUMSymbol(name: "Thursday", code: 0x74687520, type: AppleEvents.typeType) // "thu "
    public static let TIFFPicture = NUMSymbol(name: "TIFFPicture", code: 0x54494646, type: AppleEvents.typeType) // "TIFF"
    public static let Tuesday = NUMSymbol(name: "Tuesday", code: 0x74756520, type: AppleEvents.typeType) // "tue "
    public static let typeClass = NUMSymbol(name: "typeClass", code: 0x74797065, type: AppleEvents.typeType) // "type"
    public static let UnicodeText = NUMSymbol(name: "UnicodeText", code: 0x75747874, type: AppleEvents.typeType) // "utxt"
    public static let unsignedDoubleInteger = NUMSymbol(name: "unsignedDoubleInteger", code: 0x75636f6d, type: AppleEvents.typeType) // "ucom"
    public static let unsignedInteger = NUMSymbol(name: "unsignedInteger", code: 0x6d61676e, type: AppleEvents.typeType) // "magn"
    public static let unsignedShortInteger = NUMSymbol(name: "unsignedShortInteger", code: 0x75736872, type: AppleEvents.typeType) // "ushr"
    public static let UTF16Text = NUMSymbol(name: "UTF16Text", code: 0x75743136, type: AppleEvents.typeType) // "ut16"
    public static let UTF8Text = NUMSymbol(name: "UTF8Text", code: 0x75746638, type: AppleEvents.typeType) // "utf8"
    public static let value = NUMSymbol(name: "value", code: 0x4e4d4376, type: AppleEvents.typeType) // "NMCv"
    public static let version = NUMSymbol(name: "version", code: 0x76657273, type: AppleEvents.typeType) // "vers"
    public static let verticalAlignment = NUMSymbol(name: "verticalAlignment", code: 0x74785641, type: AppleEvents.typeType) // "txVA"
    public static let visible = NUMSymbol(name: "visible", code: 0x70766973, type: AppleEvents.typeType) // "pvis"
    public static let Wednesday = NUMSymbol(name: "Wednesday", code: 0x77656420, type: AppleEvents.typeType) // "wed "
    public static let width = NUMSymbol(name: "width", code: 0x73697477, type: AppleEvents.typeType) // "sitw"
    public static let window = NUMSymbol(name: "window", code: 0x6377696e, type: AppleEvents.typeType) // "cwin"
    public static let word = NUMSymbol(name: "word", code: 0x63776f72, type: AppleEvents.typeType) // "cwor"
    public static let writingCode = NUMSymbol(name: "writingCode", code: 0x70736374, type: AppleEvents.typeType) // "psct"
    public static let zoomable = NUMSymbol(name: "zoomable", code: 0x69737a6d, type: AppleEvents.typeType) // "iszm"
    public static let zoomed = NUMSymbol(name: "zoomed", code: 0x707a756d, type: AppleEvents.typeType) // "pzum"

    // Enumerators
    public static let advancedGradientFill = NUMSymbol(name: "advancedGradientFill", code: 0x66696167, type: AppleEvents.typeEnumerated) // "fiag"
    public static let advancedImageFill = NUMSymbol(name: "advancedImageFill", code: 0x66696169, type: AppleEvents.typeEnumerated) // "fiai"
    public static let ascending = NUMSymbol(name: "ascending", code: 0x6173636e, type: AppleEvents.typeEnumerated) // "ascn"
    public static let ask = NUMSymbol(name: "ask", code: 0x61736b20, type: AppleEvents.typeEnumerated) // "ask "
    public static let autoAlign = NUMSymbol(name: "autoAlign", code: 0x61617574, type: AppleEvents.typeEnumerated) // "aaut"
    public static let automatic = NUMSymbol(name: "automatic", code: 0x66617574, type: AppleEvents.typeEnumerated) // "faut"
    public static let Best = NUMSymbol(name: "Best", code: 0x4b6e5032, type: AppleEvents.typeEnumerated) // "KnP2"
    public static let Better = NUMSymbol(name: "Better", code: 0x4b6e5031, type: AppleEvents.typeEnumerated) // "KnP1"
    public static let bottom = NUMSymbol(name: "bottom", code: 0x61766274, type: AppleEvents.typeEnumerated) // "avbt"
    public static let case_ = NUMSymbol(name: "case_", code: 0x63617365, type: AppleEvents.typeEnumerated) // "case"
    public static let center = NUMSymbol(name: "center", code: 0x61637472, type: AppleEvents.typeEnumerated) // "actr"
    public static let checkbox = NUMSymbol(name: "checkbox", code: 0x66636368, type: AppleEvents.typeEnumerated) // "fcch"
    public static let colorFill = NUMSymbol(name: "colorFill", code: 0x6669636f, type: AppleEvents.typeEnumerated) // "fico"
    public static let CSV = NUMSymbol(name: "CSV", code: 0x4e637376, type: AppleEvents.typeEnumerated) // "Ncsv"
    public static let currency = NUMSymbol(name: "currency", code: 0x66637572, type: AppleEvents.typeEnumerated) // "fcur"
    public static let dateAndTime = NUMSymbol(name: "dateAndTime", code: 0x6664746d, type: AppleEvents.typeEnumerated) // "fdtm"
    public static let descending = NUMSymbol(name: "descending", code: 0x6473636e, type: AppleEvents.typeEnumerated) // "dscn"
    public static let detailed = NUMSymbol(name: "detailed", code: 0x6c776474, type: AppleEvents.typeEnumerated) // "lwdt"
    public static let diacriticals = NUMSymbol(name: "diacriticals", code: 0x64696163, type: AppleEvents.typeEnumerated) // "diac"
    public static let duration = NUMSymbol(name: "duration", code: 0x66647572, type: AppleEvents.typeEnumerated) // "fdur"
    public static let expansion = NUMSymbol(name: "expansion", code: 0x65787061, type: AppleEvents.typeEnumerated) // "expa"
    public static let fraction = NUMSymbol(name: "fraction", code: 0x66667261, type: AppleEvents.typeEnumerated) // "ffra"
    public static let Good = NUMSymbol(name: "Good", code: 0x4b6e5030, type: AppleEvents.typeEnumerated) // "KnP0"
    public static let gradientFill = NUMSymbol(name: "gradientFill", code: 0x66696772, type: AppleEvents.typeEnumerated) // "figr"
    public static let hyphens = NUMSymbol(name: "hyphens", code: 0x68797068, type: AppleEvents.typeEnumerated) // "hyph"
    public static let imageFill = NUMSymbol(name: "imageFill", code: 0x6669696d, type: AppleEvents.typeEnumerated) // "fiim"
    public static let justify = NUMSymbol(name: "justify", code: 0x616a7374, type: AppleEvents.typeEnumerated) // "ajst"
    public static let left = NUMSymbol(name: "left", code: 0x616c6674, type: AppleEvents.typeEnumerated) // "alft"
    public static let loop = NUMSymbol(name: "loop", code: 0x6d766c70, type: AppleEvents.typeEnumerated) // "mvlp"
    public static let loopBackAndForth = NUMSymbol(name: "loopBackAndForth", code: 0x6d766266, type: AppleEvents.typeEnumerated) // "mvbf"
    public static let MicrosoftExcel = NUMSymbol(name: "MicrosoftExcel", code: 0x4e65786c, type: AppleEvents.typeEnumerated) // "Nexl"
    public static let no = NUMSymbol(name: "no", code: 0x6e6f2020, type: AppleEvents.typeEnumerated) // "no  "
    public static let noFill = NUMSymbol(name: "noFill", code: 0x66696e6f, type: AppleEvents.typeEnumerated) // "fino"
    public static let none = NUMSymbol(name: "none", code: 0x6d76726e, type: AppleEvents.typeEnumerated) // "mvrn"
    public static let number = NUMSymbol(name: "number", code: 0x6e6d6272, type: AppleEvents.typeEnumerated) // "nmbr"
    public static let Numbers = NUMSymbol(name: "Numbers", code: 0x4e756666, type: AppleEvents.typeEnumerated) // "Nuff"
    public static let Numbers09 = NUMSymbol(name: "Numbers09", code: 0x4e6e6d62, type: AppleEvents.typeEnumerated) // "Nnmb"
    public static let numeralSystem = NUMSymbol(name: "numeralSystem", code: 0x66636e73, type: AppleEvents.typeEnumerated) // "fcns"
    public static let numericStrings = NUMSymbol(name: "numericStrings", code: 0x6e756d65, type: AppleEvents.typeEnumerated) // "nume"
    public static let PDF = NUMSymbol(name: "PDF", code: 0x4e706466, type: AppleEvents.typeEnumerated) // "Npdf"
    public static let percent = NUMSymbol(name: "percent", code: 0x66706572, type: AppleEvents.typeEnumerated) // "fper"
    public static let popUpMenu = NUMSymbol(name: "popUpMenu", code: 0x66637070, type: AppleEvents.typeEnumerated) // "fcpp"
    public static let punctuation = NUMSymbol(name: "punctuation", code: 0x70756e63, type: AppleEvents.typeEnumerated) // "punc"
    public static let rating = NUMSymbol(name: "rating", code: 0x66726174, type: AppleEvents.typeEnumerated) // "frat"
    public static let right = NUMSymbol(name: "right", code: 0x61726974, type: AppleEvents.typeEnumerated) // "arit"
    public static let scientific = NUMSymbol(name: "scientific", code: 0x66736369, type: AppleEvents.typeEnumerated) // "fsci"
    public static let slider = NUMSymbol(name: "slider", code: 0x6663736c, type: AppleEvents.typeEnumerated) // "fcsl"
    public static let standard = NUMSymbol(name: "standard", code: 0x6c777374, type: AppleEvents.typeEnumerated) // "lwst"
    public static let stepper = NUMSymbol(name: "stepper", code: 0x66637374, type: AppleEvents.typeEnumerated) // "fcst"
    public static let text = NUMSymbol(name: "text", code: 0x63747874, type: AppleEvents.typeEnumerated) // "ctxt"
    public static let top = NUMSymbol(name: "top", code: 0x61767470, type: AppleEvents.typeEnumerated) // "avtp"
    public static let whitespace = NUMSymbol(name: "whitespace", code: 0x77686974, type: AppleEvents.typeEnumerated) // "whit"
    public static let yes = NUMSymbol(name: "yes", code: 0x79657320, type: AppleEvents.typeEnumerated) // "yes "
}
...
extension NUMCommand {
    ...
    @discardableResult public func addColumnAfter(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "addColumnAfter", event: 0x4e4d5462_41436166, // "NMTbACaf"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func addColumnBefore(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "addColumnBefore", event: 0x4e4d5462_41436266, // "NMTbACbf"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func addRowAbove(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "addRowAbove", event: 0x4e4d5462_41526162, // "NMTbARab"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func addRowBelow(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "addRowBelow", event: 0x4e4d5462_41526166, // "NMTbARaf"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func export(_ directParameter: Any = SwiftAutomation.noParameter,
            ...
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "export", event: 0x4e6d7374_6578706f, // "Nmstexpo"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
    ...
    @discardableResult public func remove(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "remove", event: 0x4e6d5462_444c5420, // "NmTbDLT "
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
    ...
    @discardableResult public func transpose(_ directParameter: Any = SwiftAutomation.noParameter,
            requestedType: SwiftAutomation.Symbol? = nil, waitReply: Bool = true, sendOptions: SwiftAutomation.SendOptions? = nil,
            withTimeout: TimeInterval? = nil, considering: SwiftAutomation.ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent(name: "transpose", event: 0x4e6d5462_58504f53, // "NmTbXPOS"
                parentSpecifier: (self as! SwiftAutomation.Specifier), directParameter: directParameter, keywordParameters: [
                ], requestedType: requestedType, waitReply: waitReply, sendOptions: sendOptions,
                withTimeout: withTimeout, considering: considering)
    }
...
extension NUMObject {
    ...
    public var id: NUMItem {return self.property(0x49442020) as! NUMItem} // "ID  "
    ...
    public var selection: NUMItem {return self.property(0x73656c65) as! NUMItem} // "sele"
    ...
    public var characters: NUMItems {return self.elements(0x63686120) as! NUMItems} // "cha "

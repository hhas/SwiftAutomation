...
public class NOTSymbol: SwiftAutomation.Symbol {
    ...
    public override class func symbol(code: OSType, type: OSType = typeType, descriptor: ScalarDescriptor? = nil) -> NOTSymbol {
        switch (code) {
    ...
    public static let April = NOTSymbol(name: "April", code: 0x61707220, type: typeType) // "apr "
    public static let attachment = NOTSymbol(name: "attachment", code: 0x61747473, type: typeType) // "atts"
    public static let August = NOTSymbol(name: "August", code: 0x61756720, type: typeType) // "aug "
    ...
    public static let contentIdentifier = NOTSymbol(name: "contentIdentifier", code: 0x63696420, type: typeType) // "cid "
    ...
    public static let date = NOTSymbol(name: "date", code: 0x6c647420, type: typeType) // "ldt "
    public static let December = NOTSymbol(name: "December", code: 0x64656320, type: typeType) // "dec "
    ...
    public static let EPSPicture = NOTSymbol(name: "EPSPicture", code: 0x45505320, type: typeType) // "EPS "
    ...
    public static let February = NOTSymbol(name: "February", code: 0x66656220, type: typeType) // "feb "
    ...
    public static let Friday = NOTSymbol(name: "Friday", code: 0x66726920, type: typeType) // "fri "
    ...
    public static let id = NOTSymbol(name: "id", code: 0x49442020, type: typeType) // "ID  "
    ...
    public static let January = NOTSymbol(name: "January", code: 0x6a616e20, type: typeType) // "jan "
    public static let JPEGPicture = NOTSymbol(name: "JPEGPicture", code: 0x4a504547, type: typeType) // "JPEG"
    public static let July = NOTSymbol(name: "July", code: 0x6a756c20, type: typeType) // "jul "
    public static let June = NOTSymbol(name: "June", code: 0x6a756e20, type: typeType) // "jun "
    ...
    public static let March = NOTSymbol(name: "March", code: 0x6d617220, type: typeType) // "mar "
    public static let May = NOTSymbol(name: "May", code: 0x6d617920, type: typeType) // "may "
    ...
    public static let Monday = NOTSymbol(name: "Monday", code: 0x6d6f6e20, type: typeType) // "mon "
    ...
    public static let November = NOTSymbol(name: "November", code: 0x6e6f7620, type: typeType) // "nov "
    public static let null = NOTSymbol(name: "null", code: 0x6e756c6c, type: typeType) // "null"
    public static let October = NOTSymbol(name: "October", code: 0x6f637420, type: typeType) // "oct "
    ...
    public static let processSerialNumber = NOTSymbol(name: "processSerialNumber", code: 0x70736e20, type: typeType) // "psn "
    ...
    public static let reference = NOTSymbol(name: "reference", code: 0x6f626a20, type: typeType) // "obj "
    ...
    public static let Saturday = NOTSymbol(name: "Saturday", code: 0x73617420, type: typeType) // "sat "
    public static let script = NOTSymbol(name: "script", code: 0x73637074, type: typeType) // "scpt"
    public static let September = NOTSymbol(name: "September", code: 0x73657020, type: typeType) // "sep "
    ...
    public static let Sunday = NOTSymbol(name: "Sunday", code: 0x73756e20, type: typeType) // "sun "
    ...
    public static let Thursday = NOTSymbol(name: "Thursday", code: 0x74687520, type: typeType) // "thu "
    public static let TIFFPicture = NOTSymbol(name: "TIFFPicture", code: 0x54494646, type: typeType) // "TIFF"
    public static let Tuesday = NOTSymbol(name: "Tuesday", code: 0x74756520, type: typeType) // "tue "
    ...
    public static let Wednesday = NOTSymbol(name: "Wednesday", code: 0x77656420, type: typeType) // "wed "
    ...
    // Enumerators
    public static let ask = NOTSymbol(name: "ask", code: 0x61736b20, type: typeEnumerated) // "ask "
    ...
    public static let no = NOTSymbol(name: "no", code: 0x6e6f2020, type: typeEnumerated) // "no  "
    ...
    public static let yes = NOTSymbol(name: "yes", code: 0x79657320, type: typeEnumerated) // "yes "
}

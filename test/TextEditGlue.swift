...
public class TEDSymbol: SwiftAutomation.Symbol {
    ...
    public static let April = TEDSymbol(name: "April", code: 0x61707220, type: AppleEvents.typeType) // "apr\0x20"
    ...
    public static let August = TEDSymbol(name: "August", code: 0x61756720, type: AppleEvents.typeType) // "aug\0x20"
    ...
    public static let character = TEDSymbol(name: "character", code: 0x63686120, type: AppleEvents.typeType) // "cha\0x20"
    ...
    public static let date = TEDSymbol(name: "date", code: 0x6c647420, type: AppleEvents.typeType) // "ldt\0x20"
    public static let December = TEDSymbol(name: "December", code: 0x64656320, type: AppleEvents.typeType) // "dec\0x20"
    ...
    public static let EPSPicture = TEDSymbol(name: "EPSPicture", code: 0x45505320, type: AppleEvents.typeType) // "EPS\0x20"
    ...
    public static let February = TEDSymbol(name: "February", code: 0x66656220, type: AppleEvents.typeType) // "feb\0x20"
    ...
    public static let Friday = TEDSymbol(name: "Friday", code: 0x66726920, type: AppleEvents.typeType) // "fri\0x20"
    ...
    public static let id = TEDSymbol(name: "id", code: 0x49442020, type: AppleEvents.typeType) // "ID\0x20\0x20"
    ...
    public static let January = TEDSymbol(name: "January", code: 0x6a616e20, type: AppleEvents.typeType) // "jan\0x20"
    public static let JPEGPicture = TEDSymbol(name: "JPEGPicture", code: 0x4a504547, type: AppleEvents.typeType) // "JPEG"
    public static let July = TEDSymbol(name: "July", code: 0x6a756c20, type: AppleEvents.typeType) // "jul\0x20"
    public static let June = TEDSymbol(name: "June", code: 0x6a756e20, type: AppleEvents.typeType) // "jun\0x20"
    ...
    public static let March = TEDSymbol(name: "March", code: 0x6d617220, type: AppleEvents.typeType) // "mar\0x20"
    public static let May = TEDSymbol(name: "May", code: 0x6d617920, type: AppleEvents.typeType) // "may\0x20"
    ...
    public static let Monday = TEDSymbol(name: "Monday", code: 0x6d6f6e20, type: AppleEvents.typeType) // "mon\0x20"
    public static let name = TEDSymbol(name: "name", code: 0x706e616d, type: AppleEvents.typeType) // "pnam"
    public static let November = TEDSymbol(name: "November", code: 0x6e6f7620, type: AppleEvents.typeType) // "nov\0x20"
    public static let null = TEDSymbol(name: "null", code: 0x6e756c6c, type: AppleEvents.typeType) // "null"
    public static let October = TEDSymbol(name: "October", code: 0x6f637420, type: AppleEvents.typeType) // "oct\0x20"
    ...
    public static let processSerialNumber = TEDSymbol(name: "processSerialNumber", code: 0x70736e20, type: AppleEvents.typeType) // "psn\0x20"
    ...
    public static let reference = TEDSymbol(name: "reference", code: 0x6f626a20, type: AppleEvents.typeType) // "obj\0x20"
    ...
    public static let Saturday = TEDSymbol(name: "Saturday", code: 0x73617420, type: AppleEvents.typeType) // "sat\0x20"
    public static let script = TEDSymbol(name: "script", code: 0x73637074, type: AppleEvents.typeType) // "scpt"
    public static let September = TEDSymbol(name: "September", code: 0x73657020, type: AppleEvents.typeType) // "sep\0x20"
    ...
    public static let Sunday = TEDSymbol(name: "Sunday", code: 0x73756e20, type: AppleEvents.typeType) // "sun\0x20"
    ...
    public static let Thursday = TEDSymbol(name: "Thursday", code: 0x74687520, type: AppleEvents.typeType) // "thu\0x20"
    ...
    public static let Tuesday = TEDSymbol(name: "Tuesday", code: 0x74756520, type: AppleEvents.typeType) // "tue\0x20"
    ...
    public static let Wednesday = TEDSymbol(name: "Wednesday", code: 0x77656420, type: AppleEvents.typeType) // "wed\0x20"
    ...
    // Enumerators
    public static let ask = TEDSymbol(name: "ask", code: 0x61736b20, type: AppleEvents.typeEnumerated) // "ask\0x20"
    ...
    public static let no = TEDSymbol(name: "no", code: 0x6e6f2020, type: AppleEvents.typeEnumerated) // "no\0x20\0x20"
    ...
    public static let yes = TEDSymbol(name: "yes", code: 0x79657320, type: AppleEvents.typeEnumerated) // "yes\0x20"
}

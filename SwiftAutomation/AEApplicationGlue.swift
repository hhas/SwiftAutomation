...
public class AESymbol: Symbol {
    ...
    public override class func symbol(code: OSType, type: OSType = typeType, descriptor: ScalarDescriptor? = nil) -> AESymbol {
        switch (code) {
...
public enum AEymbolOrString: SelfPacking, SelfUnpacking {
    ...
    public static func SwiftAutomation_unpackSelf(_ desc: Descriptor, appData: AppData) throws -> AEymbolOrString {
        ...
        throw UnpackError(appData: appData, desc: desc, type: AEymbolOrString.self,

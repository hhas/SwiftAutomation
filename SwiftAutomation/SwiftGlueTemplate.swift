...
"",
"    public override class func symbol(code: OSType, type: OSType = typeType, descriptor: AEDesc? = nil) -> «PREFIX»Symbol {",
...
"    ",
"    public func SwiftAutomation_packSelf(_ appData: «SWIFTAE»AppData) throws -> AEDesc {",
"        switch self {«+PACK_CASE»",
"        case .«CASE_NAME»(let value): return try appData.pack(value as Any)«-PACK_CASE»",
"        }",
"    }",
"    public static func SwiftAutomation_unpackSelf(_ desc: AEDesc, appData: «SWIFTAE»AppData) throws -> «ENUM_TYPE_NAME» {«+UNPACK_CASE»",
...
"",
"    private static func SwiftAutomation_unpackProperty<T>(_ recordDesc: AEDesc,",
...
"        let desc = AEDesc.record().coerce(toDescriptorType: self.class_.code)!«+PACK_PROPERTY»",
"        desc.setParam(try appData.pack(self.«PROPERTY_NAME» as Any), forKeyword: «PROPERTY_CODE»)«-PACK_PROPERTY»",
"        return desc",
"    }",
"    public static func SwiftAutomation_unpackSelf(_ desc: AEDesc, appData: «SWIFTAE»AppData) throws -> «STRUCT_NAME» {",
"        if !desc.isRecord {",

...
private let specifierFormatter = SpecifierFormatter(applicationClassName: "TextEdit",
                                                    classNamePrefix: "TED",
                                                    propertyNames: [
...
/******************************************************************************/
// Symbol subclass defines static type/enum/property constants based on TextEdit.app's terminology
...
// Types/properties
    ...
    public static let CString = TEDSymbol(name: "CString", code: 0x63737472, type: typeType) // 'cstr'
    ...
    public static let PascalString = TEDSymbol(name: "PascalString", code: 0x70737472, type: typeType) // 'pstr'
    ...
    public static let data = TEDSymbol(name: "data", code: 0x72646174, type: typeType) // 'rdat'
    ...
    public static let property = TEDSymbol(name: "property", code: 0x70726f70, type: typeType) // 'prop'
    ...
    public static let styledUnicodeText = TEDSymbol(name: "styledUnicodeText", code: 0x73757478, type: typeType) // 'sutx'
    ...
    public static let version_ = TEDSymbol(name: "version_", code: 0x76657273, type: typeType) // 'vers'
...
// Enumerators
    public static let applicationResponses = TEDSymbol(name: "applicationResponses", code: 0x726d7465, type: typeType) // 'rmte'
    public static let ask = TEDSymbol(name: "ask", code: 0x61736b20, type: typeType) // 'ask '
    public static let case_ = TEDSymbol(name: "case_", code: 0x63617365, type: typeType) // 'case'
    public static let detailed = TEDSymbol(name: "detailed", code: 0x6c776474, type: typeType) // 'lwdt'
    public static let diacriticals = TEDSymbol(name: "diacriticals", code: 0x64696163, type: typeType) // 'diac'
    public static let expansion = TEDSymbol(name: "expansion", code: 0x65787061, type: typeType) // 'expa'
    public static let hyphens = TEDSymbol(name: "hyphens", code: 0x68797068, type: typeType) // 'hyph'
    public static let no = TEDSymbol(name: "no", code: 0x6e6f2020, type: typeType) // 'no  '
    public static let numericStrings = TEDSymbol(name: "numericStrings", code: 0x6e756d65, type: typeType) // 'nume'
    public static let punctuation = TEDSymbol(name: "punctuation", code: 0x70756e63, type: typeType) // 'punc'
    public static let standard = TEDSymbol(name: "standard", code: 0x6c777374, type: typeType) // 'lwst'
    public static let whitespace = TEDSymbol(name: "whitespace", code: 0x77686974, type: typeType) // 'whit'
    public static let yes = TEDSymbol(name: "yes", code: 0x79657320, type: typeType) // 'yes '
}
...
/******************************************************************************/
// Specifier extensions; these add command methods and property/elements getters based on TextEdit.app's terminology
...
extension TEDCommand {
    ...
    public func save(directParameter: Any = NoParameter,
            ...
            in_: Any = NoParameter,
            waitReply: Bool = true, withTimeout: NSTimeInterval? = nil, considering: ConsideringOptions? = nil) throws -> Any {
        return try self.appData.sendAppleEvent("save", eventClass: 0x636f7265, eventID: 0x73617665, // 'coresave'
                parentSpecifier: (self as! Specifier), directParameter: directParameter, keywordParameters: [
...
extension TEDQuery {
    ...
    public var version_: TEDObject {return self.property(0x76657273) as! TEDObject} // 'vers'
...
public let TEDApp = TEDRoot(rootObject: AppRootDesc, appData: nil)
public let TEDCon = TEDRoot(rootObject: ConRootDesc, appData: nil)
public let TEDIts = TEDRoot(rootObject: ItsRootDesc, appData: nil)


// glue-defined specifier and symbol classes, root objects, and specifier formatter info; used by glue's AppData instances

private let _glueInfo = GlueInfo(insertionSpecifierType: TEDInsertion.self, objectSpecifierType: TEDObject.self,
                                 elementsSpecifierType: TEDElements.self, symbolType: TEDSymbol.self,
                                 appRoot: TEDApp, conRoot: TEDCon, itsRoot: TEDIts, formatter: specifierFormatter)
